    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Onlyfans::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Onlyfans::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(Onlyfans::Internal::Type::Converter::Input)
                  }
                )
              ]
            )
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Onlyfans::Internal::Type::BaseModel::KnownField,
                  { type: Onlyfans::Internal::Type::Converter::Input }
                )
              ]
            )
          end
                ...
                T.any(
                  {
                    ...
                    enum:
                      T.nilable(
                        T.proc.returns(
                          Onlyfans::Internal::Type::Converter::Input
                        )
                      ),
                    union:
                      T.nilable(
          ...
          sig do
            override
              .params(
                ...
                state: Onlyfans::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: Onlyfans::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: Onlyfans::Internal::Type::BaseModel,
              convert: T::Boolean
