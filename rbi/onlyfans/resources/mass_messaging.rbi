  ...
  module Resources
    class MassMessaging
      ...
      sig do
        ...
        ).returns(Onlyfans::Models::MassMessagingRetrieveResponse)
      end
      def retrieve(
      ...
      sig do
        params(
          ...
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::MassMessagingUpdateResponse)
      end
      def update(
      ...
      sig do
        params(
          account: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::MassMessagingListResponse)
      end
      def list(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::MassMessagingDeleteResponse)
      end
      def delete(
        # The ID of the message queue item. Can be retrieved from the above store and list
        # endpoints.
      ...
      sig do
        params(
          ...
          start_date: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::MassMessagingRetrieveOverviewResponse)
      end
      ...
      sig do
        params(
          ...
          user_lists: T::Array[String],
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::MassMessagingSendResponse)
      end
      def send_(
        # The Account ID
        account,
