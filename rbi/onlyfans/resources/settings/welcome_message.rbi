    ...
    class Settings
      class WelcomeMessage
        ...
        sig do
          ...
          ).returns(Onlyfans::Models::Settings::WelcomeMessageRetrieveResponse)
        end
        def retrieve(
          # The Account ID
          account,
        ...
        sig do
          params(
            ...
            text: String,
            request_options: Onlyfans::RequestOptions::OrHash
          ).returns(Onlyfans::Models::Settings::WelcomeMessageUpdateResponse)
        end
        def update(
          # The Account ID
          account,
        ...
        sig do
          params(
            ...
            enabled: T::Boolean,
            request_options: Onlyfans::RequestOptions::OrHash
          ).returns(Onlyfans::Models::Settings::WelcomeMessageToggleResponse)
        end
        def toggle(
          # The Account ID
          account,
