    ...
    class TrialLinks
      ...
      class Tags
        ...
        sig do
          ...
          ).returns(Onlyfans::Models::TrialLinks::TagListResponse)
        end
        def list(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Onlyfans::RequestOptions::OrHash
          ).returns(Onlyfans::Models::TrialLinks::TagAddResponse)
        end
        def add(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Onlyfans::RequestOptions::OrHash
          ).returns(Onlyfans::Models::TrialLinks::TagRemoveResponse)
        end
        def remove(
          # Path param: The ID of the trial link
          trial_link_id,
