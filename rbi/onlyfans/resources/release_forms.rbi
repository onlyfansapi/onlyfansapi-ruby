  ...
  module Resources
    ...
    class ReleaseForms
      ...
      sig do
        ...
        ).returns(Onlyfans::Models::ReleaseFormCreateInvitationLinkResponse)
      end
      ...
      sig do
        params(
          ...
          name: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::ReleaseFormCreateReleaseFormResponse)
      end
      ...
      sig do
        params(
          ...
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::ReleaseFormListTaggableUsersResponse)
      end
