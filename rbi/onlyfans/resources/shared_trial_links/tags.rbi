    ...
    class SharedTrialLinks
      ...
      class Tags
        ...
        sig do
          ...
          ).returns(Onlyfans::Models::SharedTrialLinks::TagListResponse)
        end
        def list(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Onlyfans::RequestOptions::OrHash
          ).returns(Onlyfans::Models::SharedTrialLinks::TagAddResponse)
        end
        def add(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Onlyfans::RequestOptions::OrHash
          ).returns(Onlyfans::Models::SharedTrialLinks::TagRemoveResponse)
        end
        def remove(
          # Path param: The OnlyFans-side ID of the shared trial link
          shared_trial_link_id,
