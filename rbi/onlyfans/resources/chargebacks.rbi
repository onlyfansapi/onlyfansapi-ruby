  ...
  module Resources
    class Chargebacks
      ...
      sig do
        ...
        ).returns(Onlyfans::Models::ChargebackListResponse)
      end
      def list(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          start_date: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::ChargebackCalculateRatioResponse)
      end
      def calculate_ratio(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          start_date: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::ChargebackListStatisticsResponse)
      end
      def list_statistics(
        # The Account ID
        account,
