...
module Onlyfans
  module Resources
    class Settings
      sig { returns(Onlyfans::Resources::Settings::BlockedCountries) }
      attr_reader :blocked_countries

      sig { returns(Onlyfans::Resources::Settings::WelcomeMessage) }
      attr_reader :welcome_message

      sig { returns(Onlyfans::Resources::Settings::SocialMediaButtons) }
      ...
      sig do
        ...
        ).returns(Onlyfans::Models::SettingRetrieveResponse)
      end
      def retrieve(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          username: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::SettingCheckUsernameAvailabilityResponse)
      end
      ...
      sig do
        params(
          ...
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::SettingUpdateProfileResponse)
      end
      def update_profile(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          price: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::SettingUpdateSubscriptionPriceResponse)
      end
