    ...
    class SharedTrackingLinks
      ...
      class Tags
        ...
        sig do
          ...
          ).returns(Onlyfans::Models::SharedTrackingLinks::TagListResponse)
        end
        def list(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Onlyfans::RequestOptions::OrHash
          ).returns(Onlyfans::Models::SharedTrackingLinks::TagAddResponse)
        end
        def add(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Onlyfans::RequestOptions::OrHash
          ).returns(Onlyfans::Models::SharedTrackingLinks::TagRemoveResponse)
        end
        def remove(
          # Path param: The OnlyFans-side ID of the shared tracking link
          shared_tracking_link_id,
