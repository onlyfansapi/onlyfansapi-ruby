  ...
  module Resources
    class Promotions
      ...
      sig do
        ...
        ).returns(Onlyfans::Models::PromotionCreateResponse)
      end
      def create(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          offset: Integer,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::PromotionListResponse)
      end
      def list(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::PromotionDeleteResponse)
      end
      def delete(
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfans::RequestOptions::OrHash
        ).returns(Onlyfans::Models::PromotionStopResponse)
      end
      def stop(
