  ...
  module Models
    class TrackingLinkListSubscribersResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::TrackingLinkListSubscribersResponse,
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::TrackingLinkListSubscribersResponse::Meta)
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta:
            Onlyfans::Models::TrackingLinkListSubscribersResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::TrackingLinkListSubscribersResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Onlyfans::Models::TrackingLinkListSubscribersResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::TrackingLinkListSubscribersResponse::Meta,
            data: Onlyfans::Models::TrackingLinkListSubscribersResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::TrackingLinkListSubscribersResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::TrackingLinkListSubscribersResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::TrackingLinkListSubscribersResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::TrackingLinkListSubscribersResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::TrackingLinkListSubscribersResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::TrackingLinkListSubscribersResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::TrackingLinkListSubscribersResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfans::Models::TrackingLinkListSubscribersResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            params(
              avatar_thumbs:
                Onlyfans::Models::TrackingLinkListSubscribersResponse::Data::List::AvatarThumbs::OrHash
            ).void
          end
