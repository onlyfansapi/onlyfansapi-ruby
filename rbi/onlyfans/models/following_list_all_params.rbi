  ...
  module Models
    class FollowingListAllParams < Onlyfans::Internal::Type::BaseModel
      ...
      module Sort
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Onlyfans::FollowingListAllParams::Sort) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        LAST_ACTIVITY =
          T.let(
            :last_activity,
            Onlyfans::FollowingListAllParams::Sort::TaggedSymbol
          )
        EXPIRE_DATE =
          T.let(
            :expire_date,
        ...
        sig do
          override.returns(
            T::Array[Onlyfans::FollowingListAllParams::Sort::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module SortDirection
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Onlyfans::FollowingListAllParams::SortDirection)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        ASC =
          T.let(
            :asc,
            Onlyfans::FollowingListAllParams::SortDirection::TaggedSymbol
          )
        DESC =
          T.let(
            :desc,
