  ...
  module Models
    class SmartLinkPostbackUpdateResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::SmartLinkPostbackUpdateResponse,
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::SmartLinkPostbackUpdateResponse::Meta)
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta: Onlyfans::Models::SmartLinkPostbackUpdateResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::SmartLinkPostbackUpdateResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Onlyfans::Models::SmartLinkPostbackUpdateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        params(
          _meta:
            Onlyfans::Models::SmartLinkPostbackUpdateResponse::Meta::OrHash,
          data: Onlyfans::Models::SmartLinkPostbackUpdateResponse::Data::OrHash
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::SmartLinkPostbackUpdateResponse::Meta,
            data: Onlyfans::Models::SmartLinkPostbackUpdateResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SmartLinkPostbackUpdateResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SmartLinkPostbackUpdateResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::SmartLinkPostbackUpdateResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SmartLinkPostbackUpdateResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::SmartLinkPostbackUpdateResponse::Meta::Credits::OrHash
          ).void
        end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SmartLinkPostbackUpdateResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::SmartLinkPostbackUpdateResponse::Data::Header
              ]
            )
          )
        end
        ...
        sig do
          params(
            headers:
              T::Array[
                Onlyfans::Models::SmartLinkPostbackUpdateResponse::Data::Header::OrHash
              ]
          ).void
        end
        attr_writer :headers
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::SmartLinkPostbackUpdateResponse::Data::SmartLink
              ]
            )
          )
        end
        ...
        sig do
          params(
            smart_links:
              T::Array[
                Onlyfans::Models::SmartLinkPostbackUpdateResponse::Data::SmartLink::OrHash
              ]
          ).void
        end
