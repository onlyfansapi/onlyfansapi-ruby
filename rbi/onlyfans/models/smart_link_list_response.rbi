  ...
  module Models
    class SmartLinkListResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::SmartLinkListResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(Onlyfans::Models::SmartLinkListResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::SmartLinkListResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(T::Array[Onlyfans::Models::SmartLinkListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: T::Array[Onlyfans::Models::SmartLinkListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            ...
            data: T::Array[Onlyfans::Models::SmartLinkListResponse::Data]
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::SmartLinkListResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache: Onlyfans::Models::SmartLinkListResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::SmartLinkListResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::SmartLinkListResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::SmartLinkListResponse::Meta::RateLimits)
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::SmartLinkListResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::SmartLinkListResponse::Meta::Cache::OrHash,
            _credits:
              Onlyfans::Models::SmartLinkListResponse::Meta::Credits::OrHash,
            _rate_limits:
              Onlyfans::Models::SmartLinkListResponse::Meta::RateLimits::OrHash
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::SmartLinkListResponse::Meta::Cache,
              _credits: Onlyfans::Models::SmartLinkListResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::SmartLinkListResponse::Meta::RateLimits
            }
          )
        end
        def to_hash
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::SmartLinkListResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::SmartLinkListResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SmartLinkListResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::SmartLinkListResponse::Data::Account)
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              Onlyfans::Models::SmartLinkListResponse::Data::Account::OrHash
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::SmartLinkListResponse::Data::Cost)
          )
        end
        attr_reader :cost
        ...
        sig do
          params(
            cost: Onlyfans::Models::SmartLinkListResponse::Data::Cost::OrHash
          ).void
        end
        attr_writer :cost
        ...
        sig do
          override.returns(
            {
              id: String,
              account: Onlyfans::Models::SmartLinkListResponse::Data::Account,
              clicks_count: Integer,
              conversions_count: Integer,
              cost: Onlyfans::Models::SmartLinkListResponse::Data::Cost,
              created_at: String,
              free_trial_days: Integer,
              link_type: String,
              name: String,
        ...
        class Account < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::SmartLinkListResponse::Data::Account,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Cost < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::SmartLinkListResponse::Data::Cost,
                Onlyfans::Internal::AnyHash
              )
            end
