  ...
  module Models
    class UserRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::UserRetrieveResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(Onlyfans::Models::UserRetrieveResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(_meta: Onlyfans::Models::UserRetrieveResponse::Meta::OrHash).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfans::Models::UserRetrieveResponse::Data)) }
      attr_reader :data

      sig do
        params(data: Onlyfans::Models::UserRetrieveResponse::Data::OrHash).void
      end
      attr_writer :data

      sig do
        params(
          _meta: Onlyfans::Models::UserRetrieveResponse::Meta::OrHash,
          data: Onlyfans::Models::UserRetrieveResponse::Data::OrHash
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::UserRetrieveResponse::Meta,
            data: Onlyfans::Models::UserRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::UserRetrieveResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserRetrieveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache: Onlyfans::Models::UserRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserRetrieveResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::UserRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::UserRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::UserRetrieveResponse::Meta::Cache,
              _credits: Onlyfans::Models::UserRetrieveResponse::Meta::Credits,
              _rate_limits:
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::UserRetrieveResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::UserRetrieveResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::UserRetrieveResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            avatar_thumbs:
              Onlyfans::Models::UserRetrieveResponse::Data::AvatarThumbs::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserRetrieveResponse::Data::HeaderSize)
          )
        end
        ...
        sig do
          params(
            header_size:
              Onlyfans::Models::UserRetrieveResponse::Data::HeaderSize::OrHash
          ).void
        end
        ...
        sig do
          params(
            header_thumbs:
              Onlyfans::Models::UserRetrieveResponse::Data::HeaderThumbs::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfans::Models::UserRetrieveResponse::Data::ListsState]
            )
          )
        end
        ...
        sig do
          params(
            lists_states:
              T::Array[
                Onlyfans::Models::UserRetrieveResponse::Data::ListsState::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            subscribed_by_data:
              Onlyfans::Models::UserRetrieveResponse::Data::SubscribedByData::OrHash
          ).void
        end
        ...
        sig do
          params(
            subscribed_on_data:
              Onlyfans::Models::UserRetrieveResponse::Data::SubscribedOnData::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::UserRetrieveResponse::Data::SubscriptionBundle
              ]
            )
          )
        end
        ...
        sig do
          params(
            subscription_bundles:
              T::Array[
                Onlyfans::Models::UserRetrieveResponse::Data::SubscriptionBundle::OrHash
              ]
          ).void
        end
          ...
          override.returns(
            {
              ...
              lists_states:
                T::Array[
                  Onlyfans::Models::UserRetrieveResponse::Data::ListsState
                ],
              location: String,
              medias_count: Integer,
              name: String,
        ...
        class SubscribedByData < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfans::Models::UserRetrieveResponse::Data::SubscribedByData::Subscribe
                ]
              )
            )
          end
          ...
          sig do
            params(
              subscribes:
                T::Array[
                  Onlyfans::Models::UserRetrieveResponse::Data::SubscribedByData::Subscribe::OrHash
                ]
            ).void
          end
