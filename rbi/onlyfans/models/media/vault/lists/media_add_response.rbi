        ...
        module Lists
          class MediaAddResponse < Onlyfans::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Onlyfans::Models::Media::Vault::Lists::MediaAddResponse,
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Meta
                )
              )
            end
            attr_reader :_meta
            ...
            sig do
              params(
                _meta:
                  Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Meta::OrHash
              ).void
            end
            attr_writer :_meta
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Data
                )
              )
            end
            attr_reader :data
            ...
            sig do
              params(
                data:
                  Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Data::OrHash
              ).void
            end
            attr_writer :data
            ...
            class Meta < Onlyfans::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Meta::Cache
                  )
                )
              end
              attr_reader :_cache
              ...
              sig do
                params(
                  _cache:
                    Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Meta::Cache::OrHash
                ).void
              end
              attr_writer :_cache
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Meta::Credits
                  )
                )
              end
              ...
              sig do
                params(
                  _credits:
                    Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Meta::Credits::OrHash
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Meta::RateLimits
                  )
                )
              end
              ...
              sig do
                params(
                  _rate_limits:
                    Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Meta::RateLimits::OrHash
                ).void
              end
            ...
            class Data < Onlyfans::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Data::Media
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  medias:
                    T::Array[
                      Onlyfans::Models::Media::Vault::Lists::MediaAddResponse::Data::Media::OrHash
                    ]
                ).void
              end
              attr_writer :medias
