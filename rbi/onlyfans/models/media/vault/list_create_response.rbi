      ...
      module Vault
        class ListCreateResponse < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Media::Vault::ListCreateResponse,
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::Vault::ListCreateResponse::Meta
              )
            )
          end
          attr_reader :_meta
          ...
          sig do
            params(
              _meta:
                Onlyfans::Models::Media::Vault::ListCreateResponse::Meta::OrHash
            ).void
          end
          attr_writer :_meta
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::Vault::ListCreateResponse::Data
              )
            )
          end
          attr_reader :data
          ...
          sig do
            params(
              data:
                Onlyfans::Models::Media::Vault::ListCreateResponse::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          sig do
            override.returns(
              {
                _meta: Onlyfans::Models::Media::Vault::ListCreateResponse::Meta,
                data: Onlyfans::Models::Media::Vault::ListCreateResponse::Data
              }
            )
          end
          def to_hash
          ...
          class Meta < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::Vault::ListCreateResponse::Meta::Cache
                )
              )
            end
            attr_reader :_cache
            ...
            sig do
              params(
                _cache:
                  Onlyfans::Models::Media::Vault::ListCreateResponse::Meta::Cache::OrHash
              ).void
            end
            attr_writer :_cache
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::Vault::ListCreateResponse::Meta::Credits
                )
              )
            end
            ...
            sig do
              params(
                _credits:
                  Onlyfans::Models::Media::Vault::ListCreateResponse::Meta::Credits::OrHash
              ).void
            end
            ...
            sig do
              params(
                _rate_limits:
                  Onlyfans::Models::Media::Vault::ListCreateResponse::Meta::RateLimits::OrHash
              ).void
            end
