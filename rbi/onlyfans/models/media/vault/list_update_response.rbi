      ...
      module Vault
        class ListUpdateResponse < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::Vault::ListUpdateResponse::Meta
              )
            )
          end
          attr_reader :_meta
          ...
          sig do
            params(
              _meta:
                Onlyfans::Models::Media::Vault::ListUpdateResponse::Meta::OrHash
            ).void
          end
          attr_writer :_meta
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::Vault::ListUpdateResponse::Data
              )
            )
          end
          attr_reader :data
          ...
          sig do
            params(
              data:
                Onlyfans::Models::Media::Vault::ListUpdateResponse::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          sig do
            override.returns(
              {
                _meta: Onlyfans::Models::Media::Vault::ListUpdateResponse::Meta,
                data: Onlyfans::Models::Media::Vault::ListUpdateResponse::Data
              }
            )
          end
          def to_hash
          ...
          class Meta < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::Vault::ListUpdateResponse::Meta::Cache
                )
              )
            end
            attr_reader :_cache
            ...
            sig do
              params(
                _cache:
                  Onlyfans::Models::Media::Vault::ListUpdateResponse::Meta::Cache::OrHash
              ).void
            end
            attr_writer :_cache
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::Vault::ListUpdateResponse::Meta::Credits
                )
              )
            end
            ...
            sig do
              params(
                _credits:
                  Onlyfans::Models::Media::Vault::ListUpdateResponse::Meta::Credits::OrHash
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::Vault::ListUpdateResponse::Meta::RateLimits
                )
              )
            end
            ...
            sig do
              params(
                _rate_limits:
                  Onlyfans::Models::Media::Vault::ListUpdateResponse::Meta::RateLimits::OrHash
              ).void
            end
