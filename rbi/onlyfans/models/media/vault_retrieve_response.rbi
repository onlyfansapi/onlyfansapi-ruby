    ...
    module Media
      class VaultRetrieveResponse < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::Media::VaultRetrieveResponse,
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::Media::VaultRetrieveResponse::Meta)
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta: Onlyfans::Models::Media::VaultRetrieveResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::Media::VaultRetrieveResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data: Onlyfans::Models::Media::VaultRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfans::Models::Media::VaultRetrieveResponse::Meta,
              data: Onlyfans::Models::Media::VaultRetrieveResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Media::VaultRetrieveResponse::Meta,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::VaultRetrieveResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfans::Models::Media::VaultRetrieveResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::VaultRetrieveResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfans::Models::Media::VaultRetrieveResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfans::Models::Media::VaultRetrieveResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Media::VaultRetrieveResponse::Data,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::VaultRetrieveResponse::Data::Files
              )
            )
          end
          attr_reader :files
          ...
          sig do
            params(
              files:
                Onlyfans::Models::Media::VaultRetrieveResponse::Data::Files::OrHash
            ).void
          end
          attr_writer :files
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfans::Models::Media::VaultRetrieveResponse::Data::ListState
                ]
              )
            )
          end
          ...
          sig do
            params(
              list_states:
                T::Array[
                  Onlyfans::Models::Media::VaultRetrieveResponse::Data::ListState::OrHash
                ]
            ).void
          end
          ...
          sig do
            params(
              video_sources:
                Onlyfans::Models::Media::VaultRetrieveResponse::Data::VideoSources::OrHash
            ).void
          end
          ...
          class Files < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::VaultRetrieveResponse::Data::Files::Full
                )
              )
            end
            attr_reader :full
            ...
            sig do
              params(
                full:
                  Onlyfans::Models::Media::VaultRetrieveResponse::Data::Files::Full::OrHash
              ).void
            end
            attr_writer :full
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::VaultRetrieveResponse::Data::Files::Preview
                )
              )
            end
            attr_reader :preview
            ...
            sig do
              params(
                preview:
                  Onlyfans::Models::Media::VaultRetrieveResponse::Data::Files::Preview::OrHash
              ).void
            end
            attr_writer :preview
            ...
            sig do
              params(
                square_preview:
                  Onlyfans::Models::Media::VaultRetrieveResponse::Data::Files::SquarePreview::OrHash
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::VaultRetrieveResponse::Data::Files::Thumb
                )
              )
            end
            attr_reader :thumb
            ...
            sig do
              params(
                thumb:
                  Onlyfans::Models::Media::VaultRetrieveResponse::Data::Files::Thumb::OrHash
              ).void
            end
            attr_writer :thumb
