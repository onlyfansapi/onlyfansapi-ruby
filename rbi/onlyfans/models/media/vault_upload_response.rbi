    ...
    module Media
      class VaultUploadResponse < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::Media::VaultUploadResponse,
              Onlyfans::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Onlyfans::Models::Media::VaultUploadResponse::Meta))
        end
        attr_reader :_meta

        sig do
          params(
            _meta: Onlyfans::Models::Media::VaultUploadResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta

        sig do
          returns(T.nilable(Onlyfans::Models::Media::VaultUploadResponse::Data))
        end
        attr_reader :data

        sig do
          params(
            data: Onlyfans::Models::Media::VaultUploadResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfans::Models::Media::VaultUploadResponse::Meta,
              data: Onlyfans::Models::Media::VaultUploadResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Media::VaultUploadResponse::Meta,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::VaultUploadResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfans::Models::Media::VaultUploadResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::VaultUploadResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfans::Models::Media::VaultUploadResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfans::Models::Media::VaultUploadResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Media::VaultUploadResponse::Data,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Media::VaultUploadResponse::Data::Files
              )
            )
          end
          attr_reader :files
          ...
          sig do
            params(
              files:
                Onlyfans::Models::Media::VaultUploadResponse::Data::Files::OrHash
            ).void
          end
          attr_writer :files
          ...
          class Files < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Media::VaultUploadResponse::Data::Files::Full
                )
              )
            end
            attr_reader :full
            ...
            sig do
              params(
                full:
                  Onlyfans::Models::Media::VaultUploadResponse::Data::Files::Full::OrHash
              ).void
            end
            attr_writer :full
