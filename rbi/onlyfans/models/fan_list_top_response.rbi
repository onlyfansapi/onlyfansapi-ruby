...
module Onlyfans
  module Models
    class FanListTopResponse < Onlyfans::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Onlyfans::Models::FanListTopResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(_meta: Onlyfans::Models::FanListTopResponse::Meta::OrHash).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfans::Models::FanListTopResponse::Data)) }
      attr_reader :data

      sig do
        params(data: Onlyfans::Models::FanListTopResponse::Data::OrHash).void
      end
      attr_writer :data

      sig do
        params(
          _meta: Onlyfans::Models::FanListTopResponse::Meta::OrHash,
          data: Onlyfans::Models::FanListTopResponse::Data::OrHash
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::FanListTopResponse::Meta,
            data: Onlyfans::Models::FanListTopResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::FanListTopResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Onlyfans::Models::FanListTopResponse::Meta::Cache))
        end
        attr_reader :_cache

        sig do
          params(
            _cache: Onlyfans::Models::FanListTopResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::FanListTopResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::FanListTopResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::FanListTopResponse::Meta::RateLimits)
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::FanListTopResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::FanListTopResponse::Meta::Cache,
              _credits: Onlyfans::Models::FanListTopResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::FanListTopResponse::Meta::RateLimits
            }
          )
        end
        def to_hash
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::FanListTopResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::FanListTopResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::FanListTopResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfans::Models::FanListTopResponse::Data::User]
            )
          )
        end
        attr_reader :users
        ...
        sig do
          params(
            users:
              T::Array[Onlyfans::Models::FanListTopResponse::Data::User::OrHash]
          ).void
        end
        attr_writer :users
        ...
        sig do
          override.returns(
            {
              users: T::Array[Onlyfans::Models::FanListTopResponse::Data::User]
            }
          )
        end
        def to_hash
        ...
        class User < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            params(
              avatar_thumbs:
                Onlyfans::Models::FanListTopResponse::Data::User::AvatarThumbs::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfans::Models::FanListTopResponse::Data::User::ListsState
                ]
              )
            )
          end
          ...
          sig do
            params(
              lists_states:
                T::Array[
                  Onlyfans::Models::FanListTopResponse::Data::User::ListsState::OrHash
                ]
            ).void
          end
          ...
          sig do
            params(
              subscribed_on_data:
                Onlyfans::Models::FanListTopResponse::Data::User::SubscribedOnData::OrHash
            ).void
          end
