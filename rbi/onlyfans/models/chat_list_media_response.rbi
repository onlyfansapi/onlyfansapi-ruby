...
module Onlyfans
  module Models
    class ChatListMediaResponse < Onlyfans::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Onlyfans::Models::ChatListMediaResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::ChatListMediaResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfans::Models::ChatListMediaResponse::Data)) }
      attr_reader :data

      sig do
        params(data: Onlyfans::Models::ChatListMediaResponse::Data::OrHash).void
      end
      attr_writer :data
      ...
      sig do
        params(
          _meta: Onlyfans::Models::ChatListMediaResponse::Meta::OrHash,
          data: Onlyfans::Models::ChatListMediaResponse::Data::OrHash
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::ChatListMediaResponse::Meta,
            data: Onlyfans::Models::ChatListMediaResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::ChatListMediaResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::ChatListMediaResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache: Onlyfans::Models::ChatListMediaResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::ChatListMediaResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::ChatListMediaResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::ChatListMediaResponse::Meta::RateLimits)
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::ChatListMediaResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::ChatListMediaResponse::Meta::Cache::OrHash,
            _credits:
              Onlyfans::Models::ChatListMediaResponse::Meta::Credits::OrHash,
            _rate_limits:
              Onlyfans::Models::ChatListMediaResponse::Meta::RateLimits::OrHash
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::ChatListMediaResponse::Meta::Cache,
              _credits: Onlyfans::Models::ChatListMediaResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::ChatListMediaResponse::Meta::RateLimits
            }
          )
        end
        def to_hash
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::ChatListMediaResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::ChatListMediaResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::ChatListMediaResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfans::Models::ChatListMediaResponse::Data::List]
            )
          )
        end
        attr_reader :list
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfans::Models::ChatListMediaResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            params(
              from_user:
                Onlyfans::Models::ChatListMediaResponse::Data::List::FromUser::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfans::Models::ChatListMediaResponse::Data::List::Media
                ]
              )
            )
          end
          ...
          sig do
            params(
              media:
                T::Array[
                  Onlyfans::Models::ChatListMediaResponse::Data::List::Media::OrHash
                ]
            ).void
          end
          attr_writer :media
          ...
          class Media < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::ChatListMediaResponse::Data::List::Media::Files
                )
              )
            end
            attr_reader :files
            ...
            sig do
              params(
                files:
                  Onlyfans::Models::ChatListMediaResponse::Data::List::Media::Files::OrHash
              ).void
            end
            attr_writer :files
            ...
            sig do
              params(
                video_sources:
                  Onlyfans::Models::ChatListMediaResponse::Data::List::Media::VideoSources::OrHash
              ).void
            end
            ...
            class Files < Onlyfans::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::ChatListMediaResponse::Data::List::Media::Files::Full
                  )
                )
              end
              attr_reader :full
              ...
              sig do
                params(
                  full:
                    Onlyfans::Models::ChatListMediaResponse::Data::List::Media::Files::Full::OrHash
                ).void
              end
              attr_writer :full
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::ChatListMediaResponse::Data::List::Media::Files::Preview
                  )
                )
              end
              attr_reader :preview
              ...
              sig do
                params(
                  preview:
                    Onlyfans::Models::ChatListMediaResponse::Data::List::Media::Files::Preview::OrHash
                ).void
              end
              attr_writer :preview
              ...
              sig do
                params(
                  square_preview:
                    Onlyfans::Models::ChatListMediaResponse::Data::List::Media::Files::SquarePreview::OrHash
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::ChatListMediaResponse::Data::List::Media::Files::Thumb
                  )
                )
              end
              attr_reader :thumb
              ...
              sig do
                params(
                  thumb:
                    Onlyfans::Models::ChatListMediaResponse::Data::List::Media::Files::Thumb::OrHash
                ).void
              end
              attr_writer :thumb
