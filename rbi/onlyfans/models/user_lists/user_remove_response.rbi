    ...
    module UserLists
      class UserRemoveResponse < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::UserLists::UserRemoveResponse,
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserLists::UserRemoveResponse::Meta)
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta: Onlyfans::Models::UserLists::UserRemoveResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserLists::UserRemoveResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data: Onlyfans::Models::UserLists::UserRemoveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          params(
            _meta:
              Onlyfans::Models::UserLists::UserRemoveResponse::Meta::OrHash,
            data: Onlyfans::Models::UserLists::UserRemoveResponse::Data::OrHash
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfans::Models::UserLists::UserRemoveResponse::Meta,
              data: Onlyfans::Models::UserLists::UserRemoveResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::UserLists::UserRemoveResponse::Meta,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::UserLists::UserRemoveResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfans::Models::UserLists::UserRemoveResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::UserLists::UserRemoveResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfans::Models::UserLists::UserRemoveResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfans::Models::UserLists::UserRemoveResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::UserLists::UserRemoveResponse::Data,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::UserLists::UserRemoveResponse::Data::List
              )
            )
          end
          attr_reader :list
          ...
          sig do
            params(
              list:
                Onlyfans::Models::UserLists::UserRemoveResponse::Data::List::OrHash
            ).void
          end
          attr_writer :list
          ...
          sig do
            params(
              user_state:
                Onlyfans::Models::UserLists::UserRemoveResponse::Data::UserState::OrHash
            ).void
          end
          ...
          class List < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Onlyfans::Models::UserLists::UserRemoveResponse::Data::List::User
                  ]
                )
              )
            end
            ...
            sig do
              params(
                users:
                  T::Array[
                    Onlyfans::Models::UserLists::UserRemoveResponse::Data::List::User::OrHash
                  ]
              ).void
            end
            attr_writer :users
            ...
            class User < Onlyfans::Internal::Type::BaseModel
              ...
              sig do
                params(
                  avatar_thumbs:
                    Onlyfans::Models::UserLists::UserRemoveResponse::Data::List::User::AvatarThumbs::OrHash
                ).void
              end
