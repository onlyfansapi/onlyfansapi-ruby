    ...
    module UserLists
      class UserClearResponse < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::UserLists::UserClearResponse,
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserLists::UserClearResponse::Meta)
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta: Onlyfans::Models::UserLists::UserClearResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          params(
            data: Onlyfans::Models::UserLists::UserClearResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfans::Models::UserLists::UserClearResponse::Meta,
              data: Onlyfans::Models::UserLists::UserClearResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::UserLists::UserClearResponse::Meta,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::UserLists::UserClearResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfans::Models::UserLists::UserClearResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::UserLists::UserClearResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfans::Models::UserLists::UserClearResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfans::Models::UserLists::UserClearResponse::Meta::RateLimits::OrHash
            ).void
          end
