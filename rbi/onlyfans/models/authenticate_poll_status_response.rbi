...
module Onlyfans
  module Models
    class AuthenticatePollStatusResponse < Onlyfans::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::AuthenticatePollStatusResponse::Account)
        )
      end
      attr_reader :account
      ...
      sig do
        params(
          account:
            Onlyfans::Models::AuthenticatePollStatusResponse::Account::OrHash
        ).void
      end
      attr_writer :account
      ...
      class Account < Onlyfans::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::AuthenticatePollStatusResponse::Account::OnlyfansData
            )
          )
        end
        ...
        sig do
          params(
            onlyfans_data:
              Onlyfans::Models::AuthenticatePollStatusResponse::Account::OnlyfansData::OrHash
          ).void
        end
        ...
        class OnlyfansData < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            params(
              age_verification_session:
                Onlyfans::Models::AuthenticatePollStatusResponse::Account::OnlyfansData::AgeVerificationSession::OrHash
            ).void
          end
          ...
          sig do
            params(
              has_new_ticket_replies:
                Onlyfans::Models::AuthenticatePollStatusResponse::Account::OnlyfansData::HasNewTicketReplies::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::AuthenticatePollStatusResponse::Account::OnlyfansData::Upload
              )
            )
          end
          attr_reader :upload
          ...
          sig do
            params(
              upload:
                Onlyfans::Models::AuthenticatePollStatusResponse::Account::OnlyfansData::Upload::OrHash
            ).void
          end
          attr_writer :upload
          ...
          class Upload < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              params(
                geo_upload_args:
                  Onlyfans::Models::AuthenticatePollStatusResponse::Account::OnlyfansData::Upload::GeoUploadArgs::OrHash
              ).void
            end
            ...
            class GeoUploadArgs < Onlyfans::Internal::Type::BaseModel
              ...
              sig do
                params(
                  additional:
                    Onlyfans::Models::AuthenticatePollStatusResponse::Account::OnlyfansData::Upload::GeoUploadArgs::Additional::OrHash
                ).void
              end
