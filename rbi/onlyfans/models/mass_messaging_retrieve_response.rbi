  ...
  module Models
    class MassMessagingRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::MassMessagingRetrieveResponse,
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::MassMessagingRetrieveResponse::Meta)
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta: Onlyfans::Models::MassMessagingRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::MassMessagingRetrieveResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Onlyfans::Models::MassMessagingRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::MassMessagingRetrieveResponse::Meta,
            data: Onlyfans::Models::MassMessagingRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::MassMessagingRetrieveResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::MassMessagingRetrieveResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::MassMessagingRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::MassMessagingRetrieveResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::MassMessagingRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::MassMessagingRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::MassMessagingRetrieveResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::MassMessagingRetrieveResponse::Data::Queue
            )
          )
        end
        attr_reader :queue
        ...
        sig do
          params(
            queue:
              Onlyfans::Models::MassMessagingRetrieveResponse::Data::Queue::OrHash
          ).void
        end
        attr_writer :queue
