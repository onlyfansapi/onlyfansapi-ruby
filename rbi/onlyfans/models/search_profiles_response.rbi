  ...
  module Models
    class SearchProfilesResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::SearchProfilesResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(Onlyfans::Models::SearchProfilesResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::SearchProfilesResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        params(
          _pagination:
            Onlyfans::Models::SearchProfilesResponse::Pagination::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Onlyfans::Models::SearchProfilesResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: T::Array[Onlyfans::Models::SearchProfilesResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::SearchProfilesResponse::Meta,
            _pagination: Onlyfans::Models::SearchProfilesResponse::Pagination,
            data: T::Array[Onlyfans::Models::SearchProfilesResponse::Data]
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SearchProfilesResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::SearchProfilesResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::SearchProfilesResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::SearchProfilesResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::SearchProfilesResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::SearchProfilesResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::SearchProfilesResponse::Meta::Cache,
              _credits: Onlyfans::Models::SearchProfilesResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::SearchProfilesResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::SearchProfilesResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::SearchProfilesResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SearchProfilesResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
