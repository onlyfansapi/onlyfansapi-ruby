  ...
  module Models
    class ProfileRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::ProfileRetrieveResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfans::Models::ProfileRetrieveResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::ProfileRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfans::Models::ProfileRetrieveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::ProfileRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::ProfileRetrieveResponse::Meta,
            data: Onlyfans::Models::ProfileRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::ProfileRetrieveResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::ProfileRetrieveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::ProfileRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::ProfileRetrieveResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::ProfileRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::ProfileRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::ProfileRetrieveResponse::Meta::Cache,
              _credits:
                Onlyfans::Models::ProfileRetrieveResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::ProfileRetrieveResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::ProfileRetrieveResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::ProfileRetrieveResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            avatar_thumbs:
              Onlyfans::Models::ProfileRetrieveResponse::Data::AvatarThumbs::OrHash
          ).void
        end
        ...
        sig do
          params(
            header_size:
              Onlyfans::Models::ProfileRetrieveResponse::Data::HeaderSize::OrHash
          ).void
        end
        ...
        sig do
          params(
            header_thumbs:
              Onlyfans::Models::ProfileRetrieveResponse::Data::HeaderThumbs::OrHash
          ).void
        end
