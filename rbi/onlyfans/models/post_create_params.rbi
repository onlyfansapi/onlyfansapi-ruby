...
module Onlyfans
  module Models
    class PostCreateParams < Onlyfans::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(Onlyfans::PostCreateParams::VotingType::OrSymbol))
      end
      ...
      module VotingType
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Onlyfans::PostCreateParams::VotingType) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        POLL =
          T.let(:poll, Onlyfans::PostCreateParams::VotingType::TaggedSymbol)
        QUIZ =
          T.let(:quiz, Onlyfans::PostCreateParams::VotingType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Onlyfans::PostCreateParams::VotingType::TaggedSymbol]
          )
        end
        def self.values
        end
