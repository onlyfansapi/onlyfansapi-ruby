  ...
  module Models
    class StoryRetrieveStatsResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::StoryRetrieveStatsResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfans::Models::StoryRetrieveStatsResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::StoryRetrieveStatsResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfans::Models::StoryRetrieveStatsResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::StoryRetrieveStatsResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::StoryRetrieveStatsResponse::Meta,
            data: Onlyfans::Models::StoryRetrieveStatsResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::StoryRetrieveStatsResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::StoryRetrieveStatsResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::StoryRetrieveStatsResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::StoryRetrieveStatsResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::StoryRetrieveStatsResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::StoryRetrieveStatsResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::StoryRetrieveStatsResponse::Meta::Cache,
              _credits:
                Onlyfans::Models::StoryRetrieveStatsResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::StoryRetrieveStatsResponse::Meta::RateLimits
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::StoryRetrieveStatsResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryCommentChart
              ]
            )
          )
        end
        ...
        sig do
          params(
            story_comment_chart:
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryCommentChart::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryLikeChart
              ]
            )
          )
        end
        ...
        sig do
          params(
            story_like_chart:
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryLikeChart::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryLookChart
              ]
            )
          )
        end
        ...
        sig do
          params(
            story_look_chart:
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryLookChart::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryTipChart
              ]
            )
          )
        end
        ...
        sig do
          params(
            story_tip_chart:
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryTipChart::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryTipSumChart
              ]
            )
          )
        end
        ...
        sig do
          params(
            story_tip_sum_chart:
              T::Array[
                Onlyfans::Models::StoryRetrieveStatsResponse::Data::StoryTipSumChart::OrHash
              ]
          ).void
        end
