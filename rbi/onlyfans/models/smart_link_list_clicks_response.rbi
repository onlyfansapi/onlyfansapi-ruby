  ...
  module Models
    class SmartLinkListClicksResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::SmartLinkListClicksResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfans::Models::SmartLinkListClicksResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::SmartLinkListClicksResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfans::Models::SmartLinkListClicksResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::SmartLinkListClicksResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::SmartLinkListClicksResponse::Meta,
            data: Onlyfans::Models::SmartLinkListClicksResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SmartLinkListClicksResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SmartLinkListClicksResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::SmartLinkListClicksResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SmartLinkListClicksResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::SmartLinkListClicksResponse::Meta::Credits::OrHash
          ).void
        end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SmartLinkListClicksResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::SmartLinkListClicksResponse::Data::Chart
              ]
            )
          )
        end
        ...
        sig do
          params(
            chart:
              T::Array[
                Onlyfans::Models::SmartLinkListClicksResponse::Data::Chart::OrHash
              ]
          ).void
        end
        attr_writer :chart
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SmartLinkListClicksResponse::Data::Filters
            )
          )
        end
        attr_reader :filters
        ...
        sig do
          params(
            filters:
              Onlyfans::Models::SmartLinkListClicksResponse::Data::Filters::OrHash
          ).void
        end
        attr_writer :filters
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfans::Models::SmartLinkListClicksResponse::Data::Row]
            )
          )
        end
        attr_reader :rows
        ...
        sig do
          params(
            rows:
              T::Array[
                Onlyfans::Models::SmartLinkListClicksResponse::Data::Row::OrHash
              ]
          ).void
        end
        attr_writer :rows
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SmartLinkListClicksResponse::Data::Summary
            )
          )
        end
        attr_reader :summary
        ...
        sig do
          params(
            summary:
              Onlyfans::Models::SmartLinkListClicksResponse::Data::Summary::OrHash
          ).void
        end
        attr_writer :summary
          ...
          override.returns(
            {
              ...
              rows:
                T::Array[
                  Onlyfans::Models::SmartLinkListClicksResponse::Data::Row
                ],
              summary:
                Onlyfans::Models::SmartLinkListClicksResponse::Data::Summary
            }
        ...
        class Chart < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            params(clicks: Integer, timestamp: String).returns(T.attached_class)
          end
          def self.new(clicks: nil, timestamp: nil)
          end

          sig { override.returns({ clicks: Integer, timestamp: String }) }
          def to_hash
          end
        end
        ...
        class Summary < Onlyfans::Internal::Type::BaseModel
          ...
          sig { params(clicks_total: Integer).returns(T.attached_class) }
          def self.new(clicks_total: nil)
          end

          sig { override.returns({ clicks_total: Integer }) }
          def to_hash
          end
        end
      end
