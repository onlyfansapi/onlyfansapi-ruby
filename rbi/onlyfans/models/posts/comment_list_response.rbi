    ...
    module Posts
      class CommentListResponse < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::Posts::CommentListResponse,
              Onlyfans::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Onlyfans::Models::Posts::CommentListResponse::Meta))
        end
        attr_reader :_meta

        sig do
          params(
            _meta: Onlyfans::Models::Posts::CommentListResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta

        sig do
          returns(T.nilable(Onlyfans::Models::Posts::CommentListResponse::Data))
        end
        attr_reader :data

        sig do
          params(
            data: Onlyfans::Models::Posts::CommentListResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfans::Models::Posts::CommentListResponse::Meta,
              data: Onlyfans::Models::Posts::CommentListResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Posts::CommentListResponse::Meta,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Posts::CommentListResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfans::Models::Posts::CommentListResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Posts::CommentListResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfans::Models::Posts::CommentListResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfans::Models::Posts::CommentListResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Posts::CommentListResponse::Data,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfans::Models::Posts::CommentListResponse::Data::List
                ]
              )
            )
          end
          ...
          sig do
            params(
              list:
                T::Array[
                  Onlyfans::Models::Posts::CommentListResponse::Data::List::OrHash
                ]
            ).void
          end
          attr_writer :list
          ...
          class List < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::Posts::CommentListResponse::Data::List::Author
                )
              )
            end
            attr_reader :author
            ...
            sig do
              params(
                author:
                  Onlyfans::Models::Posts::CommentListResponse::Data::List::Author::OrHash
              ).void
            end
            attr_writer :author
