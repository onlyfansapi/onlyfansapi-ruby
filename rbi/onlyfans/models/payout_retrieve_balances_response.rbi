  ...
  module Models
    class PayoutRetrieveBalancesResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::PayoutRetrieveBalancesResponse,
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::PayoutRetrieveBalancesResponse::Meta)
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta: Onlyfans::Models::PayoutRetrieveBalancesResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::PayoutRetrieveBalancesResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Onlyfans::Models::PayoutRetrieveBalancesResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::PayoutRetrieveBalancesResponse::Meta,
            data: Onlyfans::Models::PayoutRetrieveBalancesResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::PayoutRetrieveBalancesResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::PayoutRetrieveBalancesResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::PayoutRetrieveBalancesResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::PayoutRetrieveBalancesResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::PayoutRetrieveBalancesResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::PayoutRetrieveBalancesResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          params(
            withdrawal_period_options:
              T::Array[
                Onlyfans::Models::PayoutRetrieveBalancesResponse::Data::WithdrawalPeriodOption::OrHash
              ]
          ).void
        end
