  ...
  module Models
    class PostRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::PostRetrieveResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(Onlyfans::Models::PostRetrieveResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(_meta: Onlyfans::Models::PostRetrieveResponse::Meta::OrHash).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfans::Models::PostRetrieveResponse::Data)) }
      attr_reader :data

      sig do
        params(data: Onlyfans::Models::PostRetrieveResponse::Data::OrHash).void
      end
      attr_writer :data

      sig do
        params(
          _meta: Onlyfans::Models::PostRetrieveResponse::Meta::OrHash,
          data: Onlyfans::Models::PostRetrieveResponse::Data::OrHash
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::PostRetrieveResponse::Meta,
            data: Onlyfans::Models::PostRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::PostRetrieveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache: Onlyfans::Models::PostRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::PostRetrieveResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::PostRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::PostRetrieveResponse::Meta::RateLimits)
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::PostRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::PostRetrieveResponse::Meta::Cache,
              _credits: Onlyfans::Models::PostRetrieveResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::PostRetrieveResponse::Meta::RateLimits
            }
          )
        end
        def to_hash
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::PostRetrieveResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::PostRetrieveResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::PostRetrieveResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::PostRetrieveResponse::Data::Author)
          )
        end
        attr_reader :author
        ...
        sig do
          params(
            author: Onlyfans::Models::PostRetrieveResponse::Data::Author::OrHash
          ).void
        end
        attr_writer :author
        ...
        sig do
          params(
            id: Integer,
            author:
              Onlyfans::Models::PostRetrieveResponse::Data::Author::OrHash,
        ...
        sig do
          override.returns(
            {
              id: Integer,
              author: Onlyfans::Models::PostRetrieveResponse::Data::Author,
              can_comment: T::Boolean,
              can_delete: T::Boolean,
              can_edit: T::Boolean,
              can_edit_text: T::Boolean,
        ...
        class Author < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::PostRetrieveResponse::Data::Author,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              avatar_thumbs:
                Onlyfans::Models::PostRetrieveResponse::Data::Author::AvatarThumbs::OrHash
            ).void
          end
          ...
          sig do
            params(
              header_size:
                Onlyfans::Models::PostRetrieveResponse::Data::Author::HeaderSize::OrHash
            ).void
          end
          ...
          sig do
            params(
              header_thumbs:
                Onlyfans::Models::PostRetrieveResponse::Data::Author::HeaderThumbs::OrHash
            ).void
          end
