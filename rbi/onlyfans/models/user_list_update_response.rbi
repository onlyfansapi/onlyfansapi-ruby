...
module Onlyfans
  module Models
    class UserListUpdateResponse < Onlyfans::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Onlyfans::Models::UserListUpdateResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::UserListUpdateResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfans::Models::UserListUpdateResponse::Data)) }
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::UserListUpdateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::UserListUpdateResponse::Meta,
            data: Onlyfans::Models::UserListUpdateResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::UserListUpdateResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserListUpdateResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::UserListUpdateResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserListUpdateResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::UserListUpdateResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::UserListUpdateResponse::Meta::RateLimits
            )
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::UserListUpdateResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::UserListUpdateResponse::Meta::Cache,
              _credits: Onlyfans::Models::UserListUpdateResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::UserListUpdateResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::UserListUpdateResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::UserListUpdateResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::UserListUpdateResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
