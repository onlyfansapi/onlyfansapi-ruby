  ...
  module Models
    class StoryRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::StoryRetrieveResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(Onlyfans::Models::StoryRetrieveResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::StoryRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfans::Models::StoryRetrieveResponse::Data)) }
      attr_reader :data

      sig do
        params(data: Onlyfans::Models::StoryRetrieveResponse::Data::OrHash).void
      end
      attr_writer :data
      ...
      sig do
        params(
          _meta: Onlyfans::Models::StoryRetrieveResponse::Meta::OrHash,
          data: Onlyfans::Models::StoryRetrieveResponse::Data::OrHash
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::StoryRetrieveResponse::Meta,
            data: Onlyfans::Models::StoryRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::StoryRetrieveResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::StoryRetrieveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache: Onlyfans::Models::StoryRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::StoryRetrieveResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::StoryRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::StoryRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::StoryRetrieveResponse::Meta::Cache::OrHash,
            _credits:
              Onlyfans::Models::StoryRetrieveResponse::Meta::Credits::OrHash,
            _rate_limits:
              Onlyfans::Models::StoryRetrieveResponse::Meta::RateLimits::OrHash
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::StoryRetrieveResponse::Meta::Cache,
              _credits: Onlyfans::Models::StoryRetrieveResponse::Meta::Credits,
              _rate_limits:
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::StoryRetrieveResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::StoryRetrieveResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::StoryRetrieveResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfans::Models::StoryRetrieveResponse::Data::Media]
            )
          )
        end
        attr_reader :media
        ...
        sig do
          params(
            media:
              T::Array[
                Onlyfans::Models::StoryRetrieveResponse::Data::Media::OrHash
              ]
          ).void
        end
        attr_writer :media
        ...
        class Media < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::StoryRetrieveResponse::Data::Media,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              files:
                Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::OrHash
            ).void
          end
          attr_writer :files
          ...
          class Files < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::Full
                )
              )
            end
            attr_reader :full
            ...
            sig do
              params(
                full:
                  Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::Full::OrHash
              ).void
            end
            attr_writer :full
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::Preview
                )
              )
            end
            attr_reader :preview
            ...
            sig do
              params(
                preview:
                  Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::Preview::OrHash
              ).void
            end
            attr_writer :preview
            ...
            sig do
              params(
                square_preview:
                  Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::SquarePreview::OrHash
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::Thumb
                )
              )
            end
            attr_reader :thumb
            ...
            sig do
              params(
                thumb:
                  Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::Thumb::OrHash
              ).void
            end
            attr_writer :thumb
            ...
            class Preview < Onlyfans::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::Preview::Sources
                  )
                )
              end
              attr_reader :sources
              ...
              sig do
                params(
                  sources:
                    Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::Preview::Sources::OrHash
                ).void
              end
              attr_writer :sources
            ...
            class SquarePreview < Onlyfans::Internal::Type::BaseModel
              ...
              sig do
                params(
                  sources:
                    Onlyfans::Models::StoryRetrieveResponse::Data::Media::Files::SquarePreview::Sources::OrHash
                ).void
              end
              attr_writer :sources
