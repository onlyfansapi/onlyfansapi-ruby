  ...
  module Models
    class SmartLinkRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::SmartLinkRetrieveResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfans::Models::SmartLinkRetrieveResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::SmartLinkRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfans::Models::SmartLinkRetrieveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::SmartLinkRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::SmartLinkRetrieveResponse::Meta,
            data: Onlyfans::Models::SmartLinkRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SmartLinkRetrieveResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::SmartLinkRetrieveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::SmartLinkRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SmartLinkRetrieveResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::SmartLinkRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::SmartLinkRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::SmartLinkRetrieveResponse::Meta::Cache,
              _credits:
                Onlyfans::Models::SmartLinkRetrieveResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::SmartLinkRetrieveResponse::Meta::RateLimits
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::SmartLinkRetrieveResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SmartLinkRetrieveResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SmartLinkRetrieveResponse::Data::Account
            )
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              Onlyfans::Models::SmartLinkRetrieveResponse::Data::Account::OrHash
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::SmartLinkRetrieveResponse::Data::Cost)
          )
        end
        attr_reader :cost
        ...
        sig do
          params(
            cost:
              Onlyfans::Models::SmartLinkRetrieveResponse::Data::Cost::OrHash
          ).void
        end
        attr_writer :cost
          ...
          override.returns(
            {
              ...
              clicks_count: Integer,
              conversions_count: Integer,
              cost: Onlyfans::Models::SmartLinkRetrieveResponse::Data::Cost,
              created_at: String,
              free_trial_days: Integer,
              link_type: String,
              name: String,
        ...
        class Cost < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::SmartLinkRetrieveResponse::Data::Cost,
                Onlyfans::Internal::AnyHash
              )
            end
