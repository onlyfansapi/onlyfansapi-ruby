  ...
  module Models
    class StoredListTrialLinksResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::StoredListTrialLinksResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfans::Models::StoredListTrialLinksResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::StoredListTrialLinksResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::StoredListTrialLinksResponse::Pagination)
        )
      end
      ...
      sig do
        params(
          _pagination:
            Onlyfans::Models::StoredListTrialLinksResponse::Pagination::OrHash
        ).void
      end
      attr_writer :_pagination

      sig do
        returns(T.nilable(Onlyfans::Models::StoredListTrialLinksResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::StoredListTrialLinksResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::StoredListTrialLinksResponse::Meta,
            _pagination:
              Onlyfans::Models::StoredListTrialLinksResponse::Pagination,
            data: Onlyfans::Models::StoredListTrialLinksResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::StoredListTrialLinksResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::StoredListTrialLinksResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::StoredListTrialLinksResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::StoredListTrialLinksResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::StoredListTrialLinksResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::StoredListTrialLinksResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::StoredListTrialLinksResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::StoredListTrialLinksResponse::Data::List
              ]
            )
          )
        end
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfans::Models::StoredListTrialLinksResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::StoredListTrialLinksResponse::Data::List::Cost
              )
            )
          end
          attr_reader :cost
          ...
          sig do
            params(
              cost:
                Onlyfans::Models::StoredListTrialLinksResponse::Data::List::Cost::OrHash
            ).void
          end
          attr_writer :cost
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::StoredListTrialLinksResponse::Data::List::Links
              )
            )
          end
          attr_reader :links
          ...
          sig do
            params(
              links:
                Onlyfans::Models::StoredListTrialLinksResponse::Data::List::Links::OrHash
            ).void
          end
          attr_writer :links
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::StoredListTrialLinksResponse::Data::List::Revenue
              )
            )
          end
          attr_reader :revenue
          ...
          sig do
            params(
              revenue:
                Onlyfans::Models::StoredListTrialLinksResponse::Data::List::Revenue::OrHash
            ).void
          end
          attr_writer :revenue
          ...
          class Links < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::StoredListTrialLinksResponse::Data::List::Links::Related
                )
              )
            end
            attr_reader :related
            ...
            sig do
              params(
                related:
                  Onlyfans::Models::StoredListTrialLinksResponse::Data::List::Links::Related::OrHash
              ).void
            end
            attr_writer :related
