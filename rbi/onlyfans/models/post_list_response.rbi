...
module Onlyfans
  module Models
    class PostListResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Onlyfans::Models::PostListResponse, Onlyfans::Internal::AnyHash)
        end

      sig { returns(T.nilable(Onlyfans::Models::PostListResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(_meta: Onlyfans::Models::PostListResponse::Meta::OrHash).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfans::Models::PostListResponse::Data)) }
      attr_reader :data

      sig do
        params(data: Onlyfans::Models::PostListResponse::Data::OrHash).void
      end
      attr_writer :data

      sig do
        params(
          _meta: Onlyfans::Models::PostListResponse::Meta::OrHash,
          data: Onlyfans::Models::PostListResponse::Data::OrHash
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::PostListResponse::Meta,
            data: Onlyfans::Models::PostListResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::PostListResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Onlyfans::Models::PostListResponse::Meta::Cache))
        end
        attr_reader :_cache

        sig do
          params(
            _cache: Onlyfans::Models::PostListResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache

        sig do
          returns(T.nilable(Onlyfans::Models::PostListResponse::Meta::Credits))
        end
        attr_reader :_credits

        sig do
          params(
            _credits: Onlyfans::Models::PostListResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::PostListResponse::Meta::RateLimits)
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::PostListResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::PostListResponse::Meta::Cache,
              _credits: Onlyfans::Models::PostListResponse::Meta::Credits,
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::PostListResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::PostListResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Onlyfans::Models::PostListResponse::Data::Counters))
        end
        attr_reader :counters

        sig do
          params(
            counters: Onlyfans::Models::PostListResponse::Data::Counters::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[Onlyfans::Models::PostListResponse::Data::List])
          )
        end
        attr_reader :list
        ...
        sig do
          params(
            list:
              T::Array[Onlyfans::Models::PostListResponse::Data::List::OrHash]
          ).void
        end
        attr_writer :list
        ...
        sig do
          params(
            counters:
              Onlyfans::Models::PostListResponse::Data::Counters::OrHash,
            has_more: T::Boolean,
            head_marker: String,
            list:
              T::Array[Onlyfans::Models::PostListResponse::Data::List::OrHash],
        ...
        sig do
          override.returns(
            {
              counters: Onlyfans::Models::PostListResponse::Data::Counters,
              has_more: T::Boolean,
              head_marker: String,
              list: T::Array[Onlyfans::Models::PostListResponse::Data::List],
              tail_marker: String
            }
          )
        end
        ...
        class Counters < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::PostListResponse::Data::Counters,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::PostListResponse::Data::List,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(Onlyfans::Models::PostListResponse::Data::List::Author)
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                Onlyfans::Models::PostListResponse::Data::List::Author::OrHash
            ).void
          end
          attr_writer :author
          ...
          class Author < Onlyfans::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Onlyfans::Models::PostListResponse::Data::List::Author,
                  Onlyfans::Internal::AnyHash
                )
              end
