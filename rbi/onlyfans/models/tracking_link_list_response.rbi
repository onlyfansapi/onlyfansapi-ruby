  ...
  module Models
    class TrackingLinkListResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::TrackingLinkListResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfans::Models::TrackingLinkListResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::TrackingLinkListResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::TrackingLinkListResponse::Pagination)
        )
      end
      ...
      sig do
        params(
          _pagination:
            Onlyfans::Models::TrackingLinkListResponse::Pagination::OrHash
        ).void
      end
      attr_writer :_pagination

      sig do
        returns(T.nilable(Onlyfans::Models::TrackingLinkListResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::TrackingLinkListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::TrackingLinkListResponse::Meta,
            _pagination: Onlyfans::Models::TrackingLinkListResponse::Pagination,
            data: Onlyfans::Models::TrackingLinkListResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::TrackingLinkListResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::TrackingLinkListResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::TrackingLinkListResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::TrackingLinkListResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::TrackingLinkListResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::TrackingLinkListResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::TrackingLinkListResponse::Meta::Cache,
              _credits:
                Onlyfans::Models::TrackingLinkListResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::TrackingLinkListResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::TrackingLinkListResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Pagination < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::TrackingLinkListResponse::Pagination,
              Onlyfans::Internal::AnyHash
            )
          end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::TrackingLinkListResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfans::Models::TrackingLinkListResponse::Data::List]
            )
          )
        end
        attr_reader :list
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfans::Models::TrackingLinkListResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::TrackingLinkListResponse::Data::List,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::TrackingLinkListResponse::Data::List::Links
              )
            )
          end
          attr_reader :links
          ...
          sig do
            params(
              links:
                Onlyfans::Models::TrackingLinkListResponse::Data::List::Links::OrHash
            ).void
          end
          attr_writer :links
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::TrackingLinkListResponse::Data::List::Revenue
              )
            )
          end
          attr_reader :revenue
          ...
          sig do
            params(
              revenue:
                Onlyfans::Models::TrackingLinkListResponse::Data::List::Revenue::OrHash
            ).void
          end
          attr_writer :revenue
          ...
          class Links < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfans::Models::TrackingLinkListResponse::Data::List::Links::Related
                )
              )
            end
            attr_reader :related
            ...
            sig do
              params(
                related:
                  Onlyfans::Models::TrackingLinkListResponse::Data::List::Links::Related::OrHash
              ).void
            end
            attr_writer :related
