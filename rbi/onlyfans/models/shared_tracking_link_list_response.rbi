...
module Onlyfans
  module Models
    class SharedTrackingLinkListResponse < Onlyfans::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::SharedTrackingLinkListResponse::Meta)
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta: Onlyfans::Models::SharedTrackingLinkListResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(
            Onlyfans::Models::SharedTrackingLinkListResponse::Pagination
          )
        )
      end
      ...
      sig do
        params(
          _pagination:
            Onlyfans::Models::SharedTrackingLinkListResponse::Pagination::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::SharedTrackingLinkListResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Onlyfans::Models::SharedTrackingLinkListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::SharedTrackingLinkListResponse::Meta,
            _pagination:
              Onlyfans::Models::SharedTrackingLinkListResponse::Pagination,
            data: Onlyfans::Models::SharedTrackingLinkListResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SharedTrackingLinkListResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SharedTrackingLinkListResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::SharedTrackingLinkListResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SharedTrackingLinkListResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::SharedTrackingLinkListResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::SharedTrackingLinkListResponse::Meta::RateLimits
            )
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::SharedTrackingLinkListResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::SharedTrackingLinkListResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::SharedTrackingLinkListResponse::Data::List
              ]
            )
          )
        end
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfans::Models::SharedTrackingLinkListResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::SharedTrackingLinkListResponse::Data::List::Owner
              )
            )
          end
          attr_reader :owner
          ...
          sig do
            params(
              owner:
                Onlyfans::Models::SharedTrackingLinkListResponse::Data::List::Owner::OrHash
            ).void
          end
          attr_writer :owner
