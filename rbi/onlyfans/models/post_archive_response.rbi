  ...
  module Models
    class PostArchiveResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::PostArchiveResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(Onlyfans::Models::PostArchiveResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(_meta: Onlyfans::Models::PostArchiveResponse::Meta::OrHash).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfans::Models::PostArchiveResponse::Data)) }
      attr_reader :data

      sig do
        params(data: Onlyfans::Models::PostArchiveResponse::Data::OrHash).void
      end
      attr_writer :data

      sig do
        params(
          _meta: Onlyfans::Models::PostArchiveResponse::Meta::OrHash,
          data: Onlyfans::Models::PostArchiveResponse::Data::OrHash
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::PostArchiveResponse::Meta,
            data: Onlyfans::Models::PostArchiveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::PostArchiveResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Onlyfans::Models::PostArchiveResponse::Meta::Cache))
        end
        attr_reader :_cache

        sig do
          params(
            _cache: Onlyfans::Models::PostArchiveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::PostArchiveResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::PostArchiveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::PostArchiveResponse::Meta::RateLimits)
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::PostArchiveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::PostArchiveResponse::Meta::Cache,
              _credits: Onlyfans::Models::PostArchiveResponse::Meta::Credits,
              _rate_limits:
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::PostArchiveResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::PostArchiveResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::PostArchiveResponse::Data::Counters)
          )
        end
        ...
        sig do
          params(
            counters:
              Onlyfans::Models::PostArchiveResponse::Data::Counters::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfans::Models::PostArchiveResponse::Data::LabelState]
            )
          )
        end
        ...
        sig do
          params(
            label_states:
              T::Array[
                Onlyfans::Models::PostArchiveResponse::Data::LabelState::OrHash
              ]
          ).void
        end
          ...
          override.returns(
            {
              ...
              label_states:
                T::Array[
                  Onlyfans::Models::PostArchiveResponse::Data::LabelState
                ]
            }
          )
        end
        ...
        class Counters < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::PostArchiveResponse::Data::Counters,
                Onlyfans::Internal::AnyHash
              )
            end
