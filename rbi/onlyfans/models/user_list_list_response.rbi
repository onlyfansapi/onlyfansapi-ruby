...
module Onlyfans
  module Models
    class UserListListResponse < Onlyfans::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Onlyfans::Models::UserListListResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(_meta: Onlyfans::Models::UserListListResponse::Meta::OrHash).void
      end
      attr_writer :_meta

      sig do
        returns(
          T.nilable(T::Array[Onlyfans::Models::UserListListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: T::Array[Onlyfans::Models::UserListListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
      ...
      sig do
        params(
          _meta: Onlyfans::Models::UserListListResponse::Meta::OrHash,
          data: T::Array[Onlyfans::Models::UserListListResponse::Data::OrHash]
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::UserListListResponse::Meta,
            data: T::Array[Onlyfans::Models::UserListListResponse::Data]
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::UserListListResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserListListResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache: Onlyfans::Models::UserListListResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserListListResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::UserListListResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::UserListListResponse::Meta::RateLimits)
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::UserListListResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::UserListListResponse::Meta::Cache,
              _credits: Onlyfans::Models::UserListListResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::UserListListResponse::Meta::RateLimits
            }
          )
        end
        def to_hash
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::UserListListResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::UserListListResponse::Meta::Credits,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::UserListListResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
