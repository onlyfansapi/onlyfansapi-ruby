...
module Onlyfans
  module Models
    class StoredListSharedTrackingLinksParams < Onlyfans::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::StoredListSharedTrackingLinksParams,
      ...
      sig do
        returns(
          T.nilable(Onlyfans::StoredListSharedTrackingLinksParams::Filter)
        )
      end
      attr_reader :filter
      ...
      sig do
        override.returns(
          {
            account: String,
            filter: Onlyfans::StoredListSharedTrackingLinksParams::Filter,
            limit: Integer,
            offset: Integer,
      ...
      class Filter < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::StoredListSharedTrackingLinksParams::Filter,
              Onlyfans::Internal::AnyHash
            )
          end
