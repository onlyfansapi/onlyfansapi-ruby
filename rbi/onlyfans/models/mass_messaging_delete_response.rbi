  ...
  module Models
    class MassMessagingDeleteResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::MassMessagingDeleteResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfans::Models::MassMessagingDeleteResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::MassMessagingDeleteResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfans::Models::MassMessagingDeleteResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::MassMessagingDeleteResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::MassMessagingDeleteResponse::Meta,
            data: Onlyfans::Models::MassMessagingDeleteResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::MassMessagingDeleteResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::MassMessagingDeleteResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::MassMessagingDeleteResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::MassMessagingDeleteResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::MassMessagingDeleteResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::MassMessagingDeleteResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::MassMessagingDeleteResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::MassMessagingDeleteResponse::Data::Queue
            )
          )
        end
        attr_reader :queue
        ...
        sig do
          params(
            queue:
              Onlyfans::Models::MassMessagingDeleteResponse::Data::Queue::OrHash
          ).void
        end
        attr_writer :queue
        ...
        sig do
          override.returns(
            {
              queue: Onlyfans::Models::MassMessagingDeleteResponse::Data::Queue,
              success: T::Boolean
            }
          )
        end
