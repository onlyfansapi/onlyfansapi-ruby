  ...
  module Models
    class MassMessagingRetrieveOverviewResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::MassMessagingRetrieveOverviewResponse,
      ...
      sig do
        returns(
          T.nilable(
            Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Meta
          )
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta:
            Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(
            Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::OrHash
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            _meta:
              Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Meta,
            data: Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::Item
              ]
            )
          )
        end
        ...
        sig do
          params(
            items:
              T::Array[
                Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::Item::OrHash
              ]
          ).void
        end
        attr_writer :items
        ...
        class Item < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media
                ]
              )
            )
          end
          ...
          sig do
            params(
              media:
                T::Array[
                  Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::OrHash
                ]
            ).void
          end
          attr_writer :media
          ...
          class Media < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              params(
                files:
                  Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::OrHash
              ).void
            end
            attr_writer :files
            ...
            class Files < Onlyfans::Internal::Type::BaseModel
              ...
              sig do
                params(
                  full:
                    Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::Full::OrHash
                ).void
              end
              attr_writer :full
              ...
              sig do
                params(
                  preview:
                    Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::Preview::OrHash
                ).void
              end
              attr_writer :preview
              ...
              sig do
                params(
                  square_preview:
                    Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::SquarePreview::OrHash
                ).void
              end
              ...
              sig do
                params(
                  thumb:
                    Onlyfans::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::Thumb::OrHash
                ).void
              end
              attr_writer :thumb
