...
module Onlyfans
  module Models
    class FanListAllParams < Onlyfans::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Onlyfans::FanListAllParams, Onlyfans::Internal::AnyHash)
        end

      sig { returns(String) }
      attr_accessor :account

      sig { returns(T.nilable(Onlyfans::FanListAllParams::Filter)) }
      attr_reader :filter

      sig { params(filter: Onlyfans::FanListAllParams::Filter::OrHash).void }
      attr_writer :filter
      ...
      # Filter by fan type.
      sig { returns(T.nilable(Onlyfans::FanListAllParams::Type::OrSymbol)) }
      attr_reader :type

      sig { params(type: Onlyfans::FanListAllParams::Type::OrSymbol).void }
      attr_writer :type
      ...
      sig do
        override.returns(
          {
            account: String,
            filter: Onlyfans::FanListAllParams::Filter,
            limit: Integer,
            offset: Integer,
            query: T.nilable(String),
            type: Onlyfans::FanListAllParams::Type::OrSymbol,
      ...
      class Filter < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::FanListAllParams::Filter,
        ...
        sig do
          returns(
            T.nilable(Onlyfans::FanListAllParams::Filter::Online::OrInteger)
          )
        end
          ...
          override.returns(
            {
              ...
              online:
                T.nilable(
                  Onlyfans::FanListAllParams::Filter::Online::OrInteger
                ),
              tips: Integer,
              total_spent: Integer
            }
        ...
        module Online
          ...
          TaggedInteger =
            T.type_alias do
              T.all(Integer, Onlyfans::FanListAllParams::Filter::Online)
            end
          OrInteger = T.type_alias { Integer }

          ONLINE_1 =
            T.let(1, Onlyfans::FanListAllParams::Filter::Online::TaggedInteger)
          ONLINE_0 =
            T.let(0, Onlyfans::FanListAllParams::Filter::Online::TaggedInteger)

          sig do
            override.returns(
              T::Array[
                Onlyfans::FanListAllParams::Filter::Online::TaggedInteger
              ]
            )
          end
          def self.values
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Onlyfans::FanListAllParams::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ACTIVE = T.let(:active, Onlyfans::FanListAllParams::Type::TaggedSymbol)
        EXPIRED =
          T.let(:expired, Onlyfans::FanListAllParams::Type::TaggedSymbol)
        ALL = T.let(:all, Onlyfans::FanListAllParams::Type::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Onlyfans::FanListAllParams::Type::TaggedSymbol]
          )
        end
        def self.values
        end
