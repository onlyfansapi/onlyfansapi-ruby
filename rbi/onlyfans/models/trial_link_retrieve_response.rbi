  ...
  module Models
    class TrialLinkRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::TrialLinkRetrieveResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfans::Models::TrialLinkRetrieveResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::TrialLinkRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfans::Models::TrialLinkRetrieveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::TrialLinkRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::TrialLinkRetrieveResponse::Meta,
            data: Onlyfans::Models::TrialLinkRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::TrialLinkRetrieveResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::TrialLinkRetrieveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::TrialLinkRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::TrialLinkRetrieveResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::TrialLinkRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::TrialLinkRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::TrialLinkRetrieveResponse::Meta::Cache,
              _credits:
                Onlyfans::Models::TrialLinkRetrieveResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::TrialLinkRetrieveResponse::Meta::RateLimits
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::TrialLinkRetrieveResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::TrialLinkRetrieveResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::TrialLinkRetrieveResponse::Data::Cost)
          )
        end
        attr_reader :cost
        ...
        sig do
          params(
            cost:
              Onlyfans::Models::TrialLinkRetrieveResponse::Data::Cost::OrHash
          ).void
        end
        attr_writer :cost
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::TrialLinkRetrieveResponse::Data::Links)
          )
        end
        attr_reader :links
        ...
        sig do
          params(
            links:
              Onlyfans::Models::TrialLinkRetrieveResponse::Data::Links::OrHash
          ).void
        end
        attr_writer :links
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::TrialLinkRetrieveResponse::Data::Revenue
            )
          )
        end
        attr_reader :revenue
        ...
        sig do
          params(
            revenue:
              Onlyfans::Models::TrialLinkRetrieveResponse::Data::Revenue::OrHash
          ).void
        end
        attr_writer :revenue
          ...
          override.returns(
            {
              ...
              claim_counts: Integer,
              clicks_counts: Integer,
              cost: Onlyfans::Models::TrialLinkRetrieveResponse::Data::Cost,
              created_at: String,
              expired_at: T.nilable(String),
              is_finished: T::Boolean,
              links: Onlyfans::Models::TrialLinkRetrieveResponse::Data::Links,
              revenue:
                Onlyfans::Models::TrialLinkRetrieveResponse::Data::Revenue,
              subscribe_counts: Integer,
              subscribe_days: Integer,
        ...
        class Cost < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::TrialLinkRetrieveResponse::Data::Cost,
                Onlyfans::Internal::AnyHash
              )
            end
        ...
        class Links < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::TrialLinkRetrieveResponse::Data::Links,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::TrialLinkRetrieveResponse::Data::Links::Related
              )
            )
          end
          attr_reader :related
          ...
          sig do
            params(
              related:
                Onlyfans::Models::TrialLinkRetrieveResponse::Data::Links::Related::OrHash
            ).void
          end
          attr_writer :related
