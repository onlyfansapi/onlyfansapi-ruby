    ...
    module Chats
      class MessageListResponse < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::Chats::MessageListResponse,
              Onlyfans::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Onlyfans::Models::Chats::MessageListResponse::Meta))
        end
        attr_reader :_meta

        sig do
          params(
            _meta: Onlyfans::Models::Chats::MessageListResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::Chats::MessageListResponse::Pagination)
          )
        end
        ...
        sig do
          params(
            _pagination:
              Onlyfans::Models::Chats::MessageListResponse::Pagination::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfans::Models::Chats::MessageListResponse::Data]
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              T::Array[
                Onlyfans::Models::Chats::MessageListResponse::Data::OrHash
              ]
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfans::Models::Chats::MessageListResponse::Meta,
              _pagination:
                Onlyfans::Models::Chats::MessageListResponse::Pagination,
              data: T::Array[Onlyfans::Models::Chats::MessageListResponse::Data]
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Chats::MessageListResponse::Meta,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Chats::MessageListResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfans::Models::Chats::MessageListResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Chats::MessageListResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfans::Models::Chats::MessageListResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfans::Models::Chats::MessageListResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Chats::MessageListResponse::Data,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              from_user:
                Onlyfans::Models::Chats::MessageListResponse::Data::FromUser::OrHash
            ).void
          end
