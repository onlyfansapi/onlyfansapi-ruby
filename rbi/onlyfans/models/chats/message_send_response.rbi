    ...
    module Chats
      class MessageSendResponse < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::Chats::MessageSendResponse,
              Onlyfans::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Onlyfans::Models::Chats::MessageSendResponse::Meta))
        end
        attr_reader :_meta

        sig do
          params(
            _meta: Onlyfans::Models::Chats::MessageSendResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::Chats::MessageSendResponse::Pagination)
          )
        end
        ...
        sig do
          params(
            _pagination:
              Onlyfans::Models::Chats::MessageSendResponse::Pagination::OrHash
          ).void
        end
        attr_writer :_pagination

        sig do
          returns(T.nilable(Onlyfans::Models::Chats::MessageSendResponse::Data))
        end
        attr_reader :data

        sig do
          params(
            data: Onlyfans::Models::Chats::MessageSendResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfans::Models::Chats::MessageSendResponse::Meta,
              _pagination:
                Onlyfans::Models::Chats::MessageSendResponse::Pagination,
              data: Onlyfans::Models::Chats::MessageSendResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Chats::MessageSendResponse::Meta,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Chats::MessageSendResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfans::Models::Chats::MessageSendResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfans::Models::Chats::MessageSendResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfans::Models::Chats::MessageSendResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfans::Models::Chats::MessageSendResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::Chats::MessageSendResponse::Data,
                Onlyfans::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              from_user:
                Onlyfans::Models::Chats::MessageSendResponse::Data::FromUser::OrHash
            ).void
          end
