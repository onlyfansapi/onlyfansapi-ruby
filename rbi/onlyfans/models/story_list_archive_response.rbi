  ...
  module Models
    class StoryListArchiveResponse < Onlyfans::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfans::Models::StoryListArchiveResponse,
            Onlyfans::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfans::Models::StoryListArchiveResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfans::Models::StoryListArchiveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfans::Models::StoryListArchiveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfans::Models::StoryListArchiveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfans::Models::StoryListArchiveResponse::Meta,
            data: Onlyfans::Models::StoryListArchiveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::StoryListArchiveResponse::Meta,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::StoryListArchiveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfans::Models::StoryListArchiveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfans::Models::StoryListArchiveResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfans::Models::StoryListArchiveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfans::Models::StoryListArchiveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfans::Models::StoryListArchiveResponse::Meta::Cache,
              _credits:
                Onlyfans::Models::StoryListArchiveResponse::Meta::Credits,
              _rate_limits:
                Onlyfans::Models::StoryListArchiveResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfans::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfans::Models::StoryListArchiveResponse::Meta::Cache,
                Onlyfans::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfans::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfans::Models::StoryListArchiveResponse::Data,
              Onlyfans::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfans::Models::StoryListArchiveResponse::Data::List]
            )
          )
        end
        attr_reader :list
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfans::Models::StoryListArchiveResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
          ...
          override.returns(
            {
              ...
              list:
                T::Array[
                  Onlyfans::Models::StoryListArchiveResponse::Data::List
                ],
              marker: Integer
            }
          )
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfans::Models::StoryListArchiveResponse::Data::List::Media
                ]
              )
            )
          end
          ...
          sig do
            params(
              media:
                T::Array[
                  Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::OrHash
                ]
            ).void
          end
          attr_writer :media
          ...
          def self.new(id: nil, created_at: nil, media: nil, question: nil)
          end
          ...
          class Media < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              params(
                files:
                  Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::OrHash
              ).void
            end
            attr_writer :files
            ...
            sig do
              params(
                video_sources:
                  Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::VideoSources::OrHash
              ).void
            end
            ...
            class Files < Onlyfans::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::Full
                  )
                )
              end
              attr_reader :full
              ...
              sig do
                params(
                  full:
                    Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::Full::OrHash
                ).void
              end
              attr_writer :full
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::Preview
                  )
                )
              end
              attr_reader :preview
              ...
              sig do
                params(
                  preview:
                    Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::Preview::OrHash
                ).void
              end
              attr_writer :preview
              ...
              sig do
                params(
                  square_preview:
                    Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::SquarePreview::OrHash
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::Thumb
                  )
                )
              end
              attr_reader :thumb
              ...
              sig do
                params(
                  thumb:
                    Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::Thumb::OrHash
                ).void
              end
              attr_writer :thumb
              ...
              class Preview < Onlyfans::Internal::Type::BaseModel
                ...
                sig do
                  params(
                    sources:
                      Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::Preview::Sources::OrHash
                  ).void
                end
                attr_writer :sources
              ...
              class SquarePreview < Onlyfans::Internal::Type::BaseModel
                ...
                sig do
                  params(
                    sources:
                      Onlyfans::Models::StoryListArchiveResponse::Data::List::Media::Files::SquarePreview::Sources::OrHash
                  ).void
                end
                attr_writer :sources
