...
module Onlyfans
  module Models
    class AccountListResponseItem < Onlyfans::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(String)) }
      attr_reader :authentication_progress

      sig { params(authentication_progress: String).void }
      attr_writer :authentication_progress
      ...
      sig { params(is_authenticated: T::Boolean).void }
      attr_writer :is_authenticated

      sig { returns(T.nilable(String)) }
      attr_reader :onlyfans_email

      sig { params(onlyfans_email: String).void }
      attr_writer :onlyfans_email
      ...
      sig do
        returns(
          T.nilable(Onlyfans::Models::AccountListResponseItem::OnlyfansUserData)
        )
      end
      ...
      sig do
        params(
          onlyfans_user_data:
            Onlyfans::Models::AccountListResponseItem::OnlyfansUserData::OrHash
        ).void
      end
      attr_writer :onlyfans_user_data

      sig { returns(T.nilable(String)) }
      attr_reader :onlyfans_username

      sig { params(onlyfans_username: String).void }
      attr_writer :onlyfans_username
        ...
        override.returns(
          {
            ...
            onlyfans_id: Integer,
            onlyfans_user_data:
              Onlyfans::Models::AccountListResponseItem::OnlyfansUserData,
            onlyfans_username: String
          }
        )
      end
      ...
      class OnlyfansUserData < Onlyfans::Internal::Type::BaseModel
        ...
        sig do
          params(
            avatar_thumbs:
              Onlyfans::Models::AccountListResponseItem::OnlyfansUserData::AvatarThumbs::OrHash
          ).void
        end
        ...
        sig do
          params(
            has_new_ticket_replies:
              Onlyfans::Models::AccountListResponseItem::OnlyfansUserData::HasNewTicketReplies::OrHash
          ).void
        end
        ...
        sig do
          params(
            header_size:
              Onlyfans::Models::AccountListResponseItem::OnlyfansUserData::HeaderSize::OrHash
          ).void
        end
        ...
        sig do
          params(
            header_thumbs:
              Onlyfans::Models::AccountListResponseItem::OnlyfansUserData::HeaderThumbs::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfans::Models::AccountListResponseItem::OnlyfansUserData::Upload
            )
          )
        end
        attr_reader :upload
        ...
        sig do
          params(
            upload:
              Onlyfans::Models::AccountListResponseItem::OnlyfansUserData::Upload::OrHash
          ).void
        end
        attr_writer :upload
        ...
        class Upload < Onlyfans::Internal::Type::BaseModel
          ...
          sig do
            params(
              geo_upload_args:
                Onlyfans::Models::AccountListResponseItem::OnlyfansUserData::Upload::GeoUploadArgs::OrHash
            ).void
          end
          ...
          class GeoUploadArgs < Onlyfans::Internal::Type::BaseModel
            ...
            sig do
              params(
                additional:
                  Onlyfans::Models::AccountListResponseItem::OnlyfansUserData::Upload::GeoUploadArgs::Additional::OrHash
              ).void
            end
