...
module Onlyfans
  ...
  AuthenticateReauthenticateParams =
    Onlyfans::Models::AuthenticateReauthenticateParams

  AuthenticateSend2faEmailParams =
    Onlyfans::Models::AuthenticateSend2faEmailParams
  ...
  ChargebackCalculateRatioParams =
    Onlyfans::Models::ChargebackCalculateRatioParams

  ChargebackListParams = Onlyfans::Models::ChargebackListParams

  ChargebackListStatisticsParams =
    Onlyfans::Models::ChargebackListStatisticsParams
  ...
  FanGetSubscriptionHistoryParams =
    Onlyfans::Models::FanGetSubscriptionHistoryParams
  ...
  SettingCheckUsernameAvailabilityParams =
    Onlyfans::Models::SettingCheckUsernameAvailabilityParams
  ...
  SharedTrialLinkRevokeAccessParams =
    Onlyfans::Models::SharedTrialLinkRevokeAccessParams
  ...
  SmartLinkPostbackCreateParams =
    Onlyfans::Models::SmartLinkPostbackCreateParams

  SmartLinkPostbackDeleteParams =
    Onlyfans::Models::SmartLinkPostbackDeleteParams
  ...
  SmartLinkPostbackUpdateParams =
    Onlyfans::Models::SmartLinkPostbackUpdateParams

  SmartLinkRetrieveCohortArpsParams =
    Onlyfans::Models::SmartLinkRetrieveCohortArpsParams
  ...
  StatisticCalculateTotalTransactionsParams =
    Onlyfans::Models::StatisticCalculateTotalTransactionsParams
  ...
  SubscriberRetrieveStatisticsParams =
    Onlyfans::Models::SubscriberRetrieveStatisticsParams
  ...
  TrackingLinkGetCohortArpsParams =
    Onlyfans::Models::TrackingLinkGetCohortArpsParams
  ...
  TrackingLinkListSpendersParams =
    Onlyfans::Models::TrackingLinkListSpendersParams

  TrackingLinkListSubscribersParams =
    Onlyfans::Models::TrackingLinkListSubscribersParams
  ...
  TrialLinkListSubscribersParams =
    Onlyfans::Models::TrialLinkListSubscribersParams

  TrialLinkRetrieveCohortArpsParams =
    Onlyfans::Models::TrialLinkRetrieveCohortArpsParams
