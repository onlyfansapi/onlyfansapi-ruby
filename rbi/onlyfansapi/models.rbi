...
module Onlyfansapi
  ...
  AuthenticatePollStatusParams =
    Onlyfansapi::Models::AuthenticatePollStatusParams

  AuthenticateReauthenticateParams =
    Onlyfansapi::Models::AuthenticateReauthenticateParams

  AuthenticateSend2faEmailParams =
    Onlyfansapi::Models::AuthenticateSend2faEmailParams
  ...
  BankingListAvailablePayoutSystemsParams =
  ...
  ChargebackCalculateRatioParams =
    Onlyfansapi::Models::ChargebackCalculateRatioParams

  ChargebackListParams = Onlyfansapi::Models::ChargebackListParams

  ChargebackListStatisticsParams =
    Onlyfansapi::Models::ChargebackListStatisticsParams
  ...
  FanGetSubscriptionHistoryParams =
    Onlyfansapi::Models::FanGetSubscriptionHistoryParams
  ...
  NotificationMarkAllAsReadParams =
    Onlyfansapi::Models::NotificationMarkAllAsReadParams

  Notifications = Onlyfansapi::Models::Notifications

  NotificationSearchUsersParams =
    Onlyfansapi::Models::NotificationSearchUsersParams

  PayoutListRequestsParams = Onlyfansapi::Models::PayoutListRequestsParams

  PayoutRequestManualWithdrawalParams =
    Onlyfansapi::Models::PayoutRequestManualWithdrawalParams

  PayoutRetrieveBalancesParams =
    Onlyfansapi::Models::PayoutRetrieveBalancesParams

  PayoutRetrieveEarningStatisticsParams =
    Onlyfansapi::Models::PayoutRetrieveEarningStatisticsParams

  PayoutRetrieveEligibilityParams =
    Onlyfansapi::Models::PayoutRetrieveEligibilityParams
  ...
  ReleaseFormListTaggableUsersParams =
    Onlyfansapi::Models::ReleaseFormListTaggableUsersParams
  ...
  SettingCheckUsernameAvailabilityParams =
    Onlyfansapi::Models::SettingCheckUsernameAvailabilityParams
  ...
  SettingUpdateSubscriptionPriceParams =
    Onlyfansapi::Models::SettingUpdateSubscriptionPriceParams

  SharedTrackingLinkListParams =
    Onlyfansapi::Models::SharedTrackingLinkListParams

  SharedTrackingLinkRevokeAccessParams =
    Onlyfansapi::Models::SharedTrackingLinkRevokeAccessParams
  ...
  SharedTrialLinkRevokeAccessParams =
    Onlyfansapi::Models::SharedTrialLinkRevokeAccessParams
  ...
  SmartLinkPostbackCreateParams =
    Onlyfansapi::Models::SmartLinkPostbackCreateParams

  SmartLinkPostbackDeleteParams =
    Onlyfansapi::Models::SmartLinkPostbackDeleteParams
  ...
  SmartLinkPostbackUpdateParams =
    Onlyfansapi::Models::SmartLinkPostbackUpdateParams

  SmartLinkRetrieveCohortArpsParams =
    Onlyfansapi::Models::SmartLinkRetrieveCohortArpsParams

  SmartLinkRetrieveParams = Onlyfansapi::Models::SmartLinkRetrieveParams

  SmartLinkRetrieveStatsParams =
    Onlyfansapi::Models::SmartLinkRetrieveStatsParams
  ...
  StoredListSharedTrackingLinksParams =
    Onlyfansapi::Models::StoredListSharedTrackingLinksParams

  StoredListSharedTrialLinksParams =
    Onlyfansapi::Models::StoredListSharedTrialLinksParams

  StoredListTrackingLinksParams =
    Onlyfansapi::Models::StoredListTrackingLinksParams
  ...
  SubscriberRetrieveStatisticsParams =
    Onlyfansapi::Models::SubscriberRetrieveStatisticsParams
  ...
  TrackingLinkGetCohortArpsParams =
    Onlyfansapi::Models::TrackingLinkGetCohortArpsParams
  ...
  TrackingLinkListSpendersParams =
    Onlyfansapi::Models::TrackingLinkListSpendersParams

  TrackingLinkListSubscribersParams =
    Onlyfansapi::Models::TrackingLinkListSubscribersParams
  ...
  TrialLinkListSubscribersParams =
    Onlyfansapi::Models::TrialLinkListSubscribersParams

  TrialLinkRetrieveCohortArpsParams =
    Onlyfansapi::Models::TrialLinkRetrieveCohortArpsParams

  TrialLinkRetrieveParams = Onlyfansapi::Models::TrialLinkRetrieveParams

  TrialLinkRetrieveStatsParams =
    Onlyfansapi::Models::TrialLinkRetrieveStatsParams
