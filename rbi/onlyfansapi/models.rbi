...
module Onlyfansapi
  ...
  ChatStartTypingIndicatorParams =
    Onlyfansapi::Models::ChatStartTypingIndicatorParams
  ...
  MassMessagingListQueueParams =
    Onlyfansapi::Models::MassMessagingListQueueParams
  ...
  PayoutListPayoutRequestsParams =
    Onlyfansapi::Models::PayoutListPayoutRequestsParams
  ...
  PayoutUpdatePayoutFrequencyParams =
    Onlyfansapi::Models::PayoutUpdatePayoutFrequencyParams
  ...
  SettingCheckUsernameExistsParams =
    Onlyfansapi::Models::SettingCheckUsernameExistsParams
