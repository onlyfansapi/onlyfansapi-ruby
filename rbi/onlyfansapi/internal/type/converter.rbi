  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Onlyfansapi::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Onlyfansapi::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Onlyfansapi::Internal::Type::Converter::Input,
              value: T.anything,
              state: Onlyfansapi::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
