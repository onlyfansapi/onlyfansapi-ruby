  ...
  module Models
    class FollowingListActiveParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::FollowingListActiveParams,
      ...
      sig { returns(T.nilable(Onlyfansapi::FollowingListActiveParams::Filter)) }
      attr_reader :filter
      ...
      class Filter < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::FollowingListActiveParams::Filter,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::FollowingListActiveParams::Filter::Online::OrInteger
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::FollowingListActiveParams::Filter::Paid::OrInteger
            )
          )
        end
        attr_accessor :paid
        ...
        module Online
          ...
          TaggedInteger =
            T.type_alias do
              T.all(
                Integer,
                Onlyfansapi::FollowingListActiveParams::Filter::Online
              )
            end
        ...
        module Paid
          ...
          TaggedInteger =
            T.type_alias do
              T.all(
                Integer,
                Onlyfansapi::FollowingListActiveParams::Filter::Paid
              )
            end
          OrInteger = T.type_alias { Integer }
