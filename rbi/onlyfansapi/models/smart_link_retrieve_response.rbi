  ...
  module Models
    class SmartLinkRetrieveResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::SmartLinkRetrieveResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfansapi::Models::SmartLinkRetrieveResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::SmartLinkRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfansapi::Models::SmartLinkRetrieveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfansapi::Models::SmartLinkRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::SmartLinkRetrieveResponse::Meta,
            data: Onlyfansapi::Models::SmartLinkRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Data::Account
            )
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Data::Account::OrHash
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Data::Cost
            )
          )
        end
        attr_reader :cost
        ...
        sig do
          params(
            cost:
              Onlyfansapi::Models::SmartLinkRetrieveResponse::Data::Cost::OrHash
          ).void
        end
        attr_writer :cost
          ...
          override.returns(
            {
              ...
              clicks_count: Integer,
              conversions_count: Integer,
              cost: Onlyfansapi::Models::SmartLinkRetrieveResponse::Data::Cost,
              created_at: String,
              free_trial_days: Integer,
              link_type: String,
              name: String,
