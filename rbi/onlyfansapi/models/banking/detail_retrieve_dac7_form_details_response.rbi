    ...
    module Banking
      class DetailRetrieveDac7FormDetailsResponse < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::Banking::DetailRetrieveDac7FormDetailsResponse,
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::Banking::DetailRetrieveDac7FormDetailsResponse::Meta
            )
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta:
              Onlyfansapi::Models::Banking::DetailRetrieveDac7FormDetailsResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::Banking::DetailRetrieveDac7FormDetailsResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Onlyfansapi::Models::Banking::DetailRetrieveDac7FormDetailsResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::Banking::DetailRetrieveDac7FormDetailsResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfansapi::Models::Banking::DetailRetrieveDac7FormDetailsResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            params(
              _credits:
                Onlyfansapi::Models::Banking::DetailRetrieveDac7FormDetailsResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfansapi::Models::Banking::DetailRetrieveDac7FormDetailsResponse::Meta::RateLimits::OrHash
            ).void
          end
