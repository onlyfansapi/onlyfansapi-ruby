  ...
  module Models
    class SmartLinkRetrieveCohortArpsParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::SmartLinkRetrieveCohortArpsParams,
      ...
      module RevenueBasis
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Onlyfansapi::SmartLinkRetrieveCohortArpsParams::RevenueBasis
            )
          end
        ...
        NET =
          T.let(
            :net,
            Onlyfansapi::SmartLinkRetrieveCohortArpsParams::RevenueBasis::TaggedSymbol
          )
        GROSS =
          T.let(
            :gross,
