...
module Onlyfansapi
  module Models
    class TrackingLinkRetrieveResponse < Onlyfansapi::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta)
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta: Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        params(
          _meta:
            Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta::OrHash,
          data: Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::OrHash
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta,
            data: Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta::RateLimits
            )
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::Cost
            )
          )
        end
        attr_reader :cost
        ...
        sig do
          params(
            cost:
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::Cost::OrHash
          ).void
        end
        attr_writer :cost
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::Links
            )
          )
        end
        attr_reader :links
        ...
        sig do
          params(
            links:
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::Links::OrHash
          ).void
        end
        attr_writer :links
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::Revenue
            )
          )
        end
        attr_reader :revenue
        ...
        sig do
          params(
            revenue:
              Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::Revenue::OrHash
          ).void
        end
        attr_writer :revenue
        ...
        class Links < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::Links::Related
              )
            )
          end
          attr_reader :related
          ...
          sig do
            params(
              related:
                Onlyfansapi::Models::TrackingLinkRetrieveResponse::Data::Links::Related::OrHash
            ).void
          end
          attr_writer :related
