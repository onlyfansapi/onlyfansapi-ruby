...
module Onlyfansapi
  module Models
    class AuthenticateStartParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Onlyfansapi::AuthenticateStartParams::AuthType::OrSymbol)
        )
      end
      ...
      sig do
        params(
          auth_type: Onlyfansapi::AuthenticateStartParams::AuthType::OrSymbol
        ).void
      end
      ...
      sig do
        returns(T.nilable(Onlyfansapi::AuthenticateStartParams::CustomProxy))
      end
      ...
      sig do
        params(
          custom_proxy:
            Onlyfansapi::AuthenticateStartParams::CustomProxy::OrHash
        ).void
      end
        ...
        override.returns(
          {
            ...
            auth_type: Onlyfansapi::AuthenticateStartParams::AuthType::OrSymbol,
            cookies: String,
            custom_proxy: Onlyfansapi::AuthenticateStartParams::CustomProxy,
            email: String,
            force_connect: T::Boolean,
            name: String,
            password: String,
      ...
      module AuthType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Onlyfansapi::AuthenticateStartParams::AuthType)
          end
        ...
        EMAIL_PASSWORD =
          T.let(
            :email_password,
            Onlyfansapi::AuthenticateStartParams::AuthType::TaggedSymbol
          )
        RAW_DATA =
          T.let(
            :raw_data,
      ...
      class CustomProxy < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::AuthenticateStartParams::CustomProxy,
              Onlyfansapi::Internal::AnyHash
            )
          end
