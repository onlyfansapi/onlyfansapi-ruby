  ...
  module Models
    class StoredListSharedTrackingLinksResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::StoredListSharedTrackingLinksResponse,
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Meta
          )
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta:
            Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Pagination
          )
        )
      end
      ...
      sig do
        params(
          _pagination:
            Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Pagination::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Data
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Data::List
              ]
            )
          )
        end
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Data::List::Owner
              )
            )
          end
          attr_reader :owner
          ...
          sig do
            params(
              owner:
                Onlyfansapi::Models::StoredListSharedTrackingLinksResponse::Data::List::Owner::OrHash
            ).void
          end
          attr_writer :owner
