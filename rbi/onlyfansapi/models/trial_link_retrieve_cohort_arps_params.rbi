  ...
  module Models
    class TrialLinkRetrieveCohortArpsParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::TrialLinkRetrieveCohortArpsParams,
      ...
      module RevenueBasis
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Onlyfansapi::TrialLinkRetrieveCohortArpsParams::RevenueBasis
            )
          end
        ...
        NET =
          T.let(
            :net,
            Onlyfansapi::TrialLinkRetrieveCohortArpsParams::RevenueBasis::TaggedSymbol
          )
        GROSS =
          T.let(
            :gross,
