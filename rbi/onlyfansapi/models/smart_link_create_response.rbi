  ...
  module Models
    class SmartLinkCreateResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::SmartLinkCreateResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfansapi::Models::SmartLinkCreateResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::SmartLinkCreateResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfansapi::Models::SmartLinkCreateResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfansapi::Models::SmartLinkCreateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::SmartLinkCreateResponse::Meta,
            data: Onlyfansapi::Models::SmartLinkCreateResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::SmartLinkCreateResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::SmartLinkCreateResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::SmartLinkCreateResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkCreateResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::SmartLinkCreateResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::SmartLinkCreateResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfansapi::Models::SmartLinkCreateResponse::Meta::Cache,
              _credits:
                Onlyfansapi::Models::SmartLinkCreateResponse::Meta::Credits,
              _rate_limits:
                Onlyfansapi::Models::SmartLinkCreateResponse::Meta::RateLimits
        ...
        class Cache < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::SmartLinkCreateResponse::Meta::Cache,
                Onlyfansapi::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::SmartLinkCreateResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkCreateResponse::Data::Account
            )
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              Onlyfansapi::Models::SmartLinkCreateResponse::Data::Account::OrHash
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::SmartLinkCreateResponse::Data::Cost)
          )
        end
        attr_reader :cost
        ...
        sig do
          params(
            cost:
              Onlyfansapi::Models::SmartLinkCreateResponse::Data::Cost::OrHash
          ).void
        end
        attr_writer :cost
          ...
          override.returns(
            {
              ...
              clicks_count: Integer,
              conversions_count: Integer,
              cost: Onlyfansapi::Models::SmartLinkCreateResponse::Data::Cost,
              created_at: String,
              free_trial_days: Integer,
              link_type: String,
              name: String,
        ...
        class Cost < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::SmartLinkCreateResponse::Data::Cost,
                Onlyfansapi::Internal::AnyHash
              )
            end
