  ...
  module Models
    class MassMessagingRetrieveResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::MassMessagingRetrieveResponse,
      ...
      sig do
        returns(
          T.nilable(Onlyfansapi::Models::MassMessagingRetrieveResponse::Meta)
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta:
            Onlyfansapi::Models::MassMessagingRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfansapi::Models::MassMessagingRetrieveResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Onlyfansapi::Models::MassMessagingRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::MassMessagingRetrieveResponse::Meta,
            data: Onlyfansapi::Models::MassMessagingRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::MassMessagingRetrieveResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::MassMessagingRetrieveResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::MassMessagingRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::MassMessagingRetrieveResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::MassMessagingRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::MassMessagingRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::MassMessagingRetrieveResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::MassMessagingRetrieveResponse::Data::Queue
            )
          )
        end
        attr_reader :queue
        ...
        sig do
          params(
            queue:
              Onlyfansapi::Models::MassMessagingRetrieveResponse::Data::Queue::OrHash
          ).void
        end
        attr_writer :queue
