  ...
  module Models
    class PromotionCreateParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::PromotionCreateParams,
      ...
      # promotions.**
      sig { returns(Onlyfansapi::PromotionCreateParams::Type::OrSymbol) }
      attr_accessor :type
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Onlyfansapi::PromotionCreateParams::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        NEW =
          T.let(:new, Onlyfansapi::PromotionCreateParams::Type::TaggedSymbol)
        EXPIRED =
          T.let(
            :expired,
            Onlyfansapi::PromotionCreateParams::Type::TaggedSymbol
          )
        NEW_AND_EXPIRED =
          T.let(
            :new_and_expired,
        ...
        sig do
          override.returns(
            T::Array[Onlyfansapi::PromotionCreateParams::Type::TaggedSymbol]
          )
        end
        def self.values
        end
