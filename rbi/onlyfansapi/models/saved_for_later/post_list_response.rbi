    ...
    module SavedForLater
      class PostListResponse < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::SavedForLater::PostListResponse,
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SavedForLater::PostListResponse::Meta
            )
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta:
              Onlyfansapi::Models::SavedForLater::PostListResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SavedForLater::PostListResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Onlyfansapi::Models::SavedForLater::PostListResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfansapi::Models::SavedForLater::PostListResponse::Meta,
              data: Onlyfansapi::Models::SavedForLater::PostListResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::SavedForLater::PostListResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfansapi::Models::SavedForLater::PostListResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::SavedForLater::PostListResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfansapi::Models::SavedForLater::PostListResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfansapi::Models::SavedForLater::PostListResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfansapi::Models::SavedForLater::PostListResponse::Data::List
                ]
              )
            )
          end
          ...
          sig do
            params(
              list:
                T::Array[
                  Onlyfansapi::Models::SavedForLater::PostListResponse::Data::List::OrHash
                ]
            ).void
          end
          attr_writer :list
