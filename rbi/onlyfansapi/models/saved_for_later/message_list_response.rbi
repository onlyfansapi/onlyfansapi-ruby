    ...
    module SavedForLater
      class MessageListResponse < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::SavedForLater::MessageListResponse,
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta
            )
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta:
              Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SavedForLater::MessageListResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Onlyfansapi::Models::SavedForLater::MessageListResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfansapi::Models::SavedForLater::MessageListResponse::Data::List
                ]
              )
            )
          end
          ...
          sig do
            params(
              list:
                T::Array[
                  Onlyfansapi::Models::SavedForLater::MessageListResponse::Data::List::OrHash
                ]
            ).void
          end
          attr_writer :list
