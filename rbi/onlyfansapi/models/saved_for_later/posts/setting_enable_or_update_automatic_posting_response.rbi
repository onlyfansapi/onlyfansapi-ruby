      ...
      module Posts
        class SettingEnableOrUpdateAutomaticPostingResponse < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            params(
              _meta:
                Onlyfansapi::Models::SavedForLater::Posts::SettingEnableOrUpdateAutomaticPostingResponse::Meta::OrHash
            ).void
          end
          attr_writer :_meta
          ...
          sig do
            params(
              data:
                Onlyfansapi::Models::SavedForLater::Posts::SettingEnableOrUpdateAutomaticPostingResponse::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          class Meta < Onlyfansapi::Internal::Type::BaseModel
            ...
            sig do
              params(
                _cache:
                  Onlyfansapi::Models::SavedForLater::Posts::SettingEnableOrUpdateAutomaticPostingResponse::Meta::Cache::OrHash
              ).void
            end
            attr_writer :_cache
            ...
            sig do
              params(
                _credits:
                  Onlyfansapi::Models::SavedForLater::Posts::SettingEnableOrUpdateAutomaticPostingResponse::Meta::Credits::OrHash
              ).void
            end
            ...
            sig do
              params(
                _rate_limits:
                  Onlyfansapi::Models::SavedForLater::Posts::SettingEnableOrUpdateAutomaticPostingResponse::Meta::RateLimits::OrHash
              ).void
            end
