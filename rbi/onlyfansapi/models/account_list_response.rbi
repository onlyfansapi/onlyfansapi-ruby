  ...
  module Models
    class AccountListResponseItem < Onlyfansapi::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData
          )
        )
      end
      ...
      sig do
        params(
          onlyfans_user_data:
            Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData::OrHash
        ).void
      end
      ...
      class OnlyfansUserData < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          params(
            avatar_thumbs:
              Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData::AvatarThumbs::OrHash
          ).void
        end
        ...
        sig do
          params(
            has_new_ticket_replies:
              Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData::HasNewTicketReplies::OrHash
          ).void
        end
        ...
        sig do
          params(
            header_size:
              Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData::HeaderSize::OrHash
          ).void
        end
        ...
        sig do
          params(
            header_thumbs:
              Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData::HeaderThumbs::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData::Upload
            )
          )
        end
        attr_reader :upload
        ...
        sig do
          params(
            upload:
              Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData::Upload::OrHash
          ).void
        end
        attr_writer :upload
        ...
        class Upload < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            params(
              geo_upload_args:
                Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData::Upload::GeoUploadArgs::OrHash
            ).void
          end
          ...
          class GeoUploadArgs < Onlyfansapi::Internal::Type::BaseModel
            ...
            sig do
              params(
                additional:
                  Onlyfansapi::Models::AccountListResponseItem::OnlyfansUserData::Upload::GeoUploadArgs::Additional::OrHash
              ).void
            end
