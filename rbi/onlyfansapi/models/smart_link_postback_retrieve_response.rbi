  ...
  module Models
    class SmartLinkPostbackRetrieveResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse,
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Meta
          )
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta:
            Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Data
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Meta,
            data: Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Data::SmartLink
              ]
            )
          )
        end
        ...
        sig do
          params(
            smart_links:
              T::Array[
                Onlyfansapi::Models::SmartLinkPostbackRetrieveResponse::Data::SmartLink::OrHash
              ]
          ).void
        end
