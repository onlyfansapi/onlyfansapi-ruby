...
module Onlyfansapi
  module Models
    class UserListListResponse < Onlyfansapi::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(Onlyfansapi::Models::UserListListResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::UserListListResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(T::Array[Onlyfansapi::Models::UserListListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            T::Array[Onlyfansapi::Models::UserListListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::UserListListResponse::Meta,
            data: T::Array[Onlyfansapi::Models::UserListListResponse::Data]
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::UserListListResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::UserListListResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::UserListListResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::UserListListResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::UserListListResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::UserListListResponse::Meta::RateLimits
            )
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::UserListListResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfansapi::Models::UserListListResponse::Meta::Cache,
              _credits:
                Onlyfansapi::Models::UserListListResponse::Meta::Credits,
              _rate_limits:
                Onlyfansapi::Models::UserListListResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::UserListListResponse::Meta::Cache,
                Onlyfansapi::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::UserListListResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
