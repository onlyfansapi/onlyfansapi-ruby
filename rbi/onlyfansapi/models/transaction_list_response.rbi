  ...
  module Models
    class TransactionListResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::TransactionListResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfansapi::Models::TransactionListResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::TransactionListResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfansapi::Models::TransactionListResponse::Pagination)
        )
      end
      ...
      sig do
        params(
          _pagination:
            Onlyfansapi::Models::TransactionListResponse::Pagination::OrHash
        ).void
      end
      attr_writer :_pagination

      sig do
        returns(T.nilable(Onlyfansapi::Models::TransactionListResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfansapi::Models::TransactionListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::TransactionListResponse::Meta,
            _pagination:
              Onlyfansapi::Models::TransactionListResponse::Pagination,
            data: Onlyfansapi::Models::TransactionListResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::TransactionListResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::TransactionListResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::TransactionListResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TransactionListResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::TransactionListResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::TransactionListResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfansapi::Models::TransactionListResponse::Meta::Cache,
              _credits:
                Onlyfansapi::Models::TransactionListResponse::Meta::Credits,
              _rate_limits:
                Onlyfansapi::Models::TransactionListResponse::Meta::RateLimits
        ...
        class Cache < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::TransactionListResponse::Meta::Cache,
                Onlyfansapi::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::TransactionListResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfansapi::Models::TransactionListResponse::Data::List]
            )
          )
        end
        attr_reader :list
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfansapi::Models::TransactionListResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
          ...
          override.returns(
            {
              ...
              list:
                T::Array[
                  Onlyfansapi::Models::TransactionListResponse::Data::List
                ],
              marker: Integer,
              next_marker: Integer
            }
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          class User < Onlyfansapi::Internal::Type::BaseModel
            ...
            sig do
              params(
                avatar_thumbs:
                  Onlyfansapi::Models::TransactionListResponse::Data::List::User::AvatarThumbs::OrHash
              ).void
            end
