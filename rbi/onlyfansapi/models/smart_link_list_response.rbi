  ...
  module Models
    class SmartLinkListResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::SmartLinkListResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfansapi::Models::SmartLinkListResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::SmartLinkListResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(T::Array[Onlyfansapi::Models::SmartLinkListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            T::Array[Onlyfansapi::Models::SmartLinkListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            ...
            data: T::Array[Onlyfansapi::Models::SmartLinkListResponse::Data]
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::SmartLinkListResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::SmartLinkListResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::SmartLinkListResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::SmartLinkListResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkListResponse::Meta::RateLimits
            )
          )
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::SmartLinkListResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfansapi::Models::SmartLinkListResponse::Meta::Cache,
              _credits:
                Onlyfansapi::Models::SmartLinkListResponse::Meta::Credits,
              _rate_limits:
                Onlyfansapi::Models::SmartLinkListResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::SmartLinkListResponse::Meta::Cache,
                Onlyfansapi::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::SmartLinkListResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::SmartLinkListResponse::Data::Account)
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              Onlyfansapi::Models::SmartLinkListResponse::Data::Account::OrHash
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::SmartLinkListResponse::Data::Cost)
          )
        end
        attr_reader :cost
        ...
        sig do
          params(
            cost: Onlyfansapi::Models::SmartLinkListResponse::Data::Cost::OrHash
          ).void
        end
        attr_writer :cost
        ...
        sig do
          params(
            ...
            cost:
              Onlyfansapi::Models::SmartLinkListResponse::Data::Cost::OrHash,
            created_at: String,
          ...
          override.returns(
            {
              id: String,
              account:
                Onlyfansapi::Models::SmartLinkListResponse::Data::Account,
              clicks_count: Integer,
              conversions_count: Integer,
              cost: Onlyfansapi::Models::SmartLinkListResponse::Data::Cost,
              created_at: String,
              free_trial_days: Integer,
              link_type: String,
              name: String,
        ...
        class Cost < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::SmartLinkListResponse::Data::Cost,
                Onlyfansapi::Internal::AnyHash
              )
            end
