  ...
  module Models
    class StoryRetrieveResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::StoryRetrieveResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfansapi::Models::StoryRetrieveResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::StoryRetrieveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfansapi::Models::StoryRetrieveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfansapi::Models::StoryRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::StoryRetrieveResponse::Meta,
            data: Onlyfansapi::Models::StoryRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::StoryRetrieveResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::StoryRetrieveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::StoryRetrieveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::StoryRetrieveResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::StoryRetrieveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::StoryRetrieveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfansapi::Models::StoryRetrieveResponse::Meta::Cache,
              _credits:
                Onlyfansapi::Models::StoryRetrieveResponse::Meta::Credits,
              _rate_limits:
                Onlyfansapi::Models::StoryRetrieveResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::StoryRetrieveResponse::Meta::Cache,
                Onlyfansapi::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::StoryRetrieveResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfansapi::Models::StoryRetrieveResponse::Data::Media]
            )
          )
        end
        attr_reader :media
        ...
        sig do
          params(
            media:
              T::Array[
                Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::OrHash
              ]
          ).void
        end
        attr_writer :media
          ...
          override.returns(
            {
              ...
              media:
                T::Array[
                  Onlyfansapi::Models::StoryRetrieveResponse::Data::Media
                ],
              question: T.nilable(String),
              release_forms: T::Array[T.anything],
              tips_amount: String,
        ...
        class Media < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            params(
              files:
                Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::OrHash
            ).void
          end
          attr_writer :files
          ...
          sig do
            params(
              video_sources:
                Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::VideoSources::OrHash
            ).void
          end
          ...
          class Files < Onlyfansapi::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::Full
                )
              )
            end
            attr_reader :full
            ...
            sig do
              params(
                full:
                  Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::Full::OrHash
              ).void
            end
            attr_writer :full
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::Preview
                )
              )
            end
            attr_reader :preview
            ...
            sig do
              params(
                preview:
                  Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::Preview::OrHash
              ).void
            end
            attr_writer :preview
            ...
            sig do
              params(
                square_preview:
                  Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::SquarePreview::OrHash
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::Thumb
                )
              )
            end
            attr_reader :thumb
            ...
            sig do
              params(
                thumb:
                  Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::Thumb::OrHash
              ).void
            end
            attr_writer :thumb
            ...
            class Preview < Onlyfansapi::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::Preview::Sources
                  )
                )
              end
              attr_reader :sources
              ...
              sig do
                params(
                  sources:
                    Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::Preview::Sources::OrHash
                ).void
              end
              attr_writer :sources
            ...
            class SquarePreview < Onlyfansapi::Internal::Type::BaseModel
              ...
              sig do
                params(
                  sources:
                    Onlyfansapi::Models::StoryRetrieveResponse::Data::Media::Files::SquarePreview::Sources::OrHash
                ).void
              end
              attr_writer :sources
