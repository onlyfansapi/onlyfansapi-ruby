    ...
    module UserLists
      class UserClearResponse < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::UserLists::UserClearResponse,
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::UserLists::UserClearResponse::Meta)
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta:
              Onlyfansapi::Models::UserLists::UserClearResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::UserLists::UserClearResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Onlyfansapi::Models::UserLists::UserClearResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfansapi::Models::UserLists::UserClearResponse::Meta,
              data: Onlyfansapi::Models::UserLists::UserClearResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::UserLists::UserClearResponse::Meta,
                Onlyfansapi::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfansapi::Models::UserLists::UserClearResponse::Meta::RateLimits::OrHash
            ).void
          end
