  ...
  module Models
    class MassMessagingRetrieveOverviewResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse,
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Meta
          )
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta:
            Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item
              ]
            )
          )
        end
        ...
        sig do
          params(
            items:
              T::Array[
                Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item::OrHash
              ]
          ).void
        end
        attr_writer :items
        ...
        class Item < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media
                ]
              )
            )
          end
          ...
          sig do
            params(
              media:
                T::Array[
                  Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::OrHash
                ]
            ).void
          end
          attr_writer :media
          ...
          class Media < Onlyfansapi::Internal::Type::BaseModel
            ...
            sig do
              params(
                files:
                  Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::OrHash
              ).void
            end
            attr_writer :files
            ...
            sig do
              params(
                video_sources:
                  Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::VideoSources::OrHash
              ).void
            end
            ...
            class Files < Onlyfansapi::Internal::Type::BaseModel
              ...
              sig do
                params(
                  full:
                    Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::Full::OrHash
                ).void
              end
              attr_writer :full
              ...
              sig do
                params(
                  preview:
                    Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::Preview::OrHash
                ).void
              end
              attr_writer :preview
              ...
              sig do
                params(
                  square_preview:
                    Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::SquarePreview::OrHash
                ).void
              end
              ...
              sig do
                params(
                  thumb:
                    Onlyfansapi::Models::MassMessagingRetrieveOverviewResponse::Data::Item::Media::Files::Thumb::OrHash
                ).void
              end
              attr_writer :thumb
