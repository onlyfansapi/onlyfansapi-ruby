  ...
  module Models
    class PostArchiveResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::PostArchiveResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(Onlyfansapi::Models::PostArchiveResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::PostArchiveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfansapi::Models::PostArchiveResponse::Data)) }
      attr_reader :data

      sig do
        params(
          data: Onlyfansapi::Models::PostArchiveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::PostArchiveResponse::Meta,
            data: Onlyfansapi::Models::PostArchiveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::PostArchiveResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::PostArchiveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::PostArchiveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::PostArchiveResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::PostArchiveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::PostArchiveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfansapi::Models::PostArchiveResponse::Meta::Cache,
              _credits: Onlyfansapi::Models::PostArchiveResponse::Meta::Credits,
              _rate_limits:
                Onlyfansapi::Models::PostArchiveResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::PostArchiveResponse::Meta::Cache,
                Onlyfansapi::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::PostArchiveResponse::Meta::Credits,
                Onlyfansapi::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::PostArchiveResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::PostArchiveResponse::Data::Counters)
          )
        end
        ...
        sig do
          params(
            counters:
              Onlyfansapi::Models::PostArchiveResponse::Data::Counters::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::PostArchiveResponse::Data::LabelState
              ]
            )
          )
        end
        ...
        sig do
          params(
            label_states:
              T::Array[
                Onlyfansapi::Models::PostArchiveResponse::Data::LabelState::OrHash
              ]
          ).void
        end
        ...
        sig do
          override.returns(
            {
              counters:
                Onlyfansapi::Models::PostArchiveResponse::Data::Counters,
              label_states:
                T::Array[
                  Onlyfansapi::Models::PostArchiveResponse::Data::LabelState
                ]
