  ...
  module Models
    class PostUnarchiveResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::PostUnarchiveResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfansapi::Models::PostUnarchiveResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::PostUnarchiveResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfansapi::Models::PostUnarchiveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfansapi::Models::PostUnarchiveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::PostUnarchiveResponse::Meta,
            data: Onlyfansapi::Models::PostUnarchiveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::PostUnarchiveResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::PostUnarchiveResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::PostUnarchiveResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::PostUnarchiveResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::PostUnarchiveResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::PostUnarchiveResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfansapi::Models::PostUnarchiveResponse::Meta::Cache,
              _credits:
                Onlyfansapi::Models::PostUnarchiveResponse::Meta::Credits,
              _rate_limits:
                Onlyfansapi::Models::PostUnarchiveResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::PostUnarchiveResponse::Meta::Cache,
                Onlyfansapi::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::PostUnarchiveResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::PostUnarchiveResponse::Data::Counters
            )
          )
        end
        ...
        sig do
          params(
            counters:
              Onlyfansapi::Models::PostUnarchiveResponse::Data::Counters::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::PostUnarchiveResponse::Data::LabelState
              ]
            )
          )
        end
        ...
        sig do
          params(
            label_states:
              T::Array[
                Onlyfansapi::Models::PostUnarchiveResponse::Data::LabelState::OrHash
              ]
          ).void
        end
