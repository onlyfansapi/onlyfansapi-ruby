    ...
    module Chats
      class MessageSendResponse < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::Chats::MessageSendResponse,
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::Chats::MessageSendResponse::Meta)
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta: Onlyfansapi::Models::Chats::MessageSendResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::Chats::MessageSendResponse::Pagination
            )
          )
        end
        ...
        sig do
          params(
            _pagination:
              Onlyfansapi::Models::Chats::MessageSendResponse::Pagination::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::Chats::MessageSendResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data: Onlyfansapi::Models::Chats::MessageSendResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          params(
            _meta:
              Onlyfansapi::Models::Chats::MessageSendResponse::Meta::OrHash,
            _pagination:
              Onlyfansapi::Models::Chats::MessageSendResponse::Pagination::OrHash,
            data: Onlyfansapi::Models::Chats::MessageSendResponse::Data::OrHash
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfansapi::Models::Chats::MessageSendResponse::Meta,
              _pagination:
                Onlyfansapi::Models::Chats::MessageSendResponse::Pagination,
              data: Onlyfansapi::Models::Chats::MessageSendResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::Chats::MessageSendResponse::Meta,
                Onlyfansapi::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::Chats::MessageSendResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfansapi::Models::Chats::MessageSendResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::Chats::MessageSendResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfansapi::Models::Chats::MessageSendResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfansapi::Models::Chats::MessageSendResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::Chats::MessageSendResponse::Data,
                Onlyfansapi::Internal::AnyHash
              )
            end
