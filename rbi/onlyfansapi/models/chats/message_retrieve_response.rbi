    ...
    module Chats
      class MessageRetrieveResponse < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::Chats::MessageRetrieveResponse,
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta)
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta:
              Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta,
              data: Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta,
                Onlyfansapi::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            params(
              from_user:
                Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data::FromUser::OrHash
            ).void
          end
