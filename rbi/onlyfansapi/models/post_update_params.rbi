...
module Onlyfansapi
  module Models
    class PostUpdateParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Onlyfansapi::PostUpdateParams, Onlyfansapi::Internal::AnyHash)
        end
      ...
      sig do
        returns(T.nilable(Onlyfansapi::PostUpdateParams::VotingType::OrSymbol))
      end
      ...
      module VotingType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Onlyfansapi::PostUpdateParams::VotingType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        POLL =
          T.let(:poll, Onlyfansapi::PostUpdateParams::VotingType::TaggedSymbol)
        QUIZ =
          T.let(:quiz, Onlyfansapi::PostUpdateParams::VotingType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Onlyfansapi::PostUpdateParams::VotingType::TaggedSymbol]
          )
        end
        def self.values
        end
