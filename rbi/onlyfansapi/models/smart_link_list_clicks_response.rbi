  ...
  module Models
    class SmartLinkListClicksResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::SmartLinkListClicksResponse,
      ...
      sig do
        returns(
          T.nilable(Onlyfansapi::Models::SmartLinkListClicksResponse::Meta)
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta: Onlyfansapi::Models::SmartLinkListClicksResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfansapi::Models::SmartLinkListClicksResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Onlyfansapi::Models::SmartLinkListClicksResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::SmartLinkListClicksResponse::Meta,
            data: Onlyfansapi::Models::SmartLinkListClicksResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::SmartLinkListClicksResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkListClicksResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::SmartLinkListClicksResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkListClicksResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::SmartLinkListClicksResponse::Meta::Credits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::SmartLinkListClicksResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::SmartLinkListClicksResponse::Data::Chart
              ]
            )
          )
        end
        ...
        sig do
          params(
            chart:
              T::Array[
                Onlyfansapi::Models::SmartLinkListClicksResponse::Data::Chart::OrHash
              ]
          ).void
        end
        attr_writer :chart
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkListClicksResponse::Data::Filters
            )
          )
        end
        attr_reader :filters
        ...
        sig do
          params(
            filters:
              Onlyfansapi::Models::SmartLinkListClicksResponse::Data::Filters::OrHash
          ).void
        end
        attr_writer :filters
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::SmartLinkListClicksResponse::Data::Row
              ]
            )
          )
        end
        ...
        sig do
          params(
            rows:
              T::Array[
                Onlyfansapi::Models::SmartLinkListClicksResponse::Data::Row::OrHash
              ]
          ).void
        end
        attr_writer :rows
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::SmartLinkListClicksResponse::Data::Summary
            )
          )
        end
        attr_reader :summary
        ...
        sig do
          params(
            summary:
              Onlyfansapi::Models::SmartLinkListClicksResponse::Data::Summary::OrHash
          ).void
        end
        attr_writer :summary
