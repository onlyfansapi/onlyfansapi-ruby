  ...
  module Models
    class BankingListAvailablePayoutSystemsResponse < Onlyfansapi::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Meta
          )
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta:
            Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Data
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Data::Payout
              ]
            )
          )
        end
        ...
        sig do
          params(
            payouts:
              T::Array[
                Onlyfansapi::Models::BankingListAvailablePayoutSystemsResponse::Data::Payout::OrHash
              ]
          ).void
        end
        attr_writer :payouts
