  ...
  module Models
    class StoryListViewersResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::StoryListViewersResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfansapi::Models::StoryListViewersResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::StoryListViewersResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig do
        returns(T.nilable(Onlyfansapi::Models::StoryListViewersResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfansapi::Models::StoryListViewersResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::StoryListViewersResponse::Meta,
            data: Onlyfansapi::Models::StoryListViewersResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::StoryListViewersResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::StoryListViewersResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::StoryListViewersResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::StoryListViewersResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::StoryListViewersResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::StoryListViewersResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::StoryListViewersResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::StoryListViewersResponse::Data::List
              ]
            )
          )
        end
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfansapi::Models::StoryListViewersResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Onlyfansapi::Models::StoryListViewersResponse::Data::List::ListsState
                ]
              )
            )
          end
          ...
          sig do
            params(
              lists_states:
                T::Array[
                  Onlyfansapi::Models::StoryListViewersResponse::Data::List::ListsState::OrHash
                ]
            ).void
          end
