  ...
  module Models
    class ReleaseFormCreateInvitationLinkResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse,
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Meta
          )
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta:
            Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Data
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Data::User
            )
          )
        end
        attr_reader :user
        ...
        sig do
          params(
            user:
              Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Data::User::OrHash
          ).void
        end
        attr_writer :user
        ...
        class User < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            params(
              avatar_thumbs:
                Onlyfansapi::Models::ReleaseFormCreateInvitationLinkResponse::Data::User::AvatarThumbs::OrHash
            ).void
          end
