  ...
  module Models
    class TrackingLinkListResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::TrackingLinkListResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Onlyfansapi::Models::TrackingLinkListResponse::Meta))
      end
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::TrackingLinkListResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(Onlyfansapi::Models::TrackingLinkListResponse::Pagination)
        )
      end
      ...
      sig do
        params(
          _pagination:
            Onlyfansapi::Models::TrackingLinkListResponse::Pagination::OrHash
        ).void
      end
      attr_writer :_pagination

      sig do
        returns(T.nilable(Onlyfansapi::Models::TrackingLinkListResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Onlyfansapi::Models::TrackingLinkListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::TrackingLinkListResponse::Meta,
            _pagination:
              Onlyfansapi::Models::TrackingLinkListResponse::Pagination,
            data: Onlyfansapi::Models::TrackingLinkListResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::TrackingLinkListResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkListResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::TrackingLinkListResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkListResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::TrackingLinkListResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::TrackingLinkListResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::TrackingLinkListResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::TrackingLinkListResponse::Data::List
              ]
            )
          )
        end
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfansapi::Models::TrackingLinkListResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          class Links < Onlyfansapi::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfansapi::Models::TrackingLinkListResponse::Data::List::Links::Related
                )
              )
            end
            attr_reader :related
            ...
            sig do
              params(
                related:
                  Onlyfansapi::Models::TrackingLinkListResponse::Data::List::Links::Related::OrHash
              ).void
            end
            attr_writer :related
