      ...
      module Vault
        class ListRetrieveResponse < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::Media::Vault::ListRetrieveResponse,
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::Media::Vault::ListRetrieveResponse::Meta
              )
            )
          end
          attr_reader :_meta
          ...
          sig do
            params(
              _meta:
                Onlyfansapi::Models::Media::Vault::ListRetrieveResponse::Meta::OrHash
            ).void
          end
          attr_writer :_meta
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::Media::Vault::ListRetrieveResponse::Data
              )
            )
          end
          attr_reader :data
          ...
          sig do
            params(
              data:
                Onlyfansapi::Models::Media::Vault::ListRetrieveResponse::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          class Meta < Onlyfansapi::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfansapi::Models::Media::Vault::ListRetrieveResponse::Meta::Cache
                )
              )
            end
            attr_reader :_cache
            ...
            sig do
              params(
                _cache:
                  Onlyfansapi::Models::Media::Vault::ListRetrieveResponse::Meta::Cache::OrHash
              ).void
            end
            attr_writer :_cache
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfansapi::Models::Media::Vault::ListRetrieveResponse::Meta::Credits
                )
              )
            end
            ...
            sig do
              params(
                _credits:
                  Onlyfansapi::Models::Media::Vault::ListRetrieveResponse::Meta::Credits::OrHash
              ).void
            end
            ...
            sig do
              params(
                _rate_limits:
                  Onlyfansapi::Models::Media::Vault::ListRetrieveResponse::Meta::RateLimits::OrHash
              ).void
            end
