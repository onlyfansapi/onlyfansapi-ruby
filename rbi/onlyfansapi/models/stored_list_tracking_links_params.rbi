...
module Onlyfansapi
  module Models
    class StoredListTrackingLinksParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(Onlyfansapi::StoredListTrackingLinksParams::Filter))
      end
      attr_reader :filter
      ...
      sig do
        override.returns(
          {
            account: String,
            filter: Onlyfansapi::StoredListTrackingLinksParams::Filter,
            limit: Integer,
            offset: Integer,
      ...
      class Filter < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::StoredListTrackingLinksParams::Filter,
              Onlyfansapi::Internal::AnyHash
            )
          end
