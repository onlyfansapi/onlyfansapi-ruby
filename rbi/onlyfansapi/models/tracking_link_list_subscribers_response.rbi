  ...
  module Models
    class TrackingLinkListSubscribersResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::TrackingLinkListSubscribersResponse,
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta
          )
        )
      end
      attr_reader :_meta
      ...
      sig do
        params(
          _meta:
            Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta
      ...
      sig do
        returns(
          T.nilable(
            Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::OrHash
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            _meta:
              Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta,
            data: Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Cache
            )
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(
              Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Credits
            )
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::RateLimits::OrHash
          ).void
        end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List
              ]
            )
          )
        end
        ...
        sig do
          params(
            list:
              T::Array[
                Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List::OrHash
              ]
          ).void
        end
        attr_writer :list
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          sig do
            params(
              avatar_thumbs:
                Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List::AvatarThumbs::OrHash
            ).void
          end
