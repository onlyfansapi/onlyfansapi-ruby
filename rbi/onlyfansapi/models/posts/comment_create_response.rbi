    ...
    module Posts
      class CommentCreateResponse < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::Posts::CommentCreateResponse,
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::Posts::CommentCreateResponse::Meta)
          )
        end
        attr_reader :_meta
        ...
        sig do
          params(
            _meta:
              Onlyfansapi::Models::Posts::CommentCreateResponse::Meta::OrHash
          ).void
        end
        attr_writer :_meta
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::Posts::CommentCreateResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Onlyfansapi::Models::Posts::CommentCreateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              _meta: Onlyfansapi::Models::Posts::CommentCreateResponse::Meta,
              data: Onlyfansapi::Models::Posts::CommentCreateResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::Posts::CommentCreateResponse::Meta,
                Onlyfansapi::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::Posts::CommentCreateResponse::Meta::Cache
              )
            )
          end
          attr_reader :_cache
          ...
          sig do
            params(
              _cache:
                Onlyfansapi::Models::Posts::CommentCreateResponse::Meta::Cache::OrHash
            ).void
          end
          attr_writer :_cache
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::Posts::CommentCreateResponse::Meta::Credits
              )
            )
          end
          ...
          sig do
            params(
              _credits:
                Onlyfansapi::Models::Posts::CommentCreateResponse::Meta::Credits::OrHash
            ).void
          end
          ...
          sig do
            params(
              _rate_limits:
                Onlyfansapi::Models::Posts::CommentCreateResponse::Meta::RateLimits::OrHash
            ).void
          end
        ...
        class Data < Onlyfansapi::Internal::Type::BaseModel
          ...
          class Author < Onlyfansapi::Internal::Type::BaseModel
            ...
            sig do
              params(
                avatar_thumbs:
                  Onlyfansapi::Models::Posts::CommentCreateResponse::Data::Author::AvatarThumbs::OrHash
              ).void
            end
            ...
            sig do
              params(
                header_size:
                  Onlyfansapi::Models::Posts::CommentCreateResponse::Data::Author::HeaderSize::OrHash
              ).void
            end
            ...
            sig do
              params(
                header_thumbs:
                  Onlyfansapi::Models::Posts::CommentCreateResponse::Data::Author::HeaderThumbs::OrHash
              ).void
            end
