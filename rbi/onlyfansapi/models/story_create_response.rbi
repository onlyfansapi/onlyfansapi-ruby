  ...
  module Models
    class StoryCreateResponse < Onlyfansapi::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Onlyfansapi::Models::StoryCreateResponse,
            Onlyfansapi::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(Onlyfansapi::Models::StoryCreateResponse::Meta)) }
      attr_reader :_meta

      sig do
        params(
          _meta: Onlyfansapi::Models::StoryCreateResponse::Meta::OrHash
        ).void
      end
      attr_writer :_meta

      sig { returns(T.nilable(Onlyfansapi::Models::StoryCreateResponse::Data)) }
      attr_reader :data

      sig do
        params(
          data: Onlyfansapi::Models::StoryCreateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            _meta: Onlyfansapi::Models::StoryCreateResponse::Meta,
            data: Onlyfansapi::Models::StoryCreateResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::StoryCreateResponse::Meta,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::StoryCreateResponse::Meta::Cache)
          )
        end
        attr_reader :_cache
        ...
        sig do
          params(
            _cache:
              Onlyfansapi::Models::StoryCreateResponse::Meta::Cache::OrHash
          ).void
        end
        attr_writer :_cache
        ...
        sig do
          returns(
            T.nilable(Onlyfansapi::Models::StoryCreateResponse::Meta::Credits)
          )
        end
        ...
        sig do
          params(
            _credits:
              Onlyfansapi::Models::StoryCreateResponse::Meta::Credits::OrHash
          ).void
        end
        ...
        sig do
          params(
            _rate_limits:
              Onlyfansapi::Models::StoryCreateResponse::Meta::RateLimits::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _cache: Onlyfansapi::Models::StoryCreateResponse::Meta::Cache,
              _credits: Onlyfansapi::Models::StoryCreateResponse::Meta::Credits,
              _rate_limits:
                Onlyfansapi::Models::StoryCreateResponse::Meta::RateLimits
            }
          )
        ...
        class Cache < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::StoryCreateResponse::Meta::Cache,
                Onlyfansapi::Internal::AnyHash
              )
            end
        ...
        class Credits < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::StoryCreateResponse::Meta::Credits,
                Onlyfansapi::Internal::AnyHash
              )
            end
      ...
      class Data < Onlyfansapi::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Onlyfansapi::Models::StoryCreateResponse::Data,
              Onlyfansapi::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Onlyfansapi::Models::StoryCreateResponse::Data::Media]
            )
          )
        end
        attr_reader :media
        ...
        sig do
          params(
            media:
              T::Array[
                Onlyfansapi::Models::StoryCreateResponse::Data::Media::OrHash
              ]
          ).void
        end
        attr_writer :media
        ...
        class Media < Onlyfansapi::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Onlyfansapi::Models::StoryCreateResponse::Data::Media,
                Onlyfansapi::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files
              )
            )
          end
          attr_reader :files
          ...
          sig do
            params(
              files:
                Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files::OrHash
            ).void
          end
          attr_writer :files
          ...
          class Files < Onlyfansapi::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files::Full
                )
              )
            end
            attr_reader :full
            ...
            sig do
              params(
                full:
                  Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files::Full::OrHash
              ).void
            end
            attr_writer :full
