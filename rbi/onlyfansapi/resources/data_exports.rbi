  ...
  module Resources
    ...
    class DataExports
      ...
      sig do
        ...
        ).returns(Onlyfansapi::Models::DataExportCreateResponse)
      end
      def create(
      ...
      sig do
        params(
          ...
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::DataExportRetrieveResponse)
      end
      def retrieve(
      ...
      sig do
        params(
          ...
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::DataExportListResponse)
      end
      def list(
      ...
      sig do
        params(
          data_export_id: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::DataExportCancelResponse)
      end
      def cancel(
        # The prefixed ID of the data export
        data_export_id,
      ...
      sig do
        params(
          data_export_id: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::DataExportRetryResponse)
      end
      def retry_(
      ...
      sig do
        params(
          data_export_id: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::DataExportStartResponse)
      end
      def start(
        # The prefixed ID of the data export
        data_export_id,
