    ...
    class Stories
      ...
      class Highlights
        ...
        sig do
          ...
          ).returns(Onlyfansapi::Models::Stories::HighlightCreateResponse)
        end
        def create(
          # The Account ID
          account,
        ...
        sig do
          params(
            ...
            account: String,
            request_options: Onlyfansapi::RequestOptions::OrHash
          ).returns(Onlyfansapi::Models::Stories::HighlightRetrieveResponse)
        end
        def retrieve(
        ...
        sig do
          params(
            ...
            title: String,
            request_options: Onlyfansapi::RequestOptions::OrHash
          ).returns(Onlyfansapi::Models::Stories::HighlightUpdateResponse)
        end
        def update(
        ...
        sig do
          params(
            ...
            offset: Integer,
            request_options: Onlyfansapi::RequestOptions::OrHash
          ).returns(Onlyfansapi::Models::Stories::HighlightListResponse)
        end
        def list(
          # The Account ID
          account,
        ...
        sig do
          params(
            ...
            account: String,
            request_options: Onlyfansapi::RequestOptions::OrHash
          ).returns(Onlyfansapi::Models::Stories::HighlightDeleteResponse)
        end
        def delete(
          # The ID of the story highlight to retrieve
          highlight_id,
        ...
        sig do
          params(
            ...
            request_options: Onlyfansapi::RequestOptions::OrHash
          ).returns(Onlyfansapi::Models::Stories::HighlightAddStoryResponse)
        end
        def add_story(
        ...
        sig do
          params(
            ...
            highlight_id: Integer,
            request_options: Onlyfansapi::RequestOptions::OrHash
          ).returns(Onlyfansapi::Models::Stories::HighlightRemoveStoryResponse)
        end
        def remove_story(
          # The ID of the story.
          story_id,
