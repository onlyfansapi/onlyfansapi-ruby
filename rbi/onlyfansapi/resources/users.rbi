...
module Onlyfansapi
  module Resources
    ...
    class Users
      # APIs for fetching OnlyFans users
      sig { returns(Onlyfansapi::Resources::Users::Restrict) }
      attr_reader :restrict

      # APIs for fetching OnlyFans users
      sig { returns(Onlyfansapi::Resources::Users::Block) }
      attr_reader :block

      # APIs for fetching OnlyFans users
      sig { returns(Onlyfansapi::Resources::Users::Subscribe) }
      ...
      sig do
        params(
          ...
          ids: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::UserListResponse)
      end
      def list(
        # The Account ID
        account,
