...
module Onlyfansapi
  module Resources
    ...
    class Posts
      sig { returns(Onlyfansapi::Resources::Posts::Comments) }
      attr_reader :comments

      # APIs for managing your post labels
      sig { returns(Onlyfansapi::Resources::Posts::Labels) }
      attr_reader :labels
      ...
      sig do
        ...
        ).returns(Onlyfansapi::Models::PostCreateResponse)
      end
      def create(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::PostRetrieveResponse)
      end
      def retrieve(
        # The ID of the post
        post_id,
      ...
      sig do
        params(
          ...
          voting_due: Integer,
          voting_options: T::Array[String],
          voting_type: Onlyfansapi::PostUpdateParams::VotingType::OrSymbol,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(String)
      end
      def update(
      ...
      sig do
        params(
          ...
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::PostListResponse)
      end
      def list(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::PostDeleteResponse)
      end
      def delete(
        # The ID of the post
        post_id,
      ...
      sig do
        params(
          ...
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::PostArchiveResponse)
      end
      def archive(
        # Path param: The ID of the post
        post_id,
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::PostPinResponse)
      end
      def pin(
        # The ID of the post
        post_id,
      ...
      sig do
        params(
          ...
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::PostStatsResponse)
      end
      def stats(
        # Path param: The ID of the post
        post_id,
      ...
      sig do
        params(
          ...
          private_archive: T::Boolean,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::PostUnarchiveResponse)
      end
      def unarchive(
        # Path param: The ID of the post
        post_id,
