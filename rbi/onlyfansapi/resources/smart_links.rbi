  ...
  module Resources
    ...
    class SmartLinks
      ...
      sig do
        ...
        ).returns(Onlyfansapi::Models::SmartLinkCreateResponse)
      end
      def create(
      ...
      sig do
        params(
          ...
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::SmartLinkRetrieveResponse)
      end
      def retrieve(
      ...
      sig do
        params(
          smart_link_id: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::SmartLinkDeleteResponse)
      end
      def delete(
        # The ID of the Smart Link
        smart_link_id,
      ...
      sig do
        params(
          ...
          offset: Integer,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::SmartLinkListClicksResponse)
      end
      def list_clicks(
        # The ID of the smart link.
        smart_link_id,
      ...
      sig do
        params(
          smart_link_id: String,
          conversion_type:
            Onlyfansapi::SmartLinkListConversionsParams::ConversionType::OrSymbol,
          date_end: String,
          date_start: String,
          include_bots: T::Boolean,
          include_duplicates: T::Boolean,
          ...
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::SmartLinkListConversionsResponse)
      end
      ...
      sig do
        params(
          ...
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::SmartLinkListFansResponse)
      end
      def list_fans(
        # The ID of the smart link.
        smart_link_id,
      ...
      sig do
        params(
          ...
          offset: Integer,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::SmartLinkListSpendersResponse)
      end
      def list_spenders(
        # The ID of the smart link.
        smart_link_id,
      ...
      sig do
        params(
          ...
          revenue_basis:
            Onlyfansapi::SmartLinkRetrieveCohortArpsParams::RevenueBasis::OrSymbol,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).void
      end
      ...
      sig do
        params(
          ...
          date_start: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::SmartLinkRetrieveStatsResponse)
      end
      def retrieve_stats(
        # The ID of the smart link.
        smart_link_id,
