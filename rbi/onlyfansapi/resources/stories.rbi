...
module Onlyfansapi
  module Resources
    ...
    class Stories
      ...
      sig { returns(Onlyfansapi::Resources::Stories::Highlights) }
      ...
      sig do
        ...
        ).returns(Onlyfansapi::Models::StoryCreateResponse)
      end
      def create(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::StoryRetrieveResponse)
      end
      def retrieve(
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::StoryDeleteResponse)
      end
      def delete(
        # The ID of the story to retrieve
        story_id,
      ...
      sig do
        params(
          account: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::StoryListActiveResponse)
      end
      def list_active(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          marker: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::StoryListArchiveResponse)
      end
      def list_archive(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::StoryListViewersResponse)
      end
      def list_viewers(
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::StoryMarkAsWatchedResponse)
      end
      def mark_as_watched(
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::StoryRetrieveStatsResponse)
      end
      def retrieve_stats(
