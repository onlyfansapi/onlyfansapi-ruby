    ...
    class Authenticate
      ...
      sig do
        params(
          account_id: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::AuthenticateReauthenticateResponse)
      end
      def reauthenticate(
      ...
      sig do
        params(
          attempt_id: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::AuthenticateSend2faEmailResponse)
      end
      def send_2fa_email(
        # The attempt ID of the authentication process
        attempt_id,
      ...
      sig do
        params(
          ...
          xbc: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::AuthenticateStartResponse::Variants)
      end
      def start(
