...
module Onlyfansapi
  module Resources
    ...
    class SharedTrialLinks
      # APIs for Free Trial Links that other OF creators have shared with this account.
      # Revenue, cost, and spender data are not available for shared links.
      sig { returns(Onlyfansapi::Resources::SharedTrialLinks::Tags) }
      attr_reader :tags
      ...
      sig do
        ...
        ).returns(Onlyfansapi::Models::SharedTrialLinkListResponse)
      end
      def list(
        # The Account ID
        account,
      ...
      sig do
        params(
          ...
          account: String,
          request_options: Onlyfansapi::RequestOptions::OrHash
        ).returns(Onlyfansapi::Models::SharedTrialLinkRevokeAccessResponse)
      end
      def revoke_access(
