    ...
    class TrackingLinks
      ...
      class Tags
        ...
        sig do
          ...
          ).returns(Onlyfansapi::Models::TrackingLinks::TagListResponse)
        end
        def list(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Onlyfansapi::RequestOptions::OrHash
          ).returns(Onlyfansapi::Models::TrackingLinks::TagAddResponse)
        end
        def add(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Onlyfansapi::RequestOptions::OrHash
          ).returns(Onlyfansapi::Models::TrackingLinks::TagRemoveResponse)
        end
        def remove(
          # Path param: The ID of the tracking link
          tracking_link_id,
