...
class Onlyfansapi::Test::Resources::Analytics::Financial::TransactionsTest < Onlyfansapi::Test::ResourceTest
  def test_get_by_type_required_params
    ...
    assert_pattern do
      response => ^(Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::Analytics::Financial::TransactionGetByTypeResponseItem])
    end
  end
  ...
  def test_get_summary_required_params
    ...
    assert_pattern do
      response => Onlyfansapi::Models::Analytics::Financial::TransactionGetSummaryResponse
    end
