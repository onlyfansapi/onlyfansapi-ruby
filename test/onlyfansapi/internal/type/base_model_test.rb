...
class Onlyfansapi::Test::PrimitiveModelTest < Minitest::Test
  A = Onlyfansapi::Internal::Type::ArrayOf[-> { Integer }]
  H = Onlyfansapi::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Onlyfansapi::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Onlyfansapi::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Onlyfansapi::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Onlyfansapi::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Onlyfansapi::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Onlyfansapi::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Onlyfansapi::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Onlyfansapi::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Onlyfansapi::Internal::Type::Boolean, true] => true,
      [Onlyfansapi::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Onlyfansapi::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Onlyfansapi::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Onlyfansapi::Internal::Type::Converter.new_coerce_state
      Onlyfansapi::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Onlyfansapi::Internal::Type::Converter.dump(target, input, state: state)
...
class Onlyfansapi::Test::EnumModelTest < Minitest::Test
  class E0
    include Onlyfansapi::Internal::Type::Enum
...
class Onlyfansapi::Test::CollectionModelTest < Minitest::Test
  A1 = Onlyfansapi::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Onlyfansapi::Internal::Type::HashOf[Integer]

  A2 = Onlyfansapi::Internal::Type::ArrayOf[H1]
  H2 = Onlyfansapi::Internal::Type::HashOf[-> { A1 }]

  A3 = Onlyfansapi::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Onlyfansapi::Internal::Type::HashOf[Integer, nil?: true]
...
class Onlyfansapi::Test::BaseModelTest < Minitest::Test
  class M1 < Onlyfansapi::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Onlyfansapi::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Onlyfansapi::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Onlyfansapi::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Onlyfansapi::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Onlyfansapi::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Onlyfansapi::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Onlyfansapi::Errors::ConversionError => e
...
class Onlyfansapi::Test::UnionTest < Minitest::Test
  class U0
    include Onlyfansapi::Internal::Type::Union
  ...
  class M2 < Onlyfansapi::Internal::Type::BaseModel
  ...
  class M4 < Onlyfansapi::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Onlyfansapi::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Onlyfansapi::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Onlyfansapi::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Onlyfansapi::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Onlyfansapi::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Onlyfansapi::Internal::Type::Unknown, Onlyfansapi::Internal::Type::Unknown] => true,
      [Onlyfansapi::Internal::Type::Boolean, Onlyfansapi::Internal::Type::Boolean] => true,
      [Onlyfansapi::Internal::Type::Unknown, Onlyfansapi::Internal::Type::Boolean] => false,
...
class Onlyfansapi::Test::MetaInfoTest < Minitest::Test
  A1 = Onlyfansapi::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Onlyfansapi::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
