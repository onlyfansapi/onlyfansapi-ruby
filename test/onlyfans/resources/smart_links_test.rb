...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("itaque")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("aliquid")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("culpa")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("ipsum")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("quidem")
