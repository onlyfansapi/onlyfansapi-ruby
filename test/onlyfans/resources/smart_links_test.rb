...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("sapiente")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("magni")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("esse")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("ab")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("quod")
