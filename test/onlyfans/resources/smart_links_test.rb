...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("doloribus")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("accusamus")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("atque")
