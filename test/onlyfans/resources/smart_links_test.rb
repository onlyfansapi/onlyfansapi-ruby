...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("sunt")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("nisi")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("nostrum")
