...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("repudiandae")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("natus")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("amet")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("veritatis")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("dolores")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("accusamus")
