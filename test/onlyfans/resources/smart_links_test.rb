...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("sequi")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("dignissimos")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("consequatur")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("quasi")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("magni")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("quisquam")
