...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("voluptas")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("labore")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("sed")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("doloribus")
