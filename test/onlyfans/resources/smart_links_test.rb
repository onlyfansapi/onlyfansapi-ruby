...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("vitae")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("aliquam")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("laboriosam")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("vel")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("dolorem")
