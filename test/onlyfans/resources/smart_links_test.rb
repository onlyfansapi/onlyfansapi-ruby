...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("quos")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("incidunt")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("quaerat")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("corrupti")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("occaecati")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("voluptatibus")
