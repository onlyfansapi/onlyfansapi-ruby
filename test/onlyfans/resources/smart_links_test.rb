...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("deserunt")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("laborum")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("perspiciatis")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("tenetur")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("saepe")
