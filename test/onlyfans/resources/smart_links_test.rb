...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("minus")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("repellat")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("dolor")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("at")
