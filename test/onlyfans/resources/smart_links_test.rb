...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("consequuntur")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("nisi")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("pariatur")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("modi")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("itaque")
