...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("sint")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("occaecati")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("sapiente")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("vel")
