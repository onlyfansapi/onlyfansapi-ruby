...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("nostrum")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("illum")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("voluptatem")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("enim")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("iusto")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("inventore")
