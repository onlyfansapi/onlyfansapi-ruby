...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("quis")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("recusandae")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("iste")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("cumque")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("occaecati")
