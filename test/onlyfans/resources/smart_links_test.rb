...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_clicks
    ...
    response = @only_fans_api.smart_links.list_clicks("voluptate")
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("provident")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("saepe")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("illum")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("commodi")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("magni")
