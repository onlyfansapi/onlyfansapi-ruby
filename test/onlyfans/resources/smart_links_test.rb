...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("nemo")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("ab")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("nobis")
