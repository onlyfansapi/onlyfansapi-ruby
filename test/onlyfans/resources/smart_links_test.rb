...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("eos")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("vero")
  ...
  def test_retrieve_cohort_arps
    ...
    response = @only_fans_api.smart_links.retrieve_cohort_arps("aliquid")
