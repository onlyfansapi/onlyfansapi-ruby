...
class Onlyfans::Test::Resources::SmartLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_list_conversions
    ...
    response = @only_fans_api.smart_links.list_conversions("quidem")
  ...
  def test_list_fans
    ...
    response = @only_fans_api.smart_links.list_fans("et")
  ...
  def test_list_spenders
    ...
    response = @only_fans_api.smart_links.list_spenders("assumenda")
  ...
  def test_retrieve_stats
    ...
    response = @only_fans_api.smart_links.retrieve_stats("ullam")
