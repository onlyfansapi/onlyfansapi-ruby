...
class Onlyfans::Test::Resources::TrackingLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_retrieve_required_params
    ...
    response = @only_fans_api.tracking_links.retrieve("totam", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_delete_required_params
    ...
    response = @only_fans_api.tracking_links.delete("totam", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_get_cohort_arps_required_params
    ...
    response = @only_fans_api.tracking_links.get_cohort_arps("dolor", account: "acct_XXXXXXXXXXXXXXX")
