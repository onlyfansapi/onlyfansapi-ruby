...
class Onlyfans::Test::Resources::TrackingLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_retrieve_required_params
    ...
    response = @only_fans_api.tracking_links.retrieve("nam", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_delete_required_params
    ...
    response = @only_fans_api.tracking_links.delete("nam", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_get_stats_required_params
    ...
    response = @only_fans_api.tracking_links.get_stats("at", account: "acct_XXXXXXXXXXXXXXX")
