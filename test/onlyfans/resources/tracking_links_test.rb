...
class Onlyfans::Test::Resources::TrackingLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_retrieve_required_params
    ...
    response = @only_fans_api.tracking_links.retrieve("eum", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_delete_required_params
    ...
    response = @only_fans_api.tracking_links.delete("eum", account: "acct_XXXXXXXXXXXXXXX")
