...
class Onlyfans::Test::Resources::TrackingLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_retrieve_required_params
    ...
    response = @only_fans_api.tracking_links.retrieve("ducimus", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_delete_required_params
    ...
    response = @only_fans_api.tracking_links.delete("ducimus", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_get_cohort_arps_required_params
    ...
    response = @only_fans_api.tracking_links.get_cohort_arps("rerum", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_get_stats_required_params
    ...
    response = @only_fans_api.tracking_links.get_stats("laboriosam", account: "acct_XXXXXXXXXXXXXXX")
