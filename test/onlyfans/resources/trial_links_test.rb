...
class Onlyfans::Test::Resources::TrialLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_retrieve_required_params
    ...
    response = @only_fans_api.trial_links.retrieve("eligendi", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_delete_required_params
    ...
    response = @only_fans_api.trial_links.delete("eligendi", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_retrieve_stats_required_params
    ...
    response = @only_fans_api.trial_links.retrieve_stats("sit", account: "acct_XXXXXXXXXXXXXXX")
