...
class Onlyfans::Test::Resources::TrialLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_retrieve_required_params
    ...
    response = @only_fans_api.trial_links.retrieve("consectetur", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_list
    ...
    response = @only_fans_api.trial_links.list("acct_XXXXXXXXXXXXXXX")
  ...
  def test_delete_required_params
    ...
    response = @only_fans_api.trial_links.delete("consectetur", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_list_subscribers_required_params
    ...
    response =
      @only_fans_api.trial_links.list_subscribers("ea", account: "acct_XXXXXXXXXXXXXXX", limit: 10, offset: 0)
  ...
  def test_retrieve_cohort_arps_required_params
    ...
    response =
      @only_fans_api.trial_links.retrieve_cohort_arps("accusantium", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_retrieve_stats_required_params
    ...
    response = @only_fans_api.trial_links.retrieve_stats("deserunt", account: "acct_XXXXXXXXXXXXXXX")
