...
class Onlyfans::Test::Resources::TrialLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_retrieve_required_params
    ...
    response = @only_fans_api.trial_links.retrieve("assumenda", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_delete_required_params
    ...
    response = @only_fans_api.trial_links.delete("assumenda", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_list_subscribers_required_params
    ...
    response =
      @only_fans_api.trial_links.list_subscribers("at", account: "acct_XXXXXXXXXXXXXXX", limit: 10, offset: 0)
  ...
  def test_retrieve_cohort_arps_required_params
    ...
    response = @only_fans_api.trial_links.retrieve_cohort_arps("possimus", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_retrieve_stats_required_params
    ...
    response = @only_fans_api.trial_links.retrieve_stats("nostrum", account: "acct_XXXXXXXXXXXXXXX")
