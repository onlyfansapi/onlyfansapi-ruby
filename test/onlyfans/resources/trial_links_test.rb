...
class Onlyfans::Test::Resources::TrialLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_retrieve_required_params
    ...
    response = @only_fans_api.trial_links.retrieve("dolorem", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_delete_required_params
    ...
    response = @only_fans_api.trial_links.delete("dolorem", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_retrieve_cohort_arps_required_params
    ...
    response = @only_fans_api.trial_links.retrieve_cohort_arps("explicabo", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_retrieve_stats_required_params
    ...
    response = @only_fans_api.trial_links.retrieve_stats("consequatur", account: "acct_XXXXXXXXXXXXXXX")
