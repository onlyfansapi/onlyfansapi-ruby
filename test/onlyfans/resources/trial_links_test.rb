...
class Onlyfans::Test::Resources::TrialLinksTest < Onlyfans::Test::ResourceTest
  ...
  def test_retrieve_cohort_arps_required_params
    ...
    response = @only_fans_api.trial_links.retrieve_cohort_arps("earum", account: "acct_XXXXXXXXXXXXXXX")
  ...
  def test_retrieve_stats_required_params
    ...
    response = @only_fans_api.trial_links.retrieve_stats("ex", account: "acct_XXXXXXXXXXXXXXX")
