...
class Onlyfans::Test::Resources::Analytics::SummaryTest < Onlyfans::Test::ResourceTest
  def test_get_earnings_overview_required_params
    ...
    assert_pattern do
      response => Onlyfans::Models::Analytics::SummaryGetEarningsOverviewResponse
    end
  ...
  def test_get_historical_performance
    ...
    assert_pattern do
      response => ^(Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::Analytics::SummaryGetHistoricalPerformanceResponseItem])
    end
  end
  ...
  def test_get_period_comparison_required_params
    ...
    assert_pattern do
      response => Onlyfans::Models::Analytics::SummaryGetPeriodComparisonResponse
    end

    assert_pattern do
      response => {
        breakdown: ^(Onlyfans::Internal::Type::ArrayOf[Onlyfans::Internal::Type::Unknown]) | nil,
        chart_data: ^(Onlyfans::Internal::Type::ArrayOf[Onlyfans::Internal::Type::Unknown]) | nil,
        period_a_label: String | nil,
        period_b_label: String | nil,
        summary: Onlyfans::Models::Analytics::SummaryGetPeriodComparisonResponse::Summary | nil
      }
    end
  end
end
