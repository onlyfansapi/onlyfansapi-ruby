...
class Onlyfans::Test::Resources::Posts::CommentsTest < Onlyfans::Test::ResourceTest
  def test_create_required_params
    ...
    response =
      @only_fans_api.posts.comments.create("ab", account: "acct_XXXXXXXXXXXXXXX", text: "This is a comment.")
  ...
  def test_list_required_params
    ...
    response = @only_fans_api.posts.comments.list("ab", account: "acct_XXXXXXXXXXXXXXX")
