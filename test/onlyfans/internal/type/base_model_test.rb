...
class Onlyfans::Test::PrimitiveModelTest < Minitest::Test
  A = Onlyfans::Internal::Type::ArrayOf[-> { Integer }]
  H = Onlyfans::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Onlyfans::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Onlyfans::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Onlyfans::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Onlyfans::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Onlyfans::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Onlyfans::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Onlyfans::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Onlyfans::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Onlyfans::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Onlyfans::Internal::Type::Boolean, true] => true,
      [Onlyfans::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Onlyfans::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Onlyfans::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Onlyfans::Internal::Type::Converter.new_coerce_state
      Onlyfans::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Onlyfans::Internal::Type::Converter.dump(target, input, state: state)
...
class Onlyfans::Test::EnumModelTest < Minitest::Test
  class E0
    include Onlyfans::Internal::Type::Enum
...
class Onlyfans::Test::CollectionModelTest < Minitest::Test
  A1 = Onlyfans::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Onlyfans::Internal::Type::HashOf[Integer]

  A2 = Onlyfans::Internal::Type::ArrayOf[H1]
  H2 = Onlyfans::Internal::Type::HashOf[-> { A1 }]

  A3 = Onlyfans::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Onlyfans::Internal::Type::HashOf[Integer, nil?: true]
...
class Onlyfans::Test::BaseModelTest < Minitest::Test
  class M1 < Onlyfans::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Onlyfans::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Onlyfans::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Onlyfans::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Onlyfans::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Onlyfans::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Onlyfans::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Onlyfans::Errors::ConversionError => e
...
class Onlyfans::Test::UnionTest < Minitest::Test
  class U0
    include Onlyfans::Internal::Type::Union
  ...
  class M2 < Onlyfans::Internal::Type::BaseModel
  ...
  class M4 < Onlyfans::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Onlyfans::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Onlyfans::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Onlyfans::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Onlyfans::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Onlyfans::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Onlyfans::Internal::Type::Unknown, Onlyfans::Internal::Type::Unknown] => true,
      [Onlyfans::Internal::Type::Boolean, Onlyfans::Internal::Type::Boolean] => true,
      [Onlyfans::Internal::Type::Unknown, Onlyfans::Internal::Type::Boolean] => false,
...
class Onlyfans::Test::MetaInfoTest < Minitest::Test
  A1 = Onlyfans::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Onlyfans::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
