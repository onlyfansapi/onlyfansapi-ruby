...
class OnlyfansTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    ...
    only_fans_api = Onlyfans::Client.new(base_url: "http://localhost", api_key: "My API Key")

    assert_raises(Onlyfans::Errors::InternalServerError) do
  ...
  def test_client_given_request_default_retry_attempts
    ...
    only_fans_api = Onlyfans::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_retry_after_seconds
    stub_request(:get, "http://localhost/api/whoami").to_return_json(
      status: 500,
      headers: {"retry-after" => "1.3"},
      body: {}
    )

    only_fans_api = Onlyfans::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(Onlyfans::Errors::APIConnectionError) do
    ...
    assert_requested(:any, "http://localhost/redirected", times: Onlyfans::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Onlyfans::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Onlyfans::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
