...
module Onlyfans
  module Models
    ...
    class FollowingListAllParams < Onlyfans::Internal::Type::BaseModel
      ...
      # @!attribute filter
      #
      #   @return [Onlyfans::Models::FollowingListAllParams::Filter, nil]
      optional :filter, -> { Onlyfans::FollowingListAllParams::Filter }
      ...
      #   present.
      #
      #   @return [Symbol, Onlyfans::Models::FollowingListAllParams::Sort, nil]
      optional :sort, enum: -> { Onlyfans::FollowingListAllParams::Sort }, nil?: true

      # @!attribute sort_direction
      #   Direction for `sort`: `desc` (default) or `asc`. Requires `sort` to be set.
      #
      #   @return [Symbol, Onlyfans::Models::FollowingListAllParams::SortDirection, nil]
      optional :sort_direction, enum: -> { Onlyfans::FollowingListAllParams::SortDirection }, nil?: true
      ...
      class Filter < Onlyfans::Internal::Type::BaseModel
        ...
        #
        #   @return [Integer, Onlyfans::Models::FollowingListAllParams::Filter::Online, nil]
        optional :online, enum: -> { Onlyfans::FollowingListAllParams::Filter::Online }, nil?: true

        # @!attribute paid
        #   Filter by paid status (1 for paid, 0 for free, null for all).
        #
        #   @return [Integer, Onlyfans::Models::FollowingListAllParams::Filter::Paid, nil]
        optional :paid, enum: -> { Onlyfans::FollowingListAllParams::Filter::Paid }, nil?: true

        # @!method initialize(online: nil, paid: nil)
        #   @param online [Integer, Onlyfans::Models::FollowingListAllParams::Filter::Online, nil] Filter by online status (1 for online, 0 for offline, null for all).
        #
        #   @param paid [Integer, Onlyfans::Models::FollowingListAllParams::Filter::Paid, nil] Filter by paid status (1 for paid, 0 for free, null for all).

        # Filter by online status (1 for online, 0 for offline, null for all).
        #
        # @see Onlyfans::Models::FollowingListAllParams::Filter#online
        module Online
        ...
        # Filter by paid status (1 for paid, 0 for free, null for all).
        #
        # @see Onlyfans::Models::FollowingListAllParams::Filter#paid
        module Paid
          extend Onlyfans::Internal::Type::Enum
