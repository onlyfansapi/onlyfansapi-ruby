...
module Onlyfans
  module Models
    # @see Onlyfans::Resources::UserLists#retrieve
    class UserListRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::UserListRetrieveResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::UserListRetrieveResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::UserListRetrieveResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::UserListRetrieveResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::UserListRetrieveResponse::Meta]
      #   @param data [Onlyfans::Models::UserListRetrieveResponse::Data]

      # @see Onlyfans::Models::UserListRetrieveResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::UserListRetrieveResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::UserListRetrieveResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::UserListRetrieveResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::UserListRetrieveResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::UserListRetrieveResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::UserListRetrieveResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::UserListRetrieveResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::UserListRetrieveResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::UserListRetrieveResponse::Meta::RateLimits]

        # @see Onlyfans::Models::UserListRetrieveResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::UserListRetrieveResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::UserListRetrieveResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::UserListRetrieveResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<Onlyfans::Models::UserListRetrieveResponse::Data::User>, nil]
        optional :users,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::UserListRetrieveResponse::Data::User] }
        ...
        #   @param type [String]
        #   @param users [Array<Onlyfans::Models::UserListRetrieveResponse::Data::User>]
