...
module Onlyfans
  module Models
    ...
    class FanListAllResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::FanListAllResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::FanListAllResponse::Meta }

      # @!attribute _pagination
      #
      #   @return [Onlyfans::Models::FanListAllResponse::Pagination, nil]
      optional :_pagination, -> { Onlyfans::Models::FanListAllResponse::Pagination }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::FanListAllResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::FanListAllResponse::Data }

      # @!method initialize(_meta: nil, _pagination: nil, data: nil)
      #   @param _meta [Onlyfans::Models::FanListAllResponse::Meta]
      #   @param _pagination [Onlyfans::Models::FanListAllResponse::Pagination]
      #   @param data [Onlyfans::Models::FanListAllResponse::Data]

      # @see Onlyfans::Models::FanListAllResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::FanListAllResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::FanListAllResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::FanListAllResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::FanListAllResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::FanListAllResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::FanListAllResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::FanListAllResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::FanListAllResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::FanListAllResponse::Meta::RateLimits]

        # @see Onlyfans::Models::FanListAllResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::FanListAllResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::FanListAllResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::FanListAllResponse#_pagination
      ...
      # @see Onlyfans::Models::FanListAllResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfans::Models::FanListAllResponse::Data::List>, nil]
        optional :list, -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FanListAllResponse::Data::List] }

        # @!method initialize(has_more: nil, list: nil)
        #   @param has_more [Boolean]
        #   @param list [Array<Onlyfans::Models::FanListAllResponse::Data::List>]
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfans::Models::FanListAllResponse::Data::List::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfans::Models::FanListAllResponse::Data::List::AvatarThumbs },
          ...
          #
          #   @return [Array<Onlyfans::Models::FanListAllResponse::Data::List::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FanListAllResponse::Data::List::ListsState] },
          ...
          #
          #   @return [Array<Onlyfans::Models::FanListAllResponse::Data::List::PromoOffer>, nil]
          optional :promo_offers,
                   -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FanListAllResponse::Data::List::PromoOffer] },
          ...
          #
          #   @return [Onlyfans::Models::FanListAllResponse::Data::List::SubscribedOnData, nil]
          optional :subscribed_on_data,
                   -> { Onlyfans::Models::FanListAllResponse::Data::List::SubscribedOnData },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfans::Models::FanListAllResponse::Data::List::AvatarThumbs]
          ...
          #   @param lists_states [Array<Onlyfans::Models::FanListAllResponse::Data::List::ListsState>]
          #   @param name [String]
          #   @param notice [String]
          #   @param promo_offers [Array<Onlyfans::Models::FanListAllResponse::Data::List::PromoOffer>]
          ...
          #   @param subscribed_on_data [Onlyfans::Models::FanListAllResponse::Data::List::SubscribedOnData]
          ...
          # @see Onlyfans::Models::FanListAllResponse::Data::List#avatar_thumbs
          ...
          # @see Onlyfans::Models::FanListAllResponse::Data::List#subscribed_on_data
          class SubscribedOnData < Onlyfans::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Onlyfans::Models::FanListAllResponse::Data::List::SubscribedOnData::Subscribe>, nil]
            optional :subscribes,
                     -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FanListAllResponse::Data::List::SubscribedOnData::Subscribe] }
            ...
            #   @param subscribes [Array<Onlyfans::Models::FanListAllResponse::Data::List::SubscribedOnData::Subscribe>]
