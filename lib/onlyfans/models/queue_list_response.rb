...
module Onlyfans
  module Models
    ...
    class QueueListResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::QueueListResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::QueueListResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::QueueListResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::QueueListResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::QueueListResponse::Meta]
      #   @param data [Onlyfans::Models::QueueListResponse::Data]

      # @see Onlyfans::Models::QueueListResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::QueueListResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::QueueListResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::QueueListResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::QueueListResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::QueueListResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::QueueListResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::QueueListResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::QueueListResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::QueueListResponse::Meta::RateLimits]

        # @see Onlyfans::Models::QueueListResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::QueueListResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::QueueListResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::QueueListResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        # @!attribute list
        #
        #   @return [Array<Onlyfans::Models::QueueListResponse::Data::List>, nil]
        optional :list, -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::QueueListResponse::Data::List] }
        ...
        #   @param list [Array<Onlyfans::Models::QueueListResponse::Data::List>]
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          # @!attribute entity
          #
          #   @return [Onlyfans::Models::QueueListResponse::Data::List::Entity, nil]
          optional :entity, -> { Onlyfans::Models::QueueListResponse::Data::List::Entity }
          ...
          #   @param entity [Onlyfans::Models::QueueListResponse::Data::List::Entity]
          #   @param publish_date_time [String]
          #   @param type [String]

          # @see Onlyfans::Models::QueueListResponse::Data::List#entity
