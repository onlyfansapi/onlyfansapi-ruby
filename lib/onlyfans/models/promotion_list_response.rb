...
module Onlyfans
  module Models
    ...
    class PromotionListResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::PromotionListResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::PromotionListResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::PromotionListResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::PromotionListResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::PromotionListResponse::Meta]
      #   @param data [Onlyfans::Models::PromotionListResponse::Data]

      # @see Onlyfans::Models::PromotionListResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::PromotionListResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::PromotionListResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::PromotionListResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::PromotionListResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::PromotionListResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::PromotionListResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::PromotionListResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::PromotionListResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::PromotionListResponse::Meta::RateLimits]

        # @see Onlyfans::Models::PromotionListResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::PromotionListResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::PromotionListResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::PromotionListResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        # @!attribute items
        #
        #   @return [Array<Onlyfans::Models::PromotionListResponse::Data::Item>, nil]
        optional :items,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::PromotionListResponse::Data::Item] }

        # @!method initialize(has_more: nil, items: nil)
        #   @param has_more [Boolean]
        #   @param items [Array<Onlyfans::Models::PromotionListResponse::Data::Item>]
