...
module Onlyfans
  module Models
    ...
    class SmartLinkListClicksResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::SmartLinkListClicksResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::SmartLinkListClicksResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::SmartLinkListClicksResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::SmartLinkListClicksResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::SmartLinkListClicksResponse::Meta]
      #   @param data [Onlyfans::Models::SmartLinkListClicksResponse::Data]

      # @see Onlyfans::Models::SmartLinkListClicksResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::SmartLinkListClicksResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::SmartLinkListClicksResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::SmartLinkListClicksResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::SmartLinkListClicksResponse::Meta::Credits }

        # @!method initialize(_cache: nil, _credits: nil)
        #   @param _cache [Onlyfans::Models::SmartLinkListClicksResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::SmartLinkListClicksResponse::Meta::Credits]

        # @see Onlyfans::Models::SmartLinkListClicksResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::SmartLinkListClicksResponse::Meta#_credits
      ...
      # @see Onlyfans::Models::SmartLinkListClicksResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        # @!attribute chart
        #
        #   @return [Array<Onlyfans::Models::SmartLinkListClicksResponse::Data::Chart>, nil]
        optional :chart,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::SmartLinkListClicksResponse::Data::Chart] }

        # @!attribute filters
        #
        #   @return [Onlyfans::Models::SmartLinkListClicksResponse::Data::Filters, nil]
        optional :filters, -> { Onlyfans::Models::SmartLinkListClicksResponse::Data::Filters }

        # @!attribute rows
        #
        #   @return [Array<Onlyfans::Models::SmartLinkListClicksResponse::Data::Row>, nil]
        optional :rows,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::SmartLinkListClicksResponse::Data::Row] }

        # @!attribute summary
        #
        #   @return [Onlyfans::Models::SmartLinkListClicksResponse::Data::Summary, nil]
        ...
        #   @param chart [Array<Onlyfans::Models::SmartLinkListClicksResponse::Data::Chart>]
        #   @param filters [Onlyfans::Models::SmartLinkListClicksResponse::Data::Filters]
        #   @param rows [Array<Onlyfans::Models::SmartLinkListClicksResponse::Data::Row>]
        #   @param summary [Onlyfans::Models::SmartLinkListClicksResponse::Data::Summary]
        ...
        # @see Onlyfans::Models::SmartLinkListClicksResponse::Data#filters
