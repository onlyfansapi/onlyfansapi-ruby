  ...
  module Models
    module Settings
      ...
      class BlockedCountryUpdateParams < Onlyfans::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<String>]
        required :blocked_countries, Onlyfans::Internal::Type::ArrayOf[String], api_name: :blockedCountries

        # @!attribute blocked_states
        #   Blocked states payload forwarded to OnlyFans. Defaults to an empty array.
        #
        #   @return [Array<String>, nil]
        optional :blocked_states, Onlyfans::Internal::Type::ArrayOf[String], api_name: :blockedStates
