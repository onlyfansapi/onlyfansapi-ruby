    ...
    module Analytics
      module Financial
        ...
        class ProfitabilityGetHistoryResponse < Onlyfans::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Array<Onlyfans::Models::Analytics::Financial::ProfitabilityGetHistoryResponse::Data>, nil]
          optional :data,
                   -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::Analytics::Financial::ProfitabilityGetHistoryResponse::Data] }

          # @!method initialize(data: nil)
          #   @param data [Array<Onlyfans::Models::Analytics::Financial::ProfitabilityGetHistoryResponse::Data>]
