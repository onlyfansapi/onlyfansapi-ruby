...
module Onlyfans
  module Models
    ...
    class UserListListResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::UserListListResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::UserListListResponse::Meta }

      # @!attribute data
      #
      #   @return [Array<Onlyfans::Models::UserListListResponse::Data>, nil]
      optional :data, -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::UserListListResponse::Data] }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::UserListListResponse::Meta]
      #   @param data [Array<Onlyfans::Models::UserListListResponse::Data>]

      # @see Onlyfans::Models::UserListListResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::UserListListResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::UserListListResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::UserListListResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::UserListListResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::UserListListResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::UserListListResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::UserListListResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::UserListListResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::UserListListResponse::Meta::RateLimits]

        # @see Onlyfans::Models::UserListListResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::UserListListResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::UserListListResponse::Meta#_rate_limits
