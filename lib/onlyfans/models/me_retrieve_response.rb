...
module Onlyfans
  module Models
    ...
    class MeRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::MeRetrieveResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::MeRetrieveResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::MeRetrieveResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::MeRetrieveResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::MeRetrieveResponse::Meta]
      #   @param data [Onlyfans::Models::MeRetrieveResponse::Data]

      # @see Onlyfans::Models::MeRetrieveResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::MeRetrieveResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::MeRetrieveResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::MeRetrieveResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::MeRetrieveResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::MeRetrieveResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::MeRetrieveResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::MeRetrieveResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::MeRetrieveResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::MeRetrieveResponse::Meta::RateLimits]

        # @see Onlyfans::Models::MeRetrieveResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::MeRetrieveResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::MeRetrieveResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::MeRetrieveResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        optional :adv_block, Onlyfans::Internal::Type::ArrayOf[String], api_name: :advBlock
        ...
        #
        #   @return [Onlyfans::Models::MeRetrieveResponse::Data::AvatarThumbs, nil]
        optional :avatar_thumbs,
                 -> { Onlyfans::Models::MeRetrieveResponse::Data::AvatarThumbs },
                 api_name: :avatarThumbs

        # @!attribute can_add_card
        #
        #   @return [Boolean, nil]
        optional :can_add_card, Onlyfans::Internal::Type::Boolean, api_name: :canAddCard

        # @!attribute can_add_story
        #
        #   @return [Boolean, nil]
        optional :can_add_story, Onlyfans::Internal::Type::Boolean, api_name: :canAddStory
        ...
        # @!attribute can_change_content_price
        #
        #   @return [Boolean, nil]
        optional :can_change_content_price,
                 Onlyfans::Internal::Type::Boolean,
                 api_name: :canChangeContentPrice
        ...
        #
        #   @return [Boolean, nil]
        optional :can_connect_of_account, Onlyfans::Internal::Type::Boolean, api_name: :canConnectOfAccount

        # @!attribute can_create_fund_raising
        #
        #   @return [Boolean, nil]
        optional :can_create_fund_raising, Onlyfans::Internal::Type::Boolean, api_name: :canCreateFundRaising
        ...
        # @!attribute can_make_expire_posts
        #
        #   @return [Boolean, nil]
        optional :can_make_expire_posts, Onlyfans::Internal::Type::Boolean, api_name: :canMakeExpirePosts
        ...
        #
        #   @return [Boolean, nil]
        optional :can_pin_post, Onlyfans::Internal::Type::Boolean, api_name: :canPinPost
        ...
        # @!attribute can_receive_stripe_payout
        #
        #   @return [Boolean, nil]
        optional :can_receive_stripe_payout,
                 Onlyfans::Internal::Type::Boolean,
                 api_name: :canReceiveStripePayout
        ...
        # @!attribute can_streaming
        #
        #   @return [Boolean, nil]
        optional :can_streaming, Onlyfans::Internal::Type::Boolean, api_name: :canStreaming
        ...
        #
        #   @return [Boolean, nil]
        optional :has_internal_payments, Onlyfans::Internal::Type::Boolean, api_name: :hasInternalPayments
        ...
        #
        #   @return [Boolean, nil]
        optional :has_new_alerts, Onlyfans::Internal::Type::Boolean, api_name: :hasNewAlerts
        ...
        #
        #   @return [Boolean, nil]
        optional :has_new_hints, Onlyfans::Internal::Type::Boolean, api_name: :hasNewHints

        # @!attribute has_new_ticket_replies
        #
        #   @return [Onlyfans::Models::MeRetrieveResponse::Data::HasNewTicketReplies, nil]
        optional :has_new_ticket_replies,
                 -> { Onlyfans::Models::MeRetrieveResponse::Data::HasNewTicketReplies },
        ...
        #
        #   @return [Boolean, nil]
        optional :has_purchased_posts, Onlyfans::Internal::Type::Boolean, api_name: :hasPurchasedPosts

        # @!attribute has_scenario
        #
        #   @return [Boolean, nil]
        optional :has_scenario, Onlyfans::Internal::Type::Boolean, api_name: :hasScenario
        ...
        #
        #   @return [Boolean, nil]
        optional :has_tags, Onlyfans::Internal::Type::Boolean, api_name: :hasTags

        # @!attribute has_watermark_photo
        #
        #   @return [Boolean, nil]
        optional :has_watermark_photo, Onlyfans::Internal::Type::Boolean, api_name: :hasWatermarkPhoto

        # @!attribute has_watermark_video
        #
        #   @return [Boolean, nil]
        optional :has_watermark_video, Onlyfans::Internal::Type::Boolean, api_name: :hasWatermarkVideo
        ...
        #
        #   @return [Onlyfans::Models::MeRetrieveResponse::Data::HeaderSize, nil]
        optional :header_size,
                 -> { Onlyfans::Models::MeRetrieveResponse::Data::HeaderSize },
                 api_name: :headerSize

        # @!attribute header_thumbs
        #
        #   @return [Onlyfans::Models::MeRetrieveResponse::Data::HeaderThumbs, nil]
        optional :header_thumbs,
                 -> { Onlyfans::Models::MeRetrieveResponse::Data::HeaderThumbs },
        ...
        #
        #   @return [Boolean, nil]
        optional :is_age_verified, Onlyfans::Internal::Type::Boolean, api_name: :isAgeVerified

        # @!attribute is_allow_tweets
        #
        #   @return [Boolean, nil]
        optional :is_allow_tweets, Onlyfans::Internal::Type::Boolean, api_name: :isAllowTweets

        # @!attribute is_auth
        #
        #   @return [Boolean, nil]
        optional :is_auth, Onlyfans::Internal::Type::Boolean, api_name: :isAuth

        # @!attribute is_country_vat_number_collect
        #
        #   @return [Boolean, nil]
        optional :is_country_vat_number_collect,
                 Onlyfans::Internal::Type::Boolean,
                 api_name: :isCountryVatNumberCollect

        # @!attribute is_country_vat_refundable
        #
        #   @return [Boolean, nil]
        optional :is_country_vat_refundable,
                 Onlyfans::Internal::Type::Boolean,
                 api_name: :isCountryVatRefundable

        # @!attribute is_country_with_vat
        #
        #   @return [Boolean, nil]
        optional :is_country_with_vat, Onlyfans::Internal::Type::Boolean, api_name: :isCountryWithVat

        # @!attribute is_credits_enabled
        #
        #   @return [Boolean, nil]
        optional :is_credits_enabled, Onlyfans::Internal::Type::Boolean, api_name: :isCreditsEnabled

        # @!attribute is_delete_initiated
        #
        #   @return [Boolean, nil]
        optional :is_delete_initiated, Onlyfans::Internal::Type::Boolean, api_name: :isDeleteInitiated

        # @!attribute is_email_checked
        #
        #   @return [Boolean, nil]
        optional :is_email_checked, Onlyfans::Internal::Type::Boolean, api_name: :isEmailChecked

        # @!attribute is_email_required
        #
        #   @return [Boolean, nil]
        optional :is_email_required, Onlyfans::Internal::Type::Boolean, api_name: :isEmailRequired
        ...
        #
        #   @return [Boolean, nil]
        optional :is_make_payment, Onlyfans::Internal::Type::Boolean, api_name: :isMakePayment
        ...
        # @!attribute is_need_confirm_payout
        #
        #   @return [Boolean, nil]
        optional :is_need_confirm_payout, Onlyfans::Internal::Type::Boolean, api_name: :isNeedConfirmPayout

        # @!attribute is_otp_enabled
        #
        #   @return [Boolean, nil]
        optional :is_otp_enabled, Onlyfans::Internal::Type::Boolean, api_name: :isOtpEnabled
        ...
        #
        #   @return [Boolean, nil]
        optional :is_real_card_connected, Onlyfans::Internal::Type::Boolean, api_name: :isRealCardConnected
        ...
        # @!attribute is_scheduled_streams_allowed
        #
        #   @return [Boolean, nil]
        optional :is_scheduled_streams_allowed,
                 Onlyfans::Internal::Type::Boolean,
                 api_name: :isScheduledStreamsAllowed
        ...
        #
        #   @return [Boolean, nil]
        optional :is_twitter_connected, Onlyfans::Internal::Type::Boolean, api_name: :isTwitterConnected

        # @!attribute is_vat_required
        #
        #   @return [Boolean, nil]
        optional :is_vat_required, Onlyfans::Internal::Type::Boolean, api_name: :isVatRequired
        ...
        #
        #   @return [Boolean, nil]
        optional :is_visible_online, Onlyfans::Internal::Type::Boolean, api_name: :isVisibleOnline

        # @!attribute is_wallet_autorecharge
        #
        #   @return [Boolean, nil]
        optional :is_wallet_autorecharge, Onlyfans::Internal::Type::Boolean, api_name: :isWalletAutorecharge

        # @!attribute is_want_comments
        #
        #   @return [Boolean, nil]
        optional :is_want_comments, Onlyfans::Internal::Type::Boolean, api_name: :isWantComments
        ...
        # @!attribute iv_hide_for_performers
        #
        #   @return [Boolean, nil]
        optional :iv_hide_for_performers, Onlyfans::Internal::Type::Boolean, api_name: :ivHideForPerformers
        ...
        #
        #   @return [Integer, nil]
        optional :max_fund_raising_target, Integer, api_name: :maxFundRaisingTarget
        ...
        # @!attribute message_max_price
        #
        #   @return [Integer, nil]
        optional :message_max_price, Integer, api_name: :messageMaxPrice

        # @!attribute message_min_price
        #
        #   @return [Integer, nil]
        optional :message_min_price, Integer, api_name: :messageMinPrice

        # @!attribute min_fund_raising_target
        #
        #   @return [Integer, nil]
        optional :min_fund_raising_target, Integer, api_name: :minFundRaisingTarget
        ...
        #
        #   @return [Boolean, nil]
        optional :need_iv_approve, Onlyfans::Internal::Type::Boolean, api_name: :needIVApprove
        ...
        #
        #   @return [Boolean, nil]
        optional :paid_feed, Onlyfans::Internal::Type::Boolean, api_name: :paidFeed
        ...
        # @!attribute payout_type
        #
        #   @return [String, nil]
        optional :payout_type, String, api_name: :payoutType
        ...
        # @!attribute post_max_price
        #
        #   @return [Integer, nil]
        optional :post_max_price, Integer, api_name: :postMaxPrice

        # @!attribute post_min_price
        #
        #   @return [Integer, nil]
        optional :post_min_price, Integer, api_name: :postMinPrice
        ...
        #
        #   @return [Integer, nil]
        optional :subscribe_max_price, Integer, api_name: :subscribeMaxPrice

        # @!attribute subscribe_min_price
        #
        #   @return [Float, nil]
        optional :subscribe_min_price, Float, api_name: :subscribeMinPrice
        ...
        # @!attribute trial_max_days
        #
        #   @return [Integer, nil]
        optional :trial_max_days, Integer, api_name: :trialMaxDays

        # @!attribute trial_max_expires_days
        #
        #   @return [Integer, nil]
        optional :trial_max_expires_days, Integer, api_name: :trialMaxExpiresDays
        ...
        # @!attribute unread_tips
        #
        #   @return [Integer, nil]
        optional :unread_tips, Integer, api_name: :unreadTips

        # @!attribute upload
        #
        #   @return [Onlyfans::Models::MeRetrieveResponse::Data::Upload, nil]
        optional :upload, -> { Onlyfans::Models::MeRetrieveResponse::Data::Upload }
        ...
        # @!attribute vat_number_name
        #
        #   @return [String, nil]
        optional :vat_number_name, String, api_name: :vatNumberName
        ...
        #
        #   @return [Boolean, nil]
        optional :wallet_first_rebills, Onlyfans::Internal::Type::Boolean, api_name: :walletFirstRebills
        ...
        #   @param can_make_expire_posts [Boolean]
        ...
        #   @param can_receive_stripe_payout [Boolean]
        #   @param can_send_chat_to_all [Boolean]
        #   @param can_streaming [Boolean]
        ...
        #   @param has_new_ticket_replies [Onlyfans::Models::MeRetrieveResponse::Data::HasNewTicketReplies]
        ...
        #   @param header [String]
        #   @param header_size [Onlyfans::Models::MeRetrieveResponse::Data::HeaderSize]
        #   @param header_thumbs [Onlyfans::Models::MeRetrieveResponse::Data::HeaderThumbs]
        #   @param ip [String]
        #   @param is_adult_content [Boolean]
        #   @param is_age_verified [Boolean]
        #   @param is_allow_tweets [Boolean]
        #   @param is_auth [Boolean]
        #   @param is_country_vat_number_collect [Boolean]
        #   @param is_country_vat_refundable [Boolean]
        #   @param is_country_with_vat [Boolean]
        ...
        #   @param is_need_confirm_payout [Boolean]
        ...
        #   @param is_scheduled_streams_allowed [Boolean]
        ...
        #   @param message_max_price [Integer]
        #   @param message_min_price [Integer]
        #   @param min_fund_raising_target [Integer]
        #   @param name [String]
        ...
        #   @param payout_type [String]
        #   @param photos_count [Integer]
        #   @param pinned_posts_count [Integer]
        #   @param post_max_price [Integer]
        #   @param post_min_price [Integer]
        ...
        #   @param trial_max_days [Integer]
        #   @param trial_max_expires_days [Integer]
        #   @param twitter_username [String]
        #   @param unread_tips [Integer]
        #   @param upload [Onlyfans::Models::MeRetrieveResponse::Data::Upload]
        #   @param username [String]
        #   @param vat_number_name [String]
        ...
        # @see Onlyfans::Models::MeRetrieveResponse::Data#avatar_thumbs
        ...
        # @see Onlyfans::Models::MeRetrieveResponse::Data#has_new_ticket_replies
        class HasNewTicketReplies < Onlyfans::Internal::Type::BaseModel
          # @!attribute appeal_form
          #
          #   @return [Boolean, nil]
          optional :appeal_form, Onlyfans::Internal::Type::Boolean

          # @!attribute closed
          #
          #   @return [Boolean, nil]
          optional :closed, Onlyfans::Internal::Type::Boolean

          # @!attribute open_
          #
          #   @return [Boolean, nil]
          optional :open_, Onlyfans::Internal::Type::Boolean, api_name: :open

          # @!attribute solved
          #
          #   @return [Boolean, nil]
          optional :solved, Onlyfans::Internal::Type::Boolean

          # @!method initialize(appeal_form: nil, closed: nil, open_: nil, solved: nil)
          #   @param appeal_form [Boolean]
          #   @param closed [Boolean]
          #   @param open_ [Boolean]
          #   @param solved [Boolean]
        end

        # @see Onlyfans::Models::MeRetrieveResponse::Data#header_size
        ...
        # @see Onlyfans::Models::MeRetrieveResponse::Data#header_thumbs
        ...
        # @see Onlyfans::Models::MeRetrieveResponse::Data#upload
        class Upload < Onlyfans::Internal::Type::BaseModel
          # @!attribute geo_upload_args
          #
          #   @return [Onlyfans::Models::MeRetrieveResponse::Data::Upload::GeoUploadArgs, nil]
          optional :geo_upload_args,
                   -> { Onlyfans::Models::MeRetrieveResponse::Data::Upload::GeoUploadArgs },
                   api_name: :geoUploadArgs

          # @!method initialize(geo_upload_args: nil)
          #   @param geo_upload_args [Onlyfans::Models::MeRetrieveResponse::Data::Upload::GeoUploadArgs]

          # @see Onlyfans::Models::MeRetrieveResponse::Data::Upload#geo_upload_args
          class GeoUploadArgs < Onlyfans::Internal::Type::BaseModel
            # @!attribute additional
            #
            #   @return [Onlyfans::Models::MeRetrieveResponse::Data::Upload::GeoUploadArgs::Additional, nil]
            optional :additional, -> { Onlyfans::Models::MeRetrieveResponse::Data::Upload::GeoUploadArgs::Additional }
            ...
            #   @param additional [Onlyfans::Models::MeRetrieveResponse::Data::Upload::GeoUploadArgs::Additional]
            ...
            # @see Onlyfans::Models::MeRetrieveResponse::Data::Upload::GeoUploadArgs#additional
