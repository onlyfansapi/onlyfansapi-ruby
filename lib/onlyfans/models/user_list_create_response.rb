...
module Onlyfans
  module Models
    ...
    class UserListCreateResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::UserListCreateResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::UserListCreateResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::UserListCreateResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::UserListCreateResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::UserListCreateResponse::Meta]
      #   @param data [Onlyfans::Models::UserListCreateResponse::Data]

      # @see Onlyfans::Models::UserListCreateResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::UserListCreateResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::UserListCreateResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::UserListCreateResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::UserListCreateResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::UserListCreateResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::UserListCreateResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::UserListCreateResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::UserListCreateResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::UserListCreateResponse::Meta::RateLimits]

        # @see Onlyfans::Models::UserListCreateResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::UserListCreateResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::UserListCreateResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::UserListCreateResponse#data
