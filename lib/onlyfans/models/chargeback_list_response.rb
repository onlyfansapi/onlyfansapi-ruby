...
module Onlyfans
  module Models
    ...
    class ChargebackListResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::ChargebackListResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::ChargebackListResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::ChargebackListResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::ChargebackListResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::ChargebackListResponse::Meta]
      #   @param data [Onlyfans::Models::ChargebackListResponse::Data]

      # @see Onlyfans::Models::ChargebackListResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::ChargebackListResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::ChargebackListResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::ChargebackListResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::ChargebackListResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::ChargebackListResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::ChargebackListResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::ChargebackListResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::ChargebackListResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::ChargebackListResponse::Meta::RateLimits]

        # @see Onlyfans::Models::ChargebackListResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::ChargebackListResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::ChargebackListResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::ChargebackListResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        # @!attribute list
        #
        #   @return [Array<Onlyfans::Models::ChargebackListResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::ChargebackListResponse::Data::List] }
        ...
        #   @param list [Array<Onlyfans::Models::ChargebackListResponse::Data::List>]
