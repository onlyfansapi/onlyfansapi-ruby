...
module Onlyfans
  module Models
    ...
    class FollowingListExpiredResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::FollowingListExpiredResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::FollowingListExpiredResponse::Meta }

      # @!attribute _pagination
      #
      #   @return [Onlyfans::Models::FollowingListExpiredResponse::Pagination, nil]
      optional :_pagination, -> { Onlyfans::Models::FollowingListExpiredResponse::Pagination }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::FollowingListExpiredResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::FollowingListExpiredResponse::Data }

      # @!method initialize(_meta: nil, _pagination: nil, data: nil)
      #   @param _meta [Onlyfans::Models::FollowingListExpiredResponse::Meta]
      #   @param _pagination [Onlyfans::Models::FollowingListExpiredResponse::Pagination]
      #   @param data [Onlyfans::Models::FollowingListExpiredResponse::Data]

      # @see Onlyfans::Models::FollowingListExpiredResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::FollowingListExpiredResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::FollowingListExpiredResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::FollowingListExpiredResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::FollowingListExpiredResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::FollowingListExpiredResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::FollowingListExpiredResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::FollowingListExpiredResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::FollowingListExpiredResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::FollowingListExpiredResponse::Meta::RateLimits]

        # @see Onlyfans::Models::FollowingListExpiredResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::FollowingListExpiredResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::FollowingListExpiredResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::FollowingListExpiredResponse#_pagination
      ...
      # @see Onlyfans::Models::FollowingListExpiredResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfans::Models::FollowingListExpiredResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FollowingListExpiredResponse::Data::List] }

        # @!method initialize(has_more: nil, list: nil)
        #   @param has_more [Boolean]
        #   @param list [Array<Onlyfans::Models::FollowingListExpiredResponse::Data::List>]
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfans::Models::FollowingListExpiredResponse::Data::List::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfans::Models::FollowingListExpiredResponse::Data::List::AvatarThumbs },
          ...
          #
          #   @return [Onlyfans::Models::FollowingListExpiredResponse::Data::List::HeaderSize, nil]
          optional :header_size,
                   -> { Onlyfans::Models::FollowingListExpiredResponse::Data::List::HeaderSize },
                   api_name: :headerSize

          # @!attribute header_thumbs
          #
          #   @return [Onlyfans::Models::FollowingListExpiredResponse::Data::List::HeaderThumbs, nil]
          optional :header_thumbs,
                   -> { Onlyfans::Models::FollowingListExpiredResponse::Data::List::HeaderThumbs },
          ...
          #
          #   @return [Array<Onlyfans::Models::FollowingListExpiredResponse::Data::List::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FollowingListExpiredResponse::Data::List::ListsState] },
          ...
          #
          #   @return [Onlyfans::Models::FollowingListExpiredResponse::Data::List::SubscribedByData, nil]
          optional :subscribed_by_data,
                   -> { Onlyfans::Models::FollowingListExpiredResponse::Data::List::SubscribedByData },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfans::Models::FollowingListExpiredResponse::Data::List::AvatarThumbs]
          ...
          #   @param header [String]
          #   @param header_size [Onlyfans::Models::FollowingListExpiredResponse::Data::List::HeaderSize]
          #   @param header_thumbs [Onlyfans::Models::FollowingListExpiredResponse::Data::List::HeaderThumbs]
          ...
          #   @param lists_states [Array<Onlyfans::Models::FollowingListExpiredResponse::Data::List::ListsState>]
          #   @param name [String]
          #   @param subscribed_by [Boolean]
          #   @param subscribed_by_autoprolong [Boolean]
          #   @param subscribed_by_data [Onlyfans::Models::FollowingListExpiredResponse::Data::List::SubscribedByData]
          ...
          # @see Onlyfans::Models::FollowingListExpiredResponse::Data::List#avatar_thumbs
          ...
          # @see Onlyfans::Models::FollowingListExpiredResponse::Data::List#header_size
          ...
          # @see Onlyfans::Models::FollowingListExpiredResponse::Data::List#header_thumbs
          ...
          # @see Onlyfans::Models::FollowingListExpiredResponse::Data::List#subscribed_by_data
          class SubscribedByData < Onlyfans::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Onlyfans::Models::FollowingListExpiredResponse::Data::List::SubscribedByData::Subscribe>, nil]
            optional :subscribes,
                     -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FollowingListExpiredResponse::Data::List::SubscribedByData::Subscribe] }
            ...
            #   @param subscribe_price [Integer]
            #   @param subscribes [Array<Onlyfans::Models::FollowingListExpiredResponse::Data::List::SubscribedByData::Subscribe>]
