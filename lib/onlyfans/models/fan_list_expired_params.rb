...
module Onlyfans
  module Models
    ...
    class FanListExpiredParams < Onlyfans::Internal::Type::BaseModel
      ...
      # @!attribute filter
      #
      #   @return [Onlyfans::Models::FanListExpiredParams::Filter, nil]
      optional :filter, -> { Onlyfans::FanListExpiredParams::Filter }
      ...
      #   Filter by fan type.
      #
      #   @return [Symbol, Onlyfans::Models::FanListExpiredParams::Type, nil]
      optional :type, enum: -> { Onlyfans::FanListExpiredParams::Type }
      ...
      class Filter < Onlyfans::Internal::Type::BaseModel
        ...
        #   ignored.
        #
        #   @return [Integer, Onlyfans::Models::FanListExpiredParams::Filter::Online, nil]
        optional :online, enum: -> { Onlyfans::FanListExpiredParams::Filter::Online }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {Onlyfans::Models::FanListExpiredParams::Filter} for more details.
        #
        #   @param duration [Integer] Filter by minimum subscription duration in months. Must use bracket syntax: filt
        #
        #   @param online [Integer, Onlyfans::Models::FanListExpiredParams::Filter::Online, nil] Filter by online status (`1` for online fans). Must use bracket syntax: filter[o
        #
        ...
        # ignored.
        #
        # @see Onlyfans::Models::FanListExpiredParams::Filter#online
        module Online
