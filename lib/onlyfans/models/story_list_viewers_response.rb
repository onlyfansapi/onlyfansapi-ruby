...
module Onlyfans
  module Models
    ...
    class StoryListViewersResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::StoryListViewersResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::StoryListViewersResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::StoryListViewersResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::StoryListViewersResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::StoryListViewersResponse::Meta]
      #   @param data [Onlyfans::Models::StoryListViewersResponse::Data]

      # @see Onlyfans::Models::StoryListViewersResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::StoryListViewersResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::StoryListViewersResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::StoryListViewersResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::StoryListViewersResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::StoryListViewersResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::StoryListViewersResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::StoryListViewersResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::StoryListViewersResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::StoryListViewersResponse::Meta::RateLimits]

        # @see Onlyfans::Models::StoryListViewersResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::StoryListViewersResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::StoryListViewersResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::StoryListViewersResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfans::Models::StoryListViewersResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::StoryListViewersResponse::Data::List] }

        # @!method initialize(has_more: nil, list: nil)
        #   @param has_more [Boolean]
        #   @param list [Array<Onlyfans::Models::StoryListViewersResponse::Data::List>]
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          #
          #   @return [Boolean, nil]
          optional :has_story_tips, Onlyfans::Internal::Type::Boolean, api_name: :hasStoryTips
          ...
          #
          #   @return [Boolean, nil]
          optional :has_top_story_tips, Onlyfans::Internal::Type::Boolean, api_name: :hasTopStoryTips
          ...
          #
          #   @return [Boolean, nil]
          optional :is_story_blocked_user, Onlyfans::Internal::Type::Boolean, api_name: :isStoryBlockedUser

          # @!attribute is_story_liked
          #
          #   @return [Boolean, nil]
          optional :is_story_liked, Onlyfans::Internal::Type::Boolean, api_name: :isStoryLiked
          ...
          #
          #   @return [Array<Onlyfans::Models::StoryListViewersResponse::Data::List::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::StoryListViewersResponse::Data::List::ListsState] },
          ...
          #   @param lists_states [Array<Onlyfans::Models::StoryListViewersResponse::Data::List::ListsState>]
          #   @param name [String]
          #   @param notice [String]
