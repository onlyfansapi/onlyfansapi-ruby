...
module Onlyfans
  module Models
    # @see Onlyfans::Resources::Following#list_all
    class FollowingListAllResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::FollowingListAllResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::FollowingListAllResponse::Meta }

      # @!attribute _pagination
      #
      #   @return [Onlyfans::Models::FollowingListAllResponse::Pagination, nil]
      optional :_pagination, -> { Onlyfans::Models::FollowingListAllResponse::Pagination }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::FollowingListAllResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::FollowingListAllResponse::Data }

      # @!method initialize(_meta: nil, _pagination: nil, data: nil)
      #   @param _meta [Onlyfans::Models::FollowingListAllResponse::Meta]
      #   @param _pagination [Onlyfans::Models::FollowingListAllResponse::Pagination]
      #   @param data [Onlyfans::Models::FollowingListAllResponse::Data]

      # @see Onlyfans::Models::FollowingListAllResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::FollowingListAllResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::FollowingListAllResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::FollowingListAllResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::FollowingListAllResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::FollowingListAllResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::FollowingListAllResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::FollowingListAllResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::FollowingListAllResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::FollowingListAllResponse::Meta::RateLimits]

        # @see Onlyfans::Models::FollowingListAllResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::FollowingListAllResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::FollowingListAllResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::FollowingListAllResponse#_pagination
      ...
      # @see Onlyfans::Models::FollowingListAllResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfans::Models::FollowingListAllResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FollowingListAllResponse::Data::List] }

        # @!method initialize(has_more: nil, list: nil)
        #   @param has_more [Boolean]
        #   @param list [Array<Onlyfans::Models::FollowingListAllResponse::Data::List>]
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfans::Models::FollowingListAllResponse::Data::List::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfans::Models::FollowingListAllResponse::Data::List::AvatarThumbs },
          ...
          #
          #   @return [Onlyfans::Models::FollowingListAllResponse::Data::List::HeaderSize, nil]
          optional :header_size,
                   -> { Onlyfans::Models::FollowingListAllResponse::Data::List::HeaderSize },
                   api_name: :headerSize

          # @!attribute header_thumbs
          #
          #   @return [Onlyfans::Models::FollowingListAllResponse::Data::List::HeaderThumbs, nil]
          optional :header_thumbs,
                   -> { Onlyfans::Models::FollowingListAllResponse::Data::List::HeaderThumbs },
          ...
          #
          #   @return [Array<Onlyfans::Models::FollowingListAllResponse::Data::List::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FollowingListAllResponse::Data::List::ListsState] },
          ...
          #
          #   @return [Onlyfans::Models::FollowingListAllResponse::Data::List::SubscribedByData, nil]
          optional :subscribed_by_data,
                   -> { Onlyfans::Models::FollowingListAllResponse::Data::List::SubscribedByData },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfans::Models::FollowingListAllResponse::Data::List::AvatarThumbs]
          ...
          #   @param header [String]
          #   @param header_size [Onlyfans::Models::FollowingListAllResponse::Data::List::HeaderSize]
          #   @param header_thumbs [Onlyfans::Models::FollowingListAllResponse::Data::List::HeaderThumbs]
          ...
          #   @param lists_states [Array<Onlyfans::Models::FollowingListAllResponse::Data::List::ListsState>]
          #   @param name [String]
          #   @param subscribed_by [Boolean]
          #   @param subscribed_by_autoprolong [Boolean]
          #   @param subscribed_by_data [Onlyfans::Models::FollowingListAllResponse::Data::List::SubscribedByData]
          ...
          # @see Onlyfans::Models::FollowingListAllResponse::Data::List#avatar_thumbs
          ...
          # @see Onlyfans::Models::FollowingListAllResponse::Data::List#header_size
          ...
          # @see Onlyfans::Models::FollowingListAllResponse::Data::List#header_thumbs
          ...
          # @see Onlyfans::Models::FollowingListAllResponse::Data::List#subscribed_by_data
          class SubscribedByData < Onlyfans::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Onlyfans::Models::FollowingListAllResponse::Data::List::SubscribedByData::Subscribe>, nil]
            optional :subscribes,
                     -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FollowingListAllResponse::Data::List::SubscribedByData::Subscribe] }
            ...
            #   @param subscribe_price [Integer]
            #   @param subscribes [Array<Onlyfans::Models::FollowingListAllResponse::Data::List::SubscribedByData::Subscribe>]
