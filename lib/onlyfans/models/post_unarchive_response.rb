...
module Onlyfans
  module Models
    ...
    class PostUnarchiveResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::PostUnarchiveResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::PostUnarchiveResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::PostUnarchiveResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::PostUnarchiveResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::PostUnarchiveResponse::Meta]
      #   @param data [Onlyfans::Models::PostUnarchiveResponse::Data]

      # @see Onlyfans::Models::PostUnarchiveResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::PostUnarchiveResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::PostUnarchiveResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::PostUnarchiveResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::PostUnarchiveResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::PostUnarchiveResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::PostUnarchiveResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::PostUnarchiveResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::PostUnarchiveResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::PostUnarchiveResponse::Meta::RateLimits]

        # @see Onlyfans::Models::PostUnarchiveResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::PostUnarchiveResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::PostUnarchiveResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::PostUnarchiveResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        # @!attribute counters
        #
        #   @return [Onlyfans::Models::PostUnarchiveResponse::Data::Counters, nil]
        optional :counters, -> { Onlyfans::Models::PostUnarchiveResponse::Data::Counters }

        # @!attribute label_states
        #
        #   @return [Array<Onlyfans::Models::PostUnarchiveResponse::Data::LabelState>, nil]
        optional :label_states,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::PostUnarchiveResponse::Data::LabelState] },
                 api_name: :labelStates

        # @!method initialize(counters: nil, label_states: nil)
        #   @param counters [Onlyfans::Models::PostUnarchiveResponse::Data::Counters]
        #   @param label_states [Array<Onlyfans::Models::PostUnarchiveResponse::Data::LabelState>]

        # @see Onlyfans::Models::PostUnarchiveResponse::Data#counters
