...
module Onlyfans
  module Models
    ...
    class UserListUpdateResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::UserListUpdateResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::UserListUpdateResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::UserListUpdateResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::UserListUpdateResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::UserListUpdateResponse::Meta]
      #   @param data [Onlyfans::Models::UserListUpdateResponse::Data]

      # @see Onlyfans::Models::UserListUpdateResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::UserListUpdateResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::UserListUpdateResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::UserListUpdateResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::UserListUpdateResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::UserListUpdateResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::UserListUpdateResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::UserListUpdateResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::UserListUpdateResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::UserListUpdateResponse::Meta::RateLimits]

        # @see Onlyfans::Models::UserListUpdateResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::UserListUpdateResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::UserListUpdateResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::UserListUpdateResponse#data
