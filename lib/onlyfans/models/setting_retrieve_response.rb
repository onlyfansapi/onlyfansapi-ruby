...
module Onlyfans
  module Models
    # @see Onlyfans::Resources::Settings#retrieve
    class SettingRetrieveResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::SettingRetrieveResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::SettingRetrieveResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::SettingRetrieveResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::SettingRetrieveResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::SettingRetrieveResponse::Meta]
      #   @param data [Onlyfans::Models::SettingRetrieveResponse::Data]

      # @see Onlyfans::Models::SettingRetrieveResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::SettingRetrieveResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::SettingRetrieveResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::SettingRetrieveResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::SettingRetrieveResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::SettingRetrieveResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::SettingRetrieveResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::SettingRetrieveResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::SettingRetrieveResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::SettingRetrieveResponse::Meta::RateLimits]

        # @see Onlyfans::Models::SettingRetrieveResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::SettingRetrieveResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::SettingRetrieveResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::SettingRetrieveResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        # @!attribute activity_hub_allowed
        #
        #   @return [Boolean, nil]
        optional :activity_hub_allowed, Onlyfans::Internal::Type::Boolean, api_name: :activityHubAllowed
        ...
        #
        #   @return [Boolean, nil]
        optional :app_otp, Onlyfans::Internal::Type::Boolean, api_name: :appOtp
        ...
        #
        #   @return [Boolean, nil]
        optional :can_add_phone, Onlyfans::Internal::Type::Boolean, api_name: :canAddPhone

        # @!attribute can_add_subscriber_by_bundle
        #
        #   @return [Onlyfans::Models::SettingRetrieveResponse::Data::CanAddSubscriberByBundle, nil]
        ...
        #
        #   @return [Boolean, nil]
        optional :can_make_profile_links, Onlyfans::Internal::Type::Boolean, api_name: :canMakeProfileLinks

        # @!attribute can_socials_connect
        #
        #   @return [Boolean, nil]
        optional :can_socials_connect, Onlyfans::Internal::Type::Boolean, api_name: :canSocialsConnect
        ...
        #
        #   @return [Boolean, nil]
        optional :face_otp, Onlyfans::Internal::Type::Boolean, api_name: :faceOtp

        # @!attribute force_face_otp
        #
        #   @return [Boolean, nil]
        optional :force_face_otp, Onlyfans::Internal::Type::Boolean, api_name: :forceFaceOtp

        # @!attribute has_paid_posts
        #
        #   @return [Boolean, nil]
        optional :has_paid_posts, Onlyfans::Internal::Type::Boolean, api_name: :hasPaidPosts

        # @!attribute has_password
        #
        #   @return [Boolean, nil]
        optional :has_password, Onlyfans::Internal::Type::Boolean, api_name: :hasPassword
        ...
        #
        #   @return [Boolean, nil]
        optional :is_auto_follow_back, Onlyfans::Internal::Type::Boolean, api_name: :isAutoFollowBack

        # @!attribute is_co_streaming_allowed
        #
        #   @return [Boolean, nil]
        optional :is_co_streaming_allowed, Onlyfans::Internal::Type::Boolean, api_name: :isCoStreamingAllowed
        ...
        #
        #   @return [Boolean, nil]
        optional :is_drm_enabled, Onlyfans::Internal::Type::Boolean, api_name: :isDrmEnabled
        ...
        #
        #   @return [Boolean, nil]
        optional :is_monthly_newsletters, Onlyfans::Internal::Type::Boolean, api_name: :isMonthlyNewsletters

        # @!attribute is_old_login_redirect
        #
        #   @return [Boolean, nil]
        optional :is_old_login_redirect, Onlyfans::Internal::Type::Boolean, api_name: :isOldLoginRedirect

        # @!attribute is_opensea_connected
        #
        #   @return [Boolean, nil]
        optional :is_opensea_connected, Onlyfans::Internal::Type::Boolean, api_name: :isOpenseaConnected

        # @!attribute is_otp_app_connected
        #
        #   @return [Boolean, nil]
        optional :is_otp_app_connected, Onlyfans::Internal::Type::Boolean, api_name: :isOtpAppConnected

        # @!attribute is_private
        #
        #   @return [Boolean, nil]
        optional :is_private, Onlyfans::Internal::Type::Boolean, api_name: :isPrivate

        # @!attribute is_suggestions_opt_out
        #
        #   @return [Boolean, nil]
        optional :is_suggestions_opt_out, Onlyfans::Internal::Type::Boolean, api_name: :isSuggestionsOptOut

        # @!attribute is_telegram_connected
        #
        #   @return [Boolean, nil]
        optional :is_telegram_connected, Onlyfans::Internal::Type::Boolean, api_name: :isTelegramConnected
        ...
        #
        #   @return [Boolean, nil]
        optional :mute_tags_in_chats, Onlyfans::Internal::Type::Boolean, api_name: :muteTagsInChats

        # @!attribute mute_tags_in_posts
        #
        #   @return [Boolean, nil]
        optional :mute_tags_in_posts, Onlyfans::Internal::Type::Boolean, api_name: :muteTagsInPosts

        # @!attribute mute_tags_in_stories
        #
        #   @return [Boolean, nil]
        optional :mute_tags_in_stories, Onlyfans::Internal::Type::Boolean, api_name: :muteTagsInStories

        # @!attribute mute_tags_in_streams
        #
        #   @return [Boolean, nil]
        optional :mute_tags_in_streams, Onlyfans::Internal::Type::Boolean, api_name: :muteTagsInStreams
        ...
        #
        #   @return [Boolean, nil]
        optional :notify_on_all_mentions, Onlyfans::Internal::Type::Boolean, api_name: :notifyOnAllMentions
        ...
        #
        #   @return [Boolean, nil]
        optional :phone_otp, Onlyfans::Internal::Type::Boolean, api_name: :phoneOtp
        ...
        #
        #   @return [Boolean, nil]
        optional :reply_on_subscribe, Onlyfans::Internal::Type::Boolean, api_name: :replyOnSubscribe

        # @!attribute send_awards_top1
        #
        #   @return [Boolean, nil]
        optional :send_awards_top1, Onlyfans::Internal::Type::Boolean, api_name: :sendAwardsTop1

        # @!attribute send_awards_top5
        #
        #   @return [Boolean, nil]
        optional :send_awards_top5, Onlyfans::Internal::Type::Boolean, api_name: :sendAwardsTop5
        ...
        #
        #   @return [Boolean, nil]
        optional :show_posts_tips, Onlyfans::Internal::Type::Boolean, api_name: :showPostsTips

        # @!attribute show_subscribes_offers
        #
        #   @return [Boolean, nil]
        optional :show_subscribes_offers, Onlyfans::Internal::Type::Boolean, api_name: :showSubscribesOffers
        ...
        #
        #   @return [Boolean, nil]
        optional :strong_otp, Onlyfans::Internal::Type::Boolean, api_name: :strongOtp
        ...
        #   @param can_add_subscriber_by_bundle [Onlyfans::Models::SettingRetrieveResponse::Data::CanAddSubscriberByBundle]
        ...
        # @see Onlyfans::Models::SettingRetrieveResponse::Data#can_add_subscriber_by_bundle
        class CanAddSubscriberByBundle < Onlyfans::Internal::Type::BaseModel
          # @!attribute discounts
          #
          #   @return [Onlyfans::Models::SettingRetrieveResponse::Data::CanAddSubscriberByBundle::Discounts, nil]
          optional :discounts,
                   -> { Onlyfans::Models::SettingRetrieveResponse::Data::CanAddSubscriberByBundle::Discounts }

          # @!attribute durations
          #
          #   @return [Onlyfans::Models::SettingRetrieveResponse::Data::CanAddSubscriberByBundle::Durations, nil]
          optional :durations,
          ...
          #   @param discounts [Onlyfans::Models::SettingRetrieveResponse::Data::CanAddSubscriberByBundle::Discounts]
          #   @param durations [Onlyfans::Models::SettingRetrieveResponse::Data::CanAddSubscriberByBundle::Durations]

          # @see Onlyfans::Models::SettingRetrieveResponse::Data::CanAddSubscriberByBundle#discounts
          ...
          # @see Onlyfans::Models::SettingRetrieveResponse::Data::CanAddSubscriberByBundle#durations
