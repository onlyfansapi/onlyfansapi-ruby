...
module Onlyfans
  module Models
    ...
    class TrackingLinkListParams < Onlyfans::Internal::Type::BaseModel
      ...
      optional :sort, enum: -> { Onlyfans::TrackingLinkListParams::Sort }, nil?: true

      # @!attribute sortby
      #   Sort by subscriber count (claims), or creation date
      #
      #   @return [Symbol, Onlyfans::Models::TrackingLinkListParams::Sortby, nil]
      optional :sortby, enum: -> { Onlyfans::TrackingLinkListParams::Sortby }, nil?: true
      ...
      #
      #   @return [Boolean, nil]
      optional :with_deleted, Onlyfans::Internal::Type::Boolean, nil?: true
