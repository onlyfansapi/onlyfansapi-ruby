...
module Onlyfans
  module Models
    module Engagement
      ...
      class MessageGetMessageBuyersResponse < Onlyfans::Internal::Type::BaseModel
        # @!attribute _meta
        #
        #   @return [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta, nil]
        optional :_meta, -> { Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta }

        # @!attribute _pagination
        #
        #   @return [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Pagination, nil]
        optional :_pagination, -> { Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Pagination }

        # @!attribute data
        #
        #   @return [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Data, nil]
        optional :data, -> { Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Data }

        # @!method initialize(_meta: nil, _pagination: nil, data: nil)
        #   @param _meta [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta]
        #   @param _pagination [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Pagination]
        #   @param data [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Data]

        # @see Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse#_meta
        class Meta < Onlyfans::Internal::Type::BaseModel
          # @!attribute _cache
          #
          #   @return [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta::Cache, nil]
          optional :_cache, -> { Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta::Cache }

          # @!attribute _credits
          #
          #   @return [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta::Credits, nil]
          optional :_credits, -> { Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta::Credits }

          # @!attribute _rate_limits
          #
          #   @return [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta::RateLimits, nil]
          optional :_rate_limits,
                   -> { Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta::RateLimits }

          # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
          #   @param _cache [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta::Cache]
          #   @param _credits [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta::Credits]
          #   @param _rate_limits [Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta::RateLimits]

          # @see Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta#_cache
          ...
          # @see Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta#_credits
          ...
          # @see Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Meta#_rate_limits
        ...
        # @see Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse#_pagination
        ...
        # @see Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse#data
        class Data < Onlyfans::Internal::Type::BaseModel
          ...
          # @!attribute list
          #
          #   @return [Array<Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Data::List>, nil]
          optional :list,
          ...
          #   @param list [Array<Onlyfans::Models::Engagement::MessageGetMessageBuyersResponse::Data::List>]
