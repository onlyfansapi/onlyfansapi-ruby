...
module Onlyfans
  module Models
    module Chats
      ...
      class MessageSendResponse < Onlyfans::Internal::Type::BaseModel
        # @!attribute _meta
        #
        #   @return [Onlyfans::Models::Chats::MessageSendResponse::Meta, nil]
        optional :_meta, -> { Onlyfans::Models::Chats::MessageSendResponse::Meta }

        # @!attribute _pagination
        #
        #   @return [Onlyfans::Models::Chats::MessageSendResponse::Pagination, nil]
        optional :_pagination, -> { Onlyfans::Models::Chats::MessageSendResponse::Pagination }

        # @!attribute data
        #
        #   @return [Onlyfans::Models::Chats::MessageSendResponse::Data, nil]
        optional :data, -> { Onlyfans::Models::Chats::MessageSendResponse::Data }

        # @!method initialize(_meta: nil, _pagination: nil, data: nil)
        #   @param _meta [Onlyfans::Models::Chats::MessageSendResponse::Meta]
        #   @param _pagination [Onlyfans::Models::Chats::MessageSendResponse::Pagination]
        #   @param data [Onlyfans::Models::Chats::MessageSendResponse::Data]

        # @see Onlyfans::Models::Chats::MessageSendResponse#_meta
        class Meta < Onlyfans::Internal::Type::BaseModel
          # @!attribute _cache
          #
          #   @return [Onlyfans::Models::Chats::MessageSendResponse::Meta::Cache, nil]
          optional :_cache, -> { Onlyfans::Models::Chats::MessageSendResponse::Meta::Cache }

          # @!attribute _credits
          #
          #   @return [Onlyfans::Models::Chats::MessageSendResponse::Meta::Credits, nil]
          optional :_credits, -> { Onlyfans::Models::Chats::MessageSendResponse::Meta::Credits }

          # @!attribute _rate_limits
          #
          #   @return [Onlyfans::Models::Chats::MessageSendResponse::Meta::RateLimits, nil]
          optional :_rate_limits, -> { Onlyfans::Models::Chats::MessageSendResponse::Meta::RateLimits }

          # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
          #   @param _cache [Onlyfans::Models::Chats::MessageSendResponse::Meta::Cache]
          #   @param _credits [Onlyfans::Models::Chats::MessageSendResponse::Meta::Credits]
          #   @param _rate_limits [Onlyfans::Models::Chats::MessageSendResponse::Meta::RateLimits]

          # @see Onlyfans::Models::Chats::MessageSendResponse::Meta#_cache
          ...
          # @see Onlyfans::Models::Chats::MessageSendResponse::Meta#_credits
          ...
          # @see Onlyfans::Models::Chats::MessageSendResponse::Meta#_rate_limits
        ...
        # @see Onlyfans::Models::Chats::MessageSendResponse#_pagination
        ...
        # @see Onlyfans::Models::Chats::MessageSendResponse#data
        class Data < Onlyfans::Internal::Type::BaseModel
          ...
          # @!attribute from_user
          #
          #   @return [Onlyfans::Models::Chats::MessageSendResponse::Data::FromUser, nil]
          optional :from_user,
          ...
          #   @param from_user [Onlyfans::Models::Chats::MessageSendResponse::Data::FromUser]
          ...
          # @see Onlyfans::Models::Chats::MessageSendResponse::Data#from_user
