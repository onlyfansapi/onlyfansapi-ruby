  ...
  module Models
    module Chats
      ...
      class MessageRetrieveResponse < Onlyfans::Internal::Type::BaseModel
        # @!attribute _meta
        #
        #   @return [Onlyfans::Models::Chats::MessageRetrieveResponse::Meta, nil]
        optional :_meta, -> { Onlyfans::Models::Chats::MessageRetrieveResponse::Meta }

        # @!attribute data
        #
        #   @return [Onlyfans::Models::Chats::MessageRetrieveResponse::Data, nil]
        optional :data, -> { Onlyfans::Models::Chats::MessageRetrieveResponse::Data }

        # @!method initialize(_meta: nil, data: nil)
        #   @param _meta [Onlyfans::Models::Chats::MessageRetrieveResponse::Meta]
        #   @param data [Onlyfans::Models::Chats::MessageRetrieveResponse::Data]

        # @see Onlyfans::Models::Chats::MessageRetrieveResponse#_meta
        class Meta < Onlyfans::Internal::Type::BaseModel
          # @!attribute _cache
          #
          #   @return [Onlyfans::Models::Chats::MessageRetrieveResponse::Meta::Cache, nil]
          optional :_cache, -> { Onlyfans::Models::Chats::MessageRetrieveResponse::Meta::Cache }

          # @!attribute _credits
          #
          #   @return [Onlyfans::Models::Chats::MessageRetrieveResponse::Meta::Credits, nil]
          optional :_credits, -> { Onlyfans::Models::Chats::MessageRetrieveResponse::Meta::Credits }

          # @!attribute _rate_limits
          #
          #   @return [Onlyfans::Models::Chats::MessageRetrieveResponse::Meta::RateLimits, nil]
          optional :_rate_limits, -> { Onlyfans::Models::Chats::MessageRetrieveResponse::Meta::RateLimits }

          # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
          #   @param _cache [Onlyfans::Models::Chats::MessageRetrieveResponse::Meta::Cache]
          #   @param _credits [Onlyfans::Models::Chats::MessageRetrieveResponse::Meta::Credits]
          #   @param _rate_limits [Onlyfans::Models::Chats::MessageRetrieveResponse::Meta::RateLimits]

          # @see Onlyfans::Models::Chats::MessageRetrieveResponse::Meta#_cache
          ...
          # @see Onlyfans::Models::Chats::MessageRetrieveResponse::Meta#_credits
          ...
          # @see Onlyfans::Models::Chats::MessageRetrieveResponse::Meta#_rate_limits
        ...
        # @see Onlyfans::Models::Chats::MessageRetrieveResponse#data
        class Data < Onlyfans::Internal::Type::BaseModel
          ...
          # @!attribute from_user
          #
          #   @return [Onlyfans::Models::Chats::MessageRetrieveResponse::Data::FromUser, nil]
          optional :from_user,
          ...
          #   @param from_user [Onlyfans::Models::Chats::MessageRetrieveResponse::Data::FromUser]
          ...
          # @see Onlyfans::Models::Chats::MessageRetrieveResponse::Data#from_user
