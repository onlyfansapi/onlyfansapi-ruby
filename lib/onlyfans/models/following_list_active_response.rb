...
module Onlyfans
  module Models
    # @see Onlyfans::Resources::Following#list_active
    class FollowingListActiveResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::FollowingListActiveResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::FollowingListActiveResponse::Meta }

      # @!attribute _pagination
      #
      #   @return [Onlyfans::Models::FollowingListActiveResponse::Pagination, nil]
      optional :_pagination, -> { Onlyfans::Models::FollowingListActiveResponse::Pagination }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::FollowingListActiveResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::FollowingListActiveResponse::Data }

      # @!method initialize(_meta: nil, _pagination: nil, data: nil)
      #   @param _meta [Onlyfans::Models::FollowingListActiveResponse::Meta]
      #   @param _pagination [Onlyfans::Models::FollowingListActiveResponse::Pagination]
      #   @param data [Onlyfans::Models::FollowingListActiveResponse::Data]

      # @see Onlyfans::Models::FollowingListActiveResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::FollowingListActiveResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::FollowingListActiveResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::FollowingListActiveResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::FollowingListActiveResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::FollowingListActiveResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::FollowingListActiveResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::FollowingListActiveResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::FollowingListActiveResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::FollowingListActiveResponse::Meta::RateLimits]

        # @see Onlyfans::Models::FollowingListActiveResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::FollowingListActiveResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::FollowingListActiveResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::FollowingListActiveResponse#_pagination
      ...
      # @see Onlyfans::Models::FollowingListActiveResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfans::Models::FollowingListActiveResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FollowingListActiveResponse::Data::List] }

        # @!method initialize(has_more: nil, list: nil)
        #   @param has_more [Boolean]
        #   @param list [Array<Onlyfans::Models::FollowingListActiveResponse::Data::List>]
        ...
        class List < Onlyfans::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfans::Models::FollowingListActiveResponse::Data::List::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfans::Models::FollowingListActiveResponse::Data::List::AvatarThumbs },
          ...
          #
          #   @return [Onlyfans::Models::FollowingListActiveResponse::Data::List::HeaderSize, nil]
          optional :header_size,
                   -> { Onlyfans::Models::FollowingListActiveResponse::Data::List::HeaderSize },
                   api_name: :headerSize

          # @!attribute header_thumbs
          #
          #   @return [Onlyfans::Models::FollowingListActiveResponse::Data::List::HeaderThumbs, nil]
          optional :header_thumbs,
                   -> { Onlyfans::Models::FollowingListActiveResponse::Data::List::HeaderThumbs },
          ...
          #
          #   @return [Array<Onlyfans::Models::FollowingListActiveResponse::Data::List::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FollowingListActiveResponse::Data::List::ListsState] },
          ...
          #
          #   @return [Onlyfans::Models::FollowingListActiveResponse::Data::List::SubscribedByData, nil]
          optional :subscribed_by_data,
                   -> { Onlyfans::Models::FollowingListActiveResponse::Data::List::SubscribedByData },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfans::Models::FollowingListActiveResponse::Data::List::AvatarThumbs]
          ...
          #   @param header [String]
          #   @param header_size [Onlyfans::Models::FollowingListActiveResponse::Data::List::HeaderSize]
          #   @param header_thumbs [Onlyfans::Models::FollowingListActiveResponse::Data::List::HeaderThumbs]
          ...
          #   @param lists_states [Array<Onlyfans::Models::FollowingListActiveResponse::Data::List::ListsState>]
          #   @param name [String]
          #   @param subscribed_by [Boolean]
          #   @param subscribed_by_autoprolong [Boolean]
          #   @param subscribed_by_data [Onlyfans::Models::FollowingListActiveResponse::Data::List::SubscribedByData]
          ...
          # @see Onlyfans::Models::FollowingListActiveResponse::Data::List#avatar_thumbs
          ...
          # @see Onlyfans::Models::FollowingListActiveResponse::Data::List#header_size
          ...
          # @see Onlyfans::Models::FollowingListActiveResponse::Data::List#header_thumbs
          ...
          # @see Onlyfans::Models::FollowingListActiveResponse::Data::List#subscribed_by_data
          class SubscribedByData < Onlyfans::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Onlyfans::Models::FollowingListActiveResponse::Data::List::SubscribedByData::Subscribe>, nil]
            optional :subscribes,
                     -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FollowingListActiveResponse::Data::List::SubscribedByData::Subscribe] }
            ...
            #   @param subscribe_price [Integer]
            #   @param subscribes [Array<Onlyfans::Models::FollowingListActiveResponse::Data::List::SubscribedByData::Subscribe>]
