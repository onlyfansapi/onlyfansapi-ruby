...
module Onlyfans
  module Models
    ...
    class FanListTopResponse < Onlyfans::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfans::Models::FanListTopResponse::Meta, nil]
      optional :_meta, -> { Onlyfans::Models::FanListTopResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfans::Models::FanListTopResponse::Data, nil]
      optional :data, -> { Onlyfans::Models::FanListTopResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfans::Models::FanListTopResponse::Meta]
      #   @param data [Onlyfans::Models::FanListTopResponse::Data]

      # @see Onlyfans::Models::FanListTopResponse#_meta
      class Meta < Onlyfans::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfans::Models::FanListTopResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfans::Models::FanListTopResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfans::Models::FanListTopResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfans::Models::FanListTopResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfans::Models::FanListTopResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfans::Models::FanListTopResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfans::Models::FanListTopResponse::Meta::Cache]
        #   @param _credits [Onlyfans::Models::FanListTopResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfans::Models::FanListTopResponse::Meta::RateLimits]

        # @see Onlyfans::Models::FanListTopResponse::Meta#_cache
        ...
        # @see Onlyfans::Models::FanListTopResponse::Meta#_credits
        ...
        # @see Onlyfans::Models::FanListTopResponse::Meta#_rate_limits
      ...
      # @see Onlyfans::Models::FanListTopResponse#data
      class Data < Onlyfans::Internal::Type::BaseModel
        # @!attribute users
        #
        #   @return [Array<Onlyfans::Models::FanListTopResponse::Data::User>, nil]
        optional :users,
                 -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FanListTopResponse::Data::User] }

        # @!method initialize(users: nil)
        #   @param users [Array<Onlyfans::Models::FanListTopResponse::Data::User>]
        ...
        class User < Onlyfans::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfans::Models::FanListTopResponse::Data::User::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfans::Models::FanListTopResponse::Data::User::AvatarThumbs },
          ...
          #
          #   @return [Array<Onlyfans::Models::FanListTopResponse::Data::User::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfans::Internal::Type::ArrayOf[Onlyfans::Models::FanListTopResponse::Data::User::ListsState] },
          ...
          #
          #   @return [Onlyfans::Models::FanListTopResponse::Data::User::SubscribedOnData, nil]
          optional :subscribed_on_data,
                   -> { Onlyfans::Models::FanListTopResponse::Data::User::SubscribedOnData },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfans::Models::FanListTopResponse::Data::User::AvatarThumbs]
          ...
          #   @param lists_states [Array<Onlyfans::Models::FanListTopResponse::Data::User::ListsState>]
          #   @param name [String]
          #   @param notice [String]
          ...
          #   @param subscribed_on_data [Onlyfans::Models::FanListTopResponse::Data::User::SubscribedOnData]
          ...
          # @see Onlyfans::Models::FanListTopResponse::Data::User#avatar_thumbs
          ...
          # @see Onlyfans::Models::FanListTopResponse::Data::User#subscribed_on_data
