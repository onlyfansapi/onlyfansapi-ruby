...
module Onlyfans
  module Resources
    ...
    class Posts
      # @return [Onlyfans::Resources::Posts::Comments]
      attr_reader :comments

      # APIs for managing your post labels
      # @return [Onlyfans::Resources::Posts::Labels]
      attr_reader :labels
      ...
      #
      # @return [Onlyfans::Models::PostCreateResponse]
      #
      # @see Onlyfans::Models::PostCreateParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PostRetrieveResponse]
      #
      # @see Onlyfans::Models::PostRetrieveParams
      ...
      #
      # @param voting_type [Symbol, Onlyfans::Models::PostUpdateParams::VotingType] Body param: Include a poll or quiz within your post.
      #
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [String]
      #
      # @see Onlyfans::Models::PostUpdateParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PostListResponse]
      #
      # @see Onlyfans::Models::PostListParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PostDeleteResponse]
      #
      # @see Onlyfans::Models::PostDeleteParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PostArchiveResponse]
      #
      # @see Onlyfans::Models::PostArchiveParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PostPinResponse]
      #
      # @see Onlyfans::Models::PostPinParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PostStatsResponse]
      #
      # @see Onlyfans::Models::PostStatsParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PostUnarchiveResponse]
      #
      # @see Onlyfans::Models::PostUnarchiveParams
