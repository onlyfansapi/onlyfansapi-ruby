...
module Onlyfans
  module Resources
    class Promotions
      ...
      #
      # @param type [Symbol, Onlyfans::Models::PromotionCreateParams::Type] Whether this promotion should apply to new subscribers, expired subscribers, or
      #
      ...
      #
      # @return [Onlyfans::Models::PromotionCreateResponse]
      #
      # @see Onlyfans::Models::PromotionCreateParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PromotionListResponse]
      #
      # @see Onlyfans::Models::PromotionListParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PromotionDeleteResponse]
      #
      # @see Onlyfans::Models::PromotionDeleteParams
      ...
      # @param request_options [Onlyfans::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Onlyfans::Models::PromotionStopResponse]
      #
      # @see Onlyfans::Models::PromotionStopParams
