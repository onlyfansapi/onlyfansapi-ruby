    ...
    class Engagement
      class Messages
        class MassMessages
          ...
          #
          # @return [Onlyfansapi::Models::Engagement::Messages::MassMessageListResponse]
          #
          # @see Onlyfansapi::Models::Engagement::Messages::MassMessageListParams
          def list(account, params = {})
            parsed, options = Onlyfansapi::Engagement::Messages::MassMessageListParams.dump_request(params)
            ...
            @client.request(
              ...
              model: Onlyfansapi::Models::Engagement::Messages::MassMessageListResponse,
              options: options
            )
          end
          ...
          # @param request_options [Onlyfansapi::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [Onlyfansapi::Models::Engagement::Messages::MassMessageChartResponse]
          #
          # @see Onlyfansapi::Models::Engagement::Messages::MassMessageChartParams
          def chart(account, params = {})
            parsed, options = Onlyfansapi::Engagement::Messages::MassMessageChartParams.dump_request(params)
            query = Onlyfansapi::Internal::Util.encode_query_params(parsed)
            @client.request(
              method: :get,
              ...
              model: Onlyfansapi::Models::Engagement::Messages::MassMessageChartResponse,
              options: options
            )
          end
