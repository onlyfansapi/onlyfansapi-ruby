    ...
    class Engagement
      class Messages
        class DirectMessages
          ...
          # {Onlyfansapi::Models::Engagement::Messages::DirectMessageListParams} for more
          # details.
          #
          ...
          #
          # @return [Onlyfansapi::Models::Engagement::Messages::DirectMessageListResponse]
          #
          # @see Onlyfansapi::Models::Engagement::Messages::DirectMessageListParams
          def list(account, params = {})
            parsed, options = Onlyfansapi::Engagement::Messages::DirectMessageListParams.dump_request(params)
            ...
            @client.request(
              ...
              model: Onlyfansapi::Models::Engagement::Messages::DirectMessageListResponse,
              options: options
            )
          end
          ...
          # @param request_options [Onlyfansapi::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [Onlyfansapi::Models::Engagement::Messages::DirectMessageChartResponse]
          #
          # @see Onlyfansapi::Models::Engagement::Messages::DirectMessageChartParams
          def chart(account, params = {})
            parsed, options = Onlyfansapi::Engagement::Messages::DirectMessageChartParams.dump_request(params)
            query = Onlyfansapi::Internal::Util.encode_query_params(parsed)
            @client.request(
              method: :get,
              ...
              model: Onlyfansapi::Models::Engagement::Messages::DirectMessageChartResponse,
              options: options
            )
          end
