      ...
      class Vault
        class Lists
          class Media
            ...
            #
            # @return [Onlyfansapi::Models::Media::Vault::Lists::MediaAddResponse]
            #
            # @see Onlyfansapi::Models::Media::Vault::Lists::MediaAddParams
            def add(list_id, params)
              parsed, options = Onlyfansapi::Media::Vault::Lists::MediaAddParams.dump_request(params)
              account =
              ...
              @client.request(
                ...
                body: parsed,
                model: Onlyfansapi::Models::Media::Vault::Lists::MediaAddResponse,
                options: options
              )
            end
            ...
            # @param request_options [Onlyfansapi::RequestOptions, Hash{Symbol=>Object}, nil]
            #
            # @return [Onlyfansapi::Models::Media::Vault::Lists::MediaRemoveResponse]
            #
            # @see Onlyfansapi::Models::Media::Vault::Lists::MediaRemoveParams
            def remove(list_id, params)
              parsed, options = Onlyfansapi::Media::Vault::Lists::MediaRemoveParams.dump_request(params)
              account =
                parsed.delete(:account) do
                  raise ArgumentError.new("missing required path argument #{_1}")
                end
              @client.request(
                ...
                path: ["api/%1$s/media/vault/lists/%2$s/media", account, list_id],
                body: parsed,
                model: Onlyfansapi::Models::Media::Vault::Lists::MediaRemoveResponse,
                options: options
              )
            end
