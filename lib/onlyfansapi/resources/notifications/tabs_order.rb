  ...
  module Resources
    class Notifications
      ...
      class TabsOrder
        ...
        #
        # @return [Onlyfansapi::Models::Notifications::TabsOrderUpdateResponse]
        #
        # @see Onlyfansapi::Models::Notifications::TabsOrderUpdateParams
        def update(account, params)
          parsed, options = Onlyfansapi::Notifications::TabsOrderUpdateParams.dump_request(params)
          @client.request(
            method: :put,
            path: ["api/%1$s/notifications/tabs-order", account],
            body: parsed,
            model: Onlyfansapi::Models::Notifications::TabsOrderUpdateResponse,
            options: options
          )
        end
        ...
        # @param request_options [Onlyfansapi::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Onlyfansapi::Models::Notifications::TabsOrderGetResponse]
        #
        # @see Onlyfansapi::Models::Notifications::TabsOrderGetParams
        def get(account, params = {})
          @client.request(
            method: :get,
            path: ["api/%1$s/notifications/tabs-order", account],
            model: Onlyfansapi::Models::Notifications::TabsOrderGetResponse,
