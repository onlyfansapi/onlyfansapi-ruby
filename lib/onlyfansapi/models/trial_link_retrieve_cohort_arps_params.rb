...
module Onlyfansapi
  module Models
    # @see Onlyfansapi::Resources::TrialLinks#retrieve_cohort_arps
    class TrialLinkRetrieveCohortArpsParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Onlyfansapi::Models::TrialLinkRetrieveCohortArpsParams::RevenueBasis, nil]
      optional :revenue_basis, enum: -> { Onlyfansapi::TrialLinkRetrieveCohortArpsParams::RevenueBasis }
      ...
      #
      #   @param revenue_basis [Symbol, Onlyfansapi::Models::TrialLinkRetrieveCohortArpsParams::RevenueBasis] Revenue basis. Defaults to `net`.
      #
