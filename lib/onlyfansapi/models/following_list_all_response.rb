...
module Onlyfansapi
  module Models
    ...
    class FollowingListAllResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::FollowingListAllResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::FollowingListAllResponse::Meta }

      # @!attribute _pagination
      #
      #   @return [Onlyfansapi::Models::FollowingListAllResponse::Pagination, nil]
      optional :_pagination, -> { Onlyfansapi::Models::FollowingListAllResponse::Pagination }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::FollowingListAllResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::FollowingListAllResponse::Data }

      # @!method initialize(_meta: nil, _pagination: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::FollowingListAllResponse::Meta]
      #   @param _pagination [Onlyfansapi::Models::FollowingListAllResponse::Pagination]
      #   @param data [Onlyfansapi::Models::FollowingListAllResponse::Data]

      # @see Onlyfansapi::Models::FollowingListAllResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::FollowingListAllResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::FollowingListAllResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::FollowingListAllResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::FollowingListAllResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfansapi::Models::FollowingListAllResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfansapi::Models::FollowingListAllResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfansapi::Models::FollowingListAllResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::FollowingListAllResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfansapi::Models::FollowingListAllResponse::Meta::RateLimits]

        # @see Onlyfansapi::Models::FollowingListAllResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::FollowingListAllResponse::Meta#_credits
        ...
        # @see Onlyfansapi::Models::FollowingListAllResponse::Meta#_rate_limits
      ...
      # @see Onlyfansapi::Models::FollowingListAllResponse#_pagination
      ...
      # @see Onlyfansapi::Models::FollowingListAllResponse#data
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfansapi::Models::FollowingListAllResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FollowingListAllResponse::Data::List] }

        # @!method initialize(has_more: nil, list: nil)
        #   @param has_more [Boolean]
        #   @param list [Array<Onlyfansapi::Models::FollowingListAllResponse::Data::List>]
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfansapi::Models::FollowingListAllResponse::Data::List::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfansapi::Models::FollowingListAllResponse::Data::List::AvatarThumbs },
          ...
          #
          #   @return [Onlyfansapi::Models::FollowingListAllResponse::Data::List::HeaderSize, nil]
          optional :header_size,
                   -> { Onlyfansapi::Models::FollowingListAllResponse::Data::List::HeaderSize },
                   api_name: :headerSize

          # @!attribute header_thumbs
          #
          #   @return [Onlyfansapi::Models::FollowingListAllResponse::Data::List::HeaderThumbs, nil]
          optional :header_thumbs,
                   -> { Onlyfansapi::Models::FollowingListAllResponse::Data::List::HeaderThumbs },
          ...
          #
          #   @return [Array<Onlyfansapi::Models::FollowingListAllResponse::Data::List::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FollowingListAllResponse::Data::List::ListsState] },
          ...
          #
          #   @return [Onlyfansapi::Models::FollowingListAllResponse::Data::List::SubscribedByData, nil]
          optional :subscribed_by_data,
                   -> { Onlyfansapi::Models::FollowingListAllResponse::Data::List::SubscribedByData },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfansapi::Models::FollowingListAllResponse::Data::List::AvatarThumbs]
          ...
          #   @param header [String]
          #   @param header_size [Onlyfansapi::Models::FollowingListAllResponse::Data::List::HeaderSize]
          #   @param header_thumbs [Onlyfansapi::Models::FollowingListAllResponse::Data::List::HeaderThumbs]
          ...
          #   @param lists_states [Array<Onlyfansapi::Models::FollowingListAllResponse::Data::List::ListsState>]
          #   @param name [String]
          #   @param subscribed_by [Boolean]
          #   @param subscribed_by_autoprolong [Boolean]
          #   @param subscribed_by_data [Onlyfansapi::Models::FollowingListAllResponse::Data::List::SubscribedByData]
          ...
          # @see Onlyfansapi::Models::FollowingListAllResponse::Data::List#avatar_thumbs
          ...
          # @see Onlyfansapi::Models::FollowingListAllResponse::Data::List#header_size
          ...
          # @see Onlyfansapi::Models::FollowingListAllResponse::Data::List#header_thumbs
          ...
          # @see Onlyfansapi::Models::FollowingListAllResponse::Data::List#subscribed_by_data
          class SubscribedByData < Onlyfansapi::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Onlyfansapi::Models::FollowingListAllResponse::Data::List::SubscribedByData::Subscribe>, nil]
            optional :subscribes,
                     -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FollowingListAllResponse::Data::List::SubscribedByData::Subscribe] }
            ...
            #   @param subscribe_price [Integer]
            #   @param subscribes [Array<Onlyfansapi::Models::FollowingListAllResponse::Data::List::SubscribedByData::Subscribe>]
