...
module Onlyfansapi
  module Models
    ...
    class FollowingListActiveResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::FollowingListActiveResponse::Meta }

      # @!attribute _pagination
      #
      #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Pagination, nil]
      optional :_pagination, -> { Onlyfansapi::Models::FollowingListActiveResponse::Pagination }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::FollowingListActiveResponse::Data }

      # @!method initialize(_meta: nil, _pagination: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::FollowingListActiveResponse::Meta]
      #   @param _pagination [Onlyfansapi::Models::FollowingListActiveResponse::Pagination]
      #   @param data [Onlyfansapi::Models::FollowingListActiveResponse::Data]

      # @see Onlyfansapi::Models::FollowingListActiveResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::FollowingListActiveResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::FollowingListActiveResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfansapi::Models::FollowingListActiveResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfansapi::Models::FollowingListActiveResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::FollowingListActiveResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfansapi::Models::FollowingListActiveResponse::Meta::RateLimits]

        # @see Onlyfansapi::Models::FollowingListActiveResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::FollowingListActiveResponse::Meta#_credits
        ...
        # @see Onlyfansapi::Models::FollowingListActiveResponse::Meta#_rate_limits
      ...
      # @see Onlyfansapi::Models::FollowingListActiveResponse#_pagination
      ...
      # @see Onlyfansapi::Models::FollowingListActiveResponse#data
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfansapi::Models::FollowingListActiveResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FollowingListActiveResponse::Data::List] }

        # @!method initialize(has_more: nil, list: nil)
        #   @param has_more [Boolean]
        #   @param list [Array<Onlyfansapi::Models::FollowingListActiveResponse::Data::List>]
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Data::List::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfansapi::Models::FollowingListActiveResponse::Data::List::AvatarThumbs },
          ...
          #
          #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Data::List::HeaderSize, nil]
          optional :header_size,
                   -> { Onlyfansapi::Models::FollowingListActiveResponse::Data::List::HeaderSize },
                   api_name: :headerSize

          # @!attribute header_thumbs
          #
          #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Data::List::HeaderThumbs, nil]
          optional :header_thumbs,
                   -> { Onlyfansapi::Models::FollowingListActiveResponse::Data::List::HeaderThumbs },
          ...
          #
          #   @return [Array<Onlyfansapi::Models::FollowingListActiveResponse::Data::List::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FollowingListActiveResponse::Data::List::ListsState] },
          ...
          #
          #   @return [Onlyfansapi::Models::FollowingListActiveResponse::Data::List::SubscribedByData, nil]
          optional :subscribed_by_data,
                   -> { Onlyfansapi::Models::FollowingListActiveResponse::Data::List::SubscribedByData },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfansapi::Models::FollowingListActiveResponse::Data::List::AvatarThumbs]
          ...
          #   @param header [String]
          #   @param header_size [Onlyfansapi::Models::FollowingListActiveResponse::Data::List::HeaderSize]
          #   @param header_thumbs [Onlyfansapi::Models::FollowingListActiveResponse::Data::List::HeaderThumbs]
          ...
          #   @param lists_states [Array<Onlyfansapi::Models::FollowingListActiveResponse::Data::List::ListsState>]
          #   @param name [String]
          #   @param subscribed_by [Boolean]
          #   @param subscribed_by_autoprolong [Boolean]
          #   @param subscribed_by_data [Onlyfansapi::Models::FollowingListActiveResponse::Data::List::SubscribedByData]
          ...
          # @see Onlyfansapi::Models::FollowingListActiveResponse::Data::List#avatar_thumbs
          ...
          # @see Onlyfansapi::Models::FollowingListActiveResponse::Data::List#header_size
          ...
          # @see Onlyfansapi::Models::FollowingListActiveResponse::Data::List#header_thumbs
          ...
          # @see Onlyfansapi::Models::FollowingListActiveResponse::Data::List#subscribed_by_data
          class SubscribedByData < Onlyfansapi::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Onlyfansapi::Models::FollowingListActiveResponse::Data::List::SubscribedByData::Subscribe>, nil]
            optional :subscribes,
                     -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FollowingListActiveResponse::Data::List::SubscribedByData::Subscribe] }
            ...
            #   @param subscribe_price [Integer]
            #   @param subscribes [Array<Onlyfansapi::Models::FollowingListActiveResponse::Data::List::SubscribedByData::Subscribe>]
