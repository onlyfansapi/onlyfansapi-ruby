...
module Onlyfansapi
  module Models
    ...
    class UserListUpdateResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::UserListUpdateResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::UserListUpdateResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::UserListUpdateResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::UserListUpdateResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::UserListUpdateResponse::Meta]
      #   @param data [Onlyfansapi::Models::UserListUpdateResponse::Data]

      # @see Onlyfansapi::Models::UserListUpdateResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::UserListUpdateResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::UserListUpdateResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::UserListUpdateResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::UserListUpdateResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfansapi::Models::UserListUpdateResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfansapi::Models::UserListUpdateResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfansapi::Models::UserListUpdateResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::UserListUpdateResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfansapi::Models::UserListUpdateResponse::Meta::RateLimits]

        # @see Onlyfansapi::Models::UserListUpdateResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::UserListUpdateResponse::Meta#_credits
        ...
        # @see Onlyfansapi::Models::UserListUpdateResponse::Meta#_rate_limits
      ...
      # @see Onlyfansapi::Models::UserListUpdateResponse#data
