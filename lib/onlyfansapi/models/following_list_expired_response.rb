...
module Onlyfansapi
  module Models
    # @see Onlyfansapi::Resources::Following#list_expired
    class FollowingListExpiredResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::FollowingListExpiredResponse::Meta }

      # @!attribute _pagination
      #
      #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Pagination, nil]
      optional :_pagination, -> { Onlyfansapi::Models::FollowingListExpiredResponse::Pagination }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::FollowingListExpiredResponse::Data }

      # @!method initialize(_meta: nil, _pagination: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::FollowingListExpiredResponse::Meta]
      #   @param _pagination [Onlyfansapi::Models::FollowingListExpiredResponse::Pagination]
      #   @param data [Onlyfansapi::Models::FollowingListExpiredResponse::Data]

      # @see Onlyfansapi::Models::FollowingListExpiredResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::FollowingListExpiredResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::FollowingListExpiredResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfansapi::Models::FollowingListExpiredResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfansapi::Models::FollowingListExpiredResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::FollowingListExpiredResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfansapi::Models::FollowingListExpiredResponse::Meta::RateLimits]

        # @see Onlyfansapi::Models::FollowingListExpiredResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::FollowingListExpiredResponse::Meta#_credits
        ...
        # @see Onlyfansapi::Models::FollowingListExpiredResponse::Meta#_rate_limits
      ...
      # @see Onlyfansapi::Models::FollowingListExpiredResponse#_pagination
      ...
      # @see Onlyfansapi::Models::FollowingListExpiredResponse#data
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfansapi::Models::FollowingListExpiredResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FollowingListExpiredResponse::Data::List] }

        # @!method initialize(has_more: nil, list: nil)
        #   @param has_more [Boolean]
        #   @param list [Array<Onlyfansapi::Models::FollowingListExpiredResponse::Data::List>]
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::AvatarThumbs },
          ...
          #
          #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::HeaderSize, nil]
          optional :header_size,
                   -> { Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::HeaderSize },
                   api_name: :headerSize

          # @!attribute header_thumbs
          #
          #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::HeaderThumbs, nil]
          optional :header_thumbs,
                   -> { Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::HeaderThumbs },
          ...
          #
          #   @return [Array<Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::ListsState] },
          ...
          #
          #   @return [Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::SubscribedByData, nil]
          optional :subscribed_by_data,
                   -> { Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::SubscribedByData },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::AvatarThumbs]
          ...
          #   @param header [String]
          #   @param header_size [Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::HeaderSize]
          #   @param header_thumbs [Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::HeaderThumbs]
          ...
          #   @param lists_states [Array<Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::ListsState>]
          #   @param name [String]
          #   @param subscribed_by [Boolean]
          #   @param subscribed_by_autoprolong [Boolean]
          #   @param subscribed_by_data [Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::SubscribedByData]
          ...
          # @see Onlyfansapi::Models::FollowingListExpiredResponse::Data::List#avatar_thumbs
          ...
          # @see Onlyfansapi::Models::FollowingListExpiredResponse::Data::List#header_size
          ...
          # @see Onlyfansapi::Models::FollowingListExpiredResponse::Data::List#header_thumbs
          ...
          # @see Onlyfansapi::Models::FollowingListExpiredResponse::Data::List#subscribed_by_data
          class SubscribedByData < Onlyfansapi::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::SubscribedByData::Subscribe>, nil]
            optional :subscribes,
                     -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::SubscribedByData::Subscribe] }
            ...
            #   @param subscribe_price [Integer]
            #   @param subscribes [Array<Onlyfansapi::Models::FollowingListExpiredResponse::Data::List::SubscribedByData::Subscribe>]
