...
module Onlyfansapi
  module Models
    ...
    class AuthenticateStartParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      #   fields required).
      #
      #   @return [Symbol, Onlyfansapi::Models::AuthenticateStartParams::AuthType, nil]
      optional :auth_type, enum: -> { Onlyfansapi::AuthenticateStartParams::AuthType }
      ...
      #
      #   @return [Onlyfansapi::Models::AuthenticateStartParams::CustomProxy, nil]
      optional :custom_proxy, -> { Onlyfansapi::AuthenticateStartParams::CustomProxy }, api_name: :customProxy
      ...
      #
      #   @return [Boolean, nil]
      optional :force_connect, Onlyfansapi::Internal::Type::Boolean
      ...
      #
      #   @return [Symbol, Onlyfansapi::Models::AuthenticateStartParams::ProxyCountry, nil]
