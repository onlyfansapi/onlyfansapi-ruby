  ...
  module Models
    module SavedForLater
      ...
      class MessageListResponse < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _meta
        #
        #   @return [Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta, nil]
        optional :_meta, -> { Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta }

        # @!attribute data
        #
        #   @return [Onlyfansapi::Models::SavedForLater::MessageListResponse::Data, nil]
        optional :data, -> { Onlyfansapi::Models::SavedForLater::MessageListResponse::Data }

        # @!method initialize(_meta: nil, data: nil)
        #   @param _meta [Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta]
        #   @param data [Onlyfansapi::Models::SavedForLater::MessageListResponse::Data]

        # @see Onlyfansapi::Models::SavedForLater::MessageListResponse#_meta
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          # @!attribute _cache
          #
          #   @return [Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Cache, nil]
          optional :_cache, -> { Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Cache }

          # @!attribute _credits
          #
          #   @return [Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Credits, nil]
          optional :_credits, -> { Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Credits }

          # @!attribute _rate_limits
          #
          #   @return [Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::RateLimits, nil]
          optional :_rate_limits, -> { Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::RateLimits }

          # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
          #   @param _cache [Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Cache]
          #   @param _credits [Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::Credits]
          #   @param _rate_limits [Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta::RateLimits]

          # @see Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta#_cache
          ...
          # @see Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta#_credits
          ...
          # @see Onlyfansapi::Models::SavedForLater::MessageListResponse::Meta#_rate_limits
        ...
        # @see Onlyfansapi::Models::SavedForLater::MessageListResponse#data
        class Data < Onlyfansapi::Internal::Type::BaseModel
          ...
          # @!attribute list
          #
          #   @return [Array<Onlyfansapi::Models::SavedForLater::MessageListResponse::Data::List>, nil]
          optional :list,
                   -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::SavedForLater::MessageListResponse::Data::List] }
          ...
          #   @param list [Array<Onlyfansapi::Models::SavedForLater::MessageListResponse::Data::List>]
          ...
          class List < Onlyfansapi::Internal::Type::BaseModel
            ...
            # @!attribute entity
            #
            #   @return [Onlyfansapi::Models::SavedForLater::MessageListResponse::Data::List::Entity, nil]
            optional :entity, -> { Onlyfansapi::Models::SavedForLater::MessageListResponse::Data::List::Entity }
