  ...
  module Models
    module Chats
      ...
      class MessageListResponse < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _meta
        #
        #   @return [Onlyfansapi::Models::Chats::MessageListResponse::Meta, nil]
        optional :_meta, -> { Onlyfansapi::Models::Chats::MessageListResponse::Meta }

        # @!attribute _pagination
        #
        #   @return [Onlyfansapi::Models::Chats::MessageListResponse::Pagination, nil]
        optional :_pagination, -> { Onlyfansapi::Models::Chats::MessageListResponse::Pagination }

        # @!attribute data
        #
        #   @return [Array<Onlyfansapi::Models::Chats::MessageListResponse::Data>, nil]
        optional :data,
                 -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::Chats::MessageListResponse::Data] }

        # @!method initialize(_meta: nil, _pagination: nil, data: nil)
        #   @param _meta [Onlyfansapi::Models::Chats::MessageListResponse::Meta]
        #   @param _pagination [Onlyfansapi::Models::Chats::MessageListResponse::Pagination]
        #   @param data [Array<Onlyfansapi::Models::Chats::MessageListResponse::Data>]

        # @see Onlyfansapi::Models::Chats::MessageListResponse#_meta
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          # @!attribute _cache
          #
          #   @return [Onlyfansapi::Models::Chats::MessageListResponse::Meta::Cache, nil]
          optional :_cache, -> { Onlyfansapi::Models::Chats::MessageListResponse::Meta::Cache }

          # @!attribute _credits
          #
          #   @return [Onlyfansapi::Models::Chats::MessageListResponse::Meta::Credits, nil]
          optional :_credits, -> { Onlyfansapi::Models::Chats::MessageListResponse::Meta::Credits }

          # @!attribute _rate_limits
          #
          #   @return [Onlyfansapi::Models::Chats::MessageListResponse::Meta::RateLimits, nil]
          optional :_rate_limits, -> { Onlyfansapi::Models::Chats::MessageListResponse::Meta::RateLimits }

          # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
          #   @param _cache [Onlyfansapi::Models::Chats::MessageListResponse::Meta::Cache]
          #   @param _credits [Onlyfansapi::Models::Chats::MessageListResponse::Meta::Credits]
          #   @param _rate_limits [Onlyfansapi::Models::Chats::MessageListResponse::Meta::RateLimits]

          # @see Onlyfansapi::Models::Chats::MessageListResponse::Meta#_cache
          ...
          # @see Onlyfansapi::Models::Chats::MessageListResponse::Meta#_credits
          ...
          # @see Onlyfansapi::Models::Chats::MessageListResponse::Meta#_rate_limits
        ...
        # @see Onlyfansapi::Models::Chats::MessageListResponse#_pagination
        ...
        class Data < Onlyfansapi::Internal::Type::BaseModel
          ...
          # @!attribute from_user
          #
          #   @return [Onlyfansapi::Models::Chats::MessageListResponse::Data::FromUser, nil]
          optional :from_user,
          ...
          # @see Onlyfansapi::Models::Chats::MessageListResponse::Data#from_user
