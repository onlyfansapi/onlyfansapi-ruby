...
module Onlyfansapi
  module Models
    module Chats
      ...
      class MessageRetrieveResponse < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _meta
        #
        #   @return [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta, nil]
        optional :_meta, -> { Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta }

        # @!attribute data
        #
        #   @return [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data, nil]
        optional :data, -> { Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data }

        # @!method initialize(_meta: nil, data: nil)
        #   @param _meta [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta]
        #   @param data [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data]

        # @see Onlyfansapi::Models::Chats::MessageRetrieveResponse#_meta
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          # @!attribute _cache
          #
          #   @return [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Cache, nil]
          optional :_cache, -> { Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Cache }

          # @!attribute _credits
          #
          #   @return [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Credits, nil]
          optional :_credits, -> { Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Credits }

          # @!attribute _rate_limits
          #
          #   @return [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::RateLimits, nil]
          optional :_rate_limits, -> { Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::RateLimits }

          # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
          #   @param _cache [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Cache]
          #   @param _credits [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::Credits]
          #   @param _rate_limits [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta::RateLimits]

          # @see Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta#_cache
          ...
          # @see Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta#_credits
          ...
          # @see Onlyfansapi::Models::Chats::MessageRetrieveResponse::Meta#_rate_limits
        ...
        # @see Onlyfansapi::Models::Chats::MessageRetrieveResponse#data
        class Data < Onlyfansapi::Internal::Type::BaseModel
          ...
          # @!attribute from_user
          #
          #   @return [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data::FromUser, nil]
          optional :from_user,
                   -> { Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data::FromUser },
                   api_name: :fromUser
          ...
          #
          #   @return [Boolean, nil]
          optional :is_sent_by_me, Onlyfansapi::Internal::Type::Boolean, api_name: :isSentByMe
          ...
          #   @param from_user [Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data::FromUser]
          ...
          # @see Onlyfansapi::Models::Chats::MessageRetrieveResponse::Data#from_user
