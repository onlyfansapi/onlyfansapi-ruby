  ...
  module Models
    module Media
      ...
      class VaultListResponse < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _meta
        #
        #   @return [Onlyfansapi::Models::Media::VaultListResponse::Meta, nil]
        optional :_meta, -> { Onlyfansapi::Models::Media::VaultListResponse::Meta }

        # @!attribute data
        #
        #   @return [Onlyfansapi::Models::Media::VaultListResponse::Data, nil]
        optional :data, -> { Onlyfansapi::Models::Media::VaultListResponse::Data }

        # @!method initialize(_meta: nil, data: nil)
        #   @param _meta [Onlyfansapi::Models::Media::VaultListResponse::Meta]
        #   @param data [Onlyfansapi::Models::Media::VaultListResponse::Data]

        # @see Onlyfansapi::Models::Media::VaultListResponse#_meta
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          # @!attribute _cache
          #
          #   @return [Onlyfansapi::Models::Media::VaultListResponse::Meta::Cache, nil]
          optional :_cache, -> { Onlyfansapi::Models::Media::VaultListResponse::Meta::Cache }

          # @!attribute _credits
          #
          #   @return [Onlyfansapi::Models::Media::VaultListResponse::Meta::Credits, nil]
          optional :_credits, -> { Onlyfansapi::Models::Media::VaultListResponse::Meta::Credits }

          # @!attribute _rate_limits
          #
          #   @return [Onlyfansapi::Models::Media::VaultListResponse::Meta::RateLimits, nil]
          optional :_rate_limits, -> { Onlyfansapi::Models::Media::VaultListResponse::Meta::RateLimits }

          # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
          #   @param _cache [Onlyfansapi::Models::Media::VaultListResponse::Meta::Cache]
          #   @param _credits [Onlyfansapi::Models::Media::VaultListResponse::Meta::Credits]
          #   @param _rate_limits [Onlyfansapi::Models::Media::VaultListResponse::Meta::RateLimits]

          # @see Onlyfansapi::Models::Media::VaultListResponse::Meta#_cache
          ...
          # @see Onlyfansapi::Models::Media::VaultListResponse::Meta#_credits
          ...
          # @see Onlyfansapi::Models::Media::VaultListResponse::Meta#_rate_limits
        ...
        # @see Onlyfansapi::Models::Media::VaultListResponse#data
        class Data < Onlyfansapi::Internal::Type::BaseModel
          ...
          # @!attribute list
          #
          #   @return [Array<Onlyfansapi::Models::Media::VaultListResponse::Data::List>, nil]
          optional :list,
                   -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::Media::VaultListResponse::Data::List] }

          # @!method initialize(has_more: nil, list: nil)
          #   @param has_more [Boolean]
          #   @param list [Array<Onlyfansapi::Models::Media::VaultListResponse::Data::List>]
          ...
          class List < Onlyfansapi::Internal::Type::BaseModel
            ...
            # @!attribute counters
            #
            #   @return [Onlyfansapi::Models::Media::VaultListResponse::Data::List::Counters, nil]
            optional :counters, -> { Onlyfansapi::Models::Media::VaultListResponse::Data::List::Counters }
            ...
            # @!attribute files
            #
            #   @return [Onlyfansapi::Models::Media::VaultListResponse::Data::List::Files, nil]
            optional :files, -> { Onlyfansapi::Models::Media::VaultListResponse::Data::List::Files }
            ...
            #
            #   @return [Array<Onlyfansapi::Models::Media::VaultListResponse::Data::List::ListState>, nil]
            optional :list_states,
                     -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::Media::VaultListResponse::Data::List::ListState] },
                     api_name: :listStates
            ...
            #
            #   @return [Onlyfansapi::Models::Media::VaultListResponse::Data::List::VideoSources, nil]
            ...
            #   @param counters [Onlyfansapi::Models::Media::VaultListResponse::Data::List::Counters]
            #   @param created_at [String]
            #   @param duration [Integer]
            #   @param files [Onlyfansapi::Models::Media::VaultListResponse::Data::List::Files]
            #   @param has_custom_preview [Boolean]
            #   @param has_error [Boolean]
            #   @param has_posts [Boolean]
            #   @param is_ready [Boolean]
            #   @param list_states [Array<Onlyfansapi::Models::Media::VaultListResponse::Data::List::ListState>]
            #   @param release_forms [Array<Object>]
            #   @param type [String]
            #   @param video_sources [Onlyfansapi::Models::Media::VaultListResponse::Data::List::VideoSources]

            # @see Onlyfansapi::Models::Media::VaultListResponse::Data::List#counters
            ...
            # @see Onlyfansapi::Models::Media::VaultListResponse::Data::List#files
            class Files < Onlyfansapi::Internal::Type::BaseModel
              # @!attribute full
              #
              #   @return [Onlyfansapi::Models::Media::VaultListResponse::Data::List::Files::Full, nil]
              optional :full, -> { Onlyfansapi::Models::Media::VaultListResponse::Data::List::Files::Full }
            ...
            # @see Onlyfansapi::Models::Media::VaultListResponse::Data::List#video_sources
