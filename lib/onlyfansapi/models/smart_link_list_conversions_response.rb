...
module Onlyfansapi
  module Models
    ...
    class SmartLinkListConversionsResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::SmartLinkListConversionsResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta]
      #   @param data [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data]

      # @see Onlyfansapi::Models::SmartLinkListConversionsResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta::Credits }

        # @!method initialize(_cache: nil, _credits: nil)
        #   @param _cache [Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta::Credits]

        # @see Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::SmartLinkListConversionsResponse::Meta#_credits
      ...
      # @see Onlyfansapi::Models::SmartLinkListConversionsResponse#data
      class Data < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute chart
        #
        #   @return [Array<Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Chart>, nil]
        optional :chart,
                 -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Chart] }

        # @!attribute filters
        #
        #   @return [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Filters, nil]
        optional :filters, -> { Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Filters }

        # @!attribute rows
        #
        #   @return [Array<Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row>, nil]
        optional :rows,
                 -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row] }

        # @!attribute summary
        #
        #   @return [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Summary, nil]
        optional :summary, -> { Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Summary }

        # @!method initialize(chart: nil, filters: nil, rows: nil, summary: nil)
        #   @param chart [Array<Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Chart>]
        #   @param filters [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Filters]
        #   @param rows [Array<Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row>]
        #   @param summary [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Summary]
        ...
        # @see Onlyfansapi::Models::SmartLinkListConversionsResponse::Data#filters
        ...
        class Row < Onlyfansapi::Internal::Type::BaseModel
          ...
          # @!attribute click
          #
          #   @return [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row::Click, nil]
          optional :click, -> { Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row::Click }
          ...
          # @!attribute fan
          #
          #   @return [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row::Fan, nil]
          optional :fan, -> { Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row::Fan }
          ...
          #   @param click [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row::Click]
          #   @param conversion_at [String]
          #   @param conversion_type [String]
          #   @param fan [Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row::Fan]
          #   @param fan_onlyfans_id [String]

          # @see Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row#click
          class Click < Onlyfansapi::Internal::Type::BaseModel
            # @!attribute id
            #
            #   @return [String, nil]
            optional :id, String
          ...
          # @see Onlyfansapi::Models::SmartLinkListConversionsResponse::Data::Row#fan
        ...
        # @see Onlyfansapi::Models::SmartLinkListConversionsResponse::Data#summary
