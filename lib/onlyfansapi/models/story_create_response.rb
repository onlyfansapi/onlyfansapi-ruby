...
module Onlyfansapi
  module Models
    ...
    class StoryCreateResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::StoryCreateResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::StoryCreateResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::StoryCreateResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::StoryCreateResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::StoryCreateResponse::Meta]
      #   @param data [Onlyfansapi::Models::StoryCreateResponse::Data]

      # @see Onlyfansapi::Models::StoryCreateResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::StoryCreateResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::StoryCreateResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::StoryCreateResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::StoryCreateResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfansapi::Models::StoryCreateResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfansapi::Models::StoryCreateResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfansapi::Models::StoryCreateResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::StoryCreateResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfansapi::Models::StoryCreateResponse::Meta::RateLimits]

        # @see Onlyfansapi::Models::StoryCreateResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::StoryCreateResponse::Meta#_credits
        ...
        # @see Onlyfansapi::Models::StoryCreateResponse::Meta#_rate_limits
      ...
      # @see Onlyfansapi::Models::StoryCreateResponse#data
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        # @!attribute media
        #
        #   @return [Array<Onlyfansapi::Models::StoryCreateResponse::Data::Media>, nil]
        optional :media,
                 -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::StoryCreateResponse::Data::Media] }
        ...
        #   @param media [Array<Onlyfansapi::Models::StoryCreateResponse::Data::Media>]
        ...
        class Media < Onlyfansapi::Internal::Type::BaseModel
          ...
          # @!attribute files
          #
          #   @return [Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files, nil]
          optional :files, -> { Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files }
          ...
          #   @param files [Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files]
          #   @param has_custom_preview [Boolean]
          #   @param has_error [Boolean]
          #   @param is_ready [Boolean]
          #   @param type [String]

          # @see Onlyfansapi::Models::StoryCreateResponse::Data::Media#files
          class Files < Onlyfansapi::Internal::Type::BaseModel
            # @!attribute full
            #
            #   @return [Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files::Full, nil]
            optional :full, -> { Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files::Full }
            ...
            #   @param full [Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files::Full]
            #   @param preview [String, nil]
            #   @param square_preview [String, nil]
            #   @param thumb [String, nil]

            # @see Onlyfansapi::Models::StoryCreateResponse::Data::Media::Files#full
