...
module Onlyfansapi
  module Models
    ...
    class DataExportCreateParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Onlyfansapi::Models::DataExportCreateParams::FileType]
      required :file_type, enum: -> { Onlyfansapi::DataExportCreateParams::FileType }
      ...
      #
      #   @return [Symbol, Onlyfansapi::Models::DataExportCreateParams::Type]
      required :type, enum: -> { Onlyfansapi::DataExportCreateParams::Type }
      ...
      #
      #   @return [Boolean, nil]
      optional :auto_start, Onlyfansapi::Internal::Type::Boolean
      ...
      optional :options, Onlyfansapi::Internal::Type::HashOf[Onlyfansapi::Internal::Type::Unknown]
