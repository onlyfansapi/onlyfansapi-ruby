...
module Onlyfansapi
  module Models
    # @see Onlyfansapi::Resources::Posts#retrieve
    class PostRetrieveResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::PostRetrieveResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::PostRetrieveResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::PostRetrieveResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::PostRetrieveResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::PostRetrieveResponse::Meta]
      #   @param data [Onlyfansapi::Models::PostRetrieveResponse::Data]

      # @see Onlyfansapi::Models::PostRetrieveResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::PostRetrieveResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::PostRetrieveResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::PostRetrieveResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::PostRetrieveResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfansapi::Models::PostRetrieveResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfansapi::Models::PostRetrieveResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfansapi::Models::PostRetrieveResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::PostRetrieveResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfansapi::Models::PostRetrieveResponse::Meta::RateLimits]

        # @see Onlyfansapi::Models::PostRetrieveResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::PostRetrieveResponse::Meta#_credits
        ...
        # @see Onlyfansapi::Models::PostRetrieveResponse::Meta#_rate_limits
      ...
      # @see Onlyfansapi::Models::PostRetrieveResponse#data
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        # @!attribute author
        #
        #   @return [Onlyfansapi::Models::PostRetrieveResponse::Data::Author, nil]
        optional :author, -> { Onlyfansapi::Models::PostRetrieveResponse::Data::Author }
        ...
        #
        #   @return [Boolean, nil]
        optional :can_edit_text, Onlyfansapi::Internal::Type::Boolean, api_name: :canEditText
        ...
        #   @param id [Integer]
        #   @param author [Onlyfansapi::Models::PostRetrieveResponse::Data::Author]
        ...
        # @see Onlyfansapi::Models::PostRetrieveResponse::Data#author
        class Author < Onlyfansapi::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfansapi::Models::PostRetrieveResponse::Data::Author::AvatarThumbs, nil]
          ...
          #
          #   @return [Onlyfansapi::Models::PostRetrieveResponse::Data::Author::HeaderSize, nil]
          ...
          #
          #   @return [Onlyfansapi::Models::PostRetrieveResponse::Data::Author::HeaderThumbs, nil]
          ...
          #   @param header [String]
          #   @param header_size [Onlyfansapi::Models::PostRetrieveResponse::Data::Author::HeaderSize]
          #   @param header_thumbs [Onlyfansapi::Models::PostRetrieveResponse::Data::Author::HeaderThumbs]
          ...
          # @see Onlyfansapi::Models::PostRetrieveResponse::Data::Author#avatar_thumbs
          ...
          # @see Onlyfansapi::Models::PostRetrieveResponse::Data::Author#header_size
          ...
          # @see Onlyfansapi::Models::PostRetrieveResponse::Data::Author#header_thumbs
