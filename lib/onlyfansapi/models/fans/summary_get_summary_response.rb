...
module Onlyfansapi
  module Models
    module Fans
      ...
      class SummaryGetSummaryResponse < Onlyfansapi::Internal::Type::BaseModel
        ...
        #
        #   @return [Onlyfansapi::Models::Fans::SummaryGetSummaryResponse::SummaryData, nil]
        optional :summary_data, -> { Onlyfansapi::Models::Fans::SummaryGetSummaryResponse::SummaryData }
        ...
        #   @param status [String]
        #   @param summary_data [Onlyfansapi::Models::Fans::SummaryGetSummaryResponse::SummaryData]

        # @see Onlyfansapi::Models::Fans::SummaryGetSummaryResponse#summary_data
        class SummaryData < Onlyfansapi::Internal::Type::BaseModel
