...
module Onlyfansapi
  module Models
    ...
    class UserListCreateResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::UserListCreateResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::UserListCreateResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::UserListCreateResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::UserListCreateResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::UserListCreateResponse::Meta]
      #   @param data [Onlyfansapi::Models::UserListCreateResponse::Data]

      # @see Onlyfansapi::Models::UserListCreateResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::UserListCreateResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::UserListCreateResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::UserListCreateResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::UserListCreateResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfansapi::Models::UserListCreateResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfansapi::Models::UserListCreateResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfansapi::Models::UserListCreateResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::UserListCreateResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfansapi::Models::UserListCreateResponse::Meta::RateLimits]

        # @see Onlyfansapi::Models::UserListCreateResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::UserListCreateResponse::Meta#_credits
        ...
        # @see Onlyfansapi::Models::UserListCreateResponse::Meta#_rate_limits
      ...
      # @see Onlyfansapi::Models::UserListCreateResponse#data
