...
module Onlyfansapi
  module Models
    ...
    class DataExportListParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      #   Filter by status
      #
      #   @return [Symbol, Onlyfansapi::Models::DataExportListParams::Status, nil]
      optional :status, enum: -> { Onlyfansapi::DataExportListParams::Status }

      # @!attribute type
      #   Filter by export type
      #
      #   @return [Symbol, Onlyfansapi::Models::DataExportListParams::Type, nil]
      optional :type, enum: -> { Onlyfansapi::DataExportListParams::Type }
