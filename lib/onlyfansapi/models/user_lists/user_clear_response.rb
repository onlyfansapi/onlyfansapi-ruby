...
module Onlyfansapi
  module Models
    module UserLists
      # @see Onlyfansapi::Resources::UserLists::Users#clear
      class UserClearResponse < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _meta
        #
        #   @return [Onlyfansapi::Models::UserLists::UserClearResponse::Meta, nil]
        optional :_meta, -> { Onlyfansapi::Models::UserLists::UserClearResponse::Meta }

        # @!attribute data
        #
        #   @return [Onlyfansapi::Models::UserLists::UserClearResponse::Data, nil]
        optional :data, -> { Onlyfansapi::Models::UserLists::UserClearResponse::Data }

        # @!method initialize(_meta: nil, data: nil)
        #   @param _meta [Onlyfansapi::Models::UserLists::UserClearResponse::Meta]
        #   @param data [Onlyfansapi::Models::UserLists::UserClearResponse::Data]

        # @see Onlyfansapi::Models::UserLists::UserClearResponse#_meta
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          # @!attribute _cache
          #
          #   @return [Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Cache, nil]
          optional :_cache, -> { Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Cache }

          # @!attribute _credits
          #
          #   @return [Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Credits, nil]
          optional :_credits, -> { Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Credits }

          # @!attribute _rate_limits
          #
          #   @return [Onlyfansapi::Models::UserLists::UserClearResponse::Meta::RateLimits, nil]
          optional :_rate_limits, -> { Onlyfansapi::Models::UserLists::UserClearResponse::Meta::RateLimits }

          # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
          #   @param _cache [Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Cache]
          #   @param _credits [Onlyfansapi::Models::UserLists::UserClearResponse::Meta::Credits]
          #   @param _rate_limits [Onlyfansapi::Models::UserLists::UserClearResponse::Meta::RateLimits]

          # @see Onlyfansapi::Models::UserLists::UserClearResponse::Meta#_cache
          ...
          # @see Onlyfansapi::Models::UserLists::UserClearResponse::Meta#_credits
          ...
          # @see Onlyfansapi::Models::UserLists::UserClearResponse::Meta#_rate_limits
        ...
        # @see Onlyfansapi::Models::UserLists::UserClearResponse#data
