  ...
  module Models
    module UserLists
      ...
      class UserRemoveResponse < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _meta
        #
        #   @return [Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta, nil]
        optional :_meta, -> { Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta }

        # @!attribute data
        #
        #   @return [Onlyfansapi::Models::UserLists::UserRemoveResponse::Data, nil]
        optional :data, -> { Onlyfansapi::Models::UserLists::UserRemoveResponse::Data }

        # @!method initialize(_meta: nil, data: nil)
        #   @param _meta [Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta]
        #   @param data [Onlyfansapi::Models::UserLists::UserRemoveResponse::Data]

        # @see Onlyfansapi::Models::UserLists::UserRemoveResponse#_meta
        class Meta < Onlyfansapi::Internal::Type::BaseModel
          # @!attribute _cache
          #
          #   @return [Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta::Cache, nil]
          optional :_cache, -> { Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta::Cache }

          # @!attribute _credits
          #
          #   @return [Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta::Credits, nil]
          optional :_credits, -> { Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta::Credits }

          # @!attribute _rate_limits
          #
          #   @return [Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta::RateLimits, nil]
          optional :_rate_limits, -> { Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta::RateLimits }

          # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
          #   @param _cache [Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta::Cache]
          #   @param _credits [Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta::Credits]
          #   @param _rate_limits [Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta::RateLimits]

          # @see Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta#_cache
          ...
          # @see Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta#_credits
          ...
          # @see Onlyfansapi::Models::UserLists::UserRemoveResponse::Meta#_rate_limits
        ...
        # @see Onlyfansapi::Models::UserLists::UserRemoveResponse#data
        class Data < Onlyfansapi::Internal::Type::BaseModel
          # @!attribute list
          #
          #   @return [Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::List, nil]
          optional :list, -> { Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::List }

          # @!attribute user_state
          #
          #   @return [Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::UserState, nil]
          optional :user_state,
                   -> { Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::UserState },
                   api_name: :userState

          # @!method initialize(list: nil, user_state: nil)
          #   @param list [Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::List]
          #   @param user_state [Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::UserState]

          # @see Onlyfansapi::Models::UserLists::UserRemoveResponse::Data#list
          class List < Onlyfansapi::Internal::Type::BaseModel
            ...
            # @!attribute users
            #
            #   @return [Array<Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::List::User>, nil]
            optional :users,
                     -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::List::User] }
            ...
            #   @param type [String]
            #   @param users [Array<Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::List::User>]
            ...
            class User < Onlyfansapi::Internal::Type::BaseModel
              ...
              #
              #   @return [Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::List::User::AvatarThumbs, nil]
              ...
              # @see Onlyfansapi::Models::UserLists::UserRemoveResponse::Data::List::User#avatar_thumbs
          ...
          # @see Onlyfansapi::Models::UserLists::UserRemoveResponse::Data#user_state
