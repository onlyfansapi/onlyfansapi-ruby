...
module Onlyfansapi
  module Models
    # @see Onlyfansapi::Resources::Posts#update
    class PostUpdateParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Onlyfansapi::Models::PostUpdateParams::VotingType, nil]
      optional :voting_type, enum: -> { Onlyfansapi::PostUpdateParams::VotingType }, api_name: :votingType

      # @!method initialize(account:, post_id:, text:, expire_days: nil, fund_raising_target_amount: nil, fund_raising_tips_presets: nil, label_ids: nil, media_files: nil, price: nil, rf_tag: nil, save_for_later: nil, scheduled_date: nil, voting_correct_index: nil, voting_due: nil, voting_options: nil, voting_type: nil, request_options: {})
      ...
      #
      #   @param price [Integer] Price for paid content (0 or between 3-100). In case this is not zero,
      #   \*\*mediaFi
      #
      ...
      #
      #   @param voting_type [Symbol, Onlyfansapi::Models::PostUpdateParams::VotingType] Include a poll or quiz within your post.
      #
