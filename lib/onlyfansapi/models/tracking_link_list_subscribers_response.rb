...
module Onlyfansapi
  module Models
    ...
    class TrackingLinkListSubscribersResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data }

      # @!method initialize(_meta: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta]
      #   @param data [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data]

      # @see Onlyfansapi::Models::TrackingLinkListSubscribersResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta::RateLimits]

        # @see Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta#_credits
        ...
        # @see Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Meta#_rate_limits
      ...
      # @see Onlyfansapi::Models::TrackingLinkListSubscribersResponse#data
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List] }
        ...
        #   @param list [Array<Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List>]
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List::AvatarThumbs },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List::AvatarThumbs]
          ...
          # @see Onlyfansapi::Models::TrackingLinkListSubscribersResponse::Data::List#avatar_thumbs
