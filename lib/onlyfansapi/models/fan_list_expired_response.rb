...
module Onlyfansapi
  module Models
    ...
    class FanListExpiredResponse < Onlyfansapi::Internal::Type::BaseModel
      # @!attribute _meta
      #
      #   @return [Onlyfansapi::Models::FanListExpiredResponse::Meta, nil]
      optional :_meta, -> { Onlyfansapi::Models::FanListExpiredResponse::Meta }

      # @!attribute _pagination
      #
      #   @return [Onlyfansapi::Models::FanListExpiredResponse::Pagination, nil]
      optional :_pagination, -> { Onlyfansapi::Models::FanListExpiredResponse::Pagination }

      # @!attribute data
      #
      #   @return [Onlyfansapi::Models::FanListExpiredResponse::Data, nil]
      optional :data, -> { Onlyfansapi::Models::FanListExpiredResponse::Data }

      # @!method initialize(_meta: nil, _pagination: nil, data: nil)
      #   @param _meta [Onlyfansapi::Models::FanListExpiredResponse::Meta]
      #   @param _pagination [Onlyfansapi::Models::FanListExpiredResponse::Pagination]
      #   @param data [Onlyfansapi::Models::FanListExpiredResponse::Data]

      # @see Onlyfansapi::Models::FanListExpiredResponse#_meta
      class Meta < Onlyfansapi::Internal::Type::BaseModel
        # @!attribute _cache
        #
        #   @return [Onlyfansapi::Models::FanListExpiredResponse::Meta::Cache, nil]
        optional :_cache, -> { Onlyfansapi::Models::FanListExpiredResponse::Meta::Cache }

        # @!attribute _credits
        #
        #   @return [Onlyfansapi::Models::FanListExpiredResponse::Meta::Credits, nil]
        optional :_credits, -> { Onlyfansapi::Models::FanListExpiredResponse::Meta::Credits }

        # @!attribute _rate_limits
        #
        #   @return [Onlyfansapi::Models::FanListExpiredResponse::Meta::RateLimits, nil]
        optional :_rate_limits, -> { Onlyfansapi::Models::FanListExpiredResponse::Meta::RateLimits }

        # @!method initialize(_cache: nil, _credits: nil, _rate_limits: nil)
        #   @param _cache [Onlyfansapi::Models::FanListExpiredResponse::Meta::Cache]
        #   @param _credits [Onlyfansapi::Models::FanListExpiredResponse::Meta::Credits]
        #   @param _rate_limits [Onlyfansapi::Models::FanListExpiredResponse::Meta::RateLimits]

        # @see Onlyfansapi::Models::FanListExpiredResponse::Meta#_cache
        ...
        # @see Onlyfansapi::Models::FanListExpiredResponse::Meta#_credits
        ...
        # @see Onlyfansapi::Models::FanListExpiredResponse::Meta#_rate_limits
      ...
      # @see Onlyfansapi::Models::FanListExpiredResponse#_pagination
      ...
      # @see Onlyfansapi::Models::FanListExpiredResponse#data
      class Data < Onlyfansapi::Internal::Type::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onlyfansapi::Models::FanListExpiredResponse::Data::List>, nil]
        optional :list,
                 -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FanListExpiredResponse::Data::List] }

        # @!method initialize(has_more: nil, list: nil)
        #   @param has_more [Boolean]
        #   @param list [Array<Onlyfansapi::Models::FanListExpiredResponse::Data::List>]
        ...
        class List < Onlyfansapi::Internal::Type::BaseModel
          ...
          #
          #   @return [Onlyfansapi::Models::FanListExpiredResponse::Data::List::AvatarThumbs, nil]
          optional :avatar_thumbs,
                   -> { Onlyfansapi::Models::FanListExpiredResponse::Data::List::AvatarThumbs },
          ...
          #
          #   @return [Onlyfansapi::Models::FanListExpiredResponse::Data::List::HeaderSize, nil]
          optional :header_size,
                   -> { Onlyfansapi::Models::FanListExpiredResponse::Data::List::HeaderSize },
                   api_name: :headerSize

          # @!attribute header_thumbs
          #
          #   @return [Onlyfansapi::Models::FanListExpiredResponse::Data::List::HeaderThumbs, nil]
          optional :header_thumbs,
                   -> { Onlyfansapi::Models::FanListExpiredResponse::Data::List::HeaderThumbs },
          ...
          #
          #   @return [Array<Onlyfansapi::Models::FanListExpiredResponse::Data::List::ListsState>, nil]
          optional :lists_states,
                   -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FanListExpiredResponse::Data::List::ListsState] },
          ...
          #
          #   @return [Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscribedByData, nil]
          optional :subscribed_by_data,
                   -> { Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscribedByData },
          ...
          #
          #   @return [Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscribedOnData, nil]
          optional :subscribed_on_data,
                   -> { Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscribedOnData },
          ...
          #
          #   @return [Array<Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscriptionBundle>, nil]
          optional :subscription_bundles,
                   -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscriptionBundle] },
          ...
          #   @param id [Integer]
          #   @param avatar [String]
          #   @param avatar_thumbs [Onlyfansapi::Models::FanListExpiredResponse::Data::List::AvatarThumbs]
          ...
          #   @param header [String]
          #   @param header_size [Onlyfansapi::Models::FanListExpiredResponse::Data::List::HeaderSize]
          #   @param header_thumbs [Onlyfansapi::Models::FanListExpiredResponse::Data::List::HeaderThumbs]
          ...
          #   @param lists_states [Array<Onlyfansapi::Models::FanListExpiredResponse::Data::List::ListsState>]
          #   @param name [String]
          #   @param notice [String]
          #   @param promo_offers [Array<Object>]
          #   @param subscribed_by [Boolean]
          #   @param subscribed_by_autoprolong [Boolean]
          #   @param subscribed_by_data [Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscribedByData]
          ...
          #   @param subscribed_on_data [Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscribedOnData]
          #   @param subscribed_on_duration [String]
          #   @param subscribed_on_expired_now [Boolean]
          #   @param subscribe_price [Float]
          #   @param subscription_bundles [Array<Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscriptionBundle>]
          ...
          # @see Onlyfansapi::Models::FanListExpiredResponse::Data::List#avatar_thumbs
          ...
          # @see Onlyfansapi::Models::FanListExpiredResponse::Data::List#header_size
          ...
          # @see Onlyfansapi::Models::FanListExpiredResponse::Data::List#header_thumbs
          ...
          # @see Onlyfansapi::Models::FanListExpiredResponse::Data::List#subscribed_by_data
          class SubscribedByData < Onlyfansapi::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscribedByData::Subscribe>, nil]
            optional :subscribes,
                     -> { Onlyfansapi::Internal::Type::ArrayOf[Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscribedByData::Subscribe] }
            ...
            #   @param subscribe_price [Float]
            #   @param subscribes [Array<Onlyfansapi::Models::FanListExpiredResponse::Data::List::SubscribedByData::Subscribe>]
          ...
          # @see Onlyfansapi::Models::FanListExpiredResponse::Data::List#subscribed_on_data
          ...
          class SubscriptionBundle < Onlyfansapi::Internal::Type::BaseModel
            # @!attribute id
            #
            #   @return [Integer, nil]
            optional :id, Integer
