...
module Onlyfansapi
  module Models
    ...
    class SearchProfilesParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      # @!attribute filter
      #
      #   @return [Onlyfansapi::Models::SearchProfilesParams::Filter, nil]
      optional :filter, -> { Onlyfansapi::SearchProfilesParams::Filter }
      ...
      #
      #   @return [Symbol, Onlyfansapi::Models::SearchProfilesParams::Sort, nil]
      optional :sort, enum: -> { Onlyfansapi::SearchProfilesParams::Sort }

      # @!attribute sort_direction
      #   Direction for sorting. `desc` - highest value first. `asc` - lowest value first.
      #
      #   @return [Symbol, Onlyfansapi::Models::SearchProfilesParams::SortDirection, nil]
      optional :sort_direction, enum: -> { Onlyfansapi::SearchProfilesParams::SortDirection }
      ...
      class Filter < Onlyfansapi::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Onlyfansapi::Models::SearchProfilesParams::Filter::Gender, nil]
        optional :gender, enum: -> { Onlyfansapi::SearchProfilesParams::Filter::Gender }

        # @!method initialize(gender: nil)
        #   Some parameter documentations has been truncated, see
        #   {Onlyfansapi::Models::SearchProfilesParams::Filter} for more details.
        #
        #   @param gender [Symbol, Onlyfansapi::Models::SearchProfilesParams::Filter::Gender] Filter by gender (available: `female`, `male`, `trans`, `trans_ftm` (Female-to-M

        # Filter by gender (available: `female`, `male`, `trans`, `trans_ftm`
        # (Female-to-Male), `trans_mft` (Male-to-Female), `couple`). ⭐️ Only available on
        # the Pro and Enterprise plan.
        #
        # @see Onlyfansapi::Models::SearchProfilesParams::Filter#gender
        module Gender
