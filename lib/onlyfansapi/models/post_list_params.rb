...
module Onlyfansapi
  module Models
    ...
    class PostListParams < Onlyfansapi::Internal::Type::BaseModel
      ...
      #
      #   @return [Boolean, nil]
      optional :counters, Onlyfansapi::Internal::Type::Boolean
      ...
      #
      #   @return [Symbol, Onlyfansapi::Models::PostListParams::Order, nil]
      optional :order, enum: -> { Onlyfansapi::PostListParams::Order }

      # @!attribute pinned
      #   Set to true to only show pinned posts
      #
      #   @return [Boolean, nil]
      optional :pinned, Onlyfansapi::Internal::Type::Boolean
      ...
      #
      #   @return [Symbol, Onlyfansapi::Models::PostListParams::Sort, nil]
      optional :sort, enum: -> { Onlyfansapi::PostListParams::Sort }
