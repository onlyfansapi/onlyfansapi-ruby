    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Onlyfansapi::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Onlyfansapi::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Onlyfansapi::FilePart.new(value)
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Onlyfansapi::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Onlyfansapi::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Onlyfansapi::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Onlyfansapi::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Onlyfansapi::Internal::Type::Converter
              ...
              Onlyfansapi::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Onlyfansapi::Internal::Type::Converter, T::Class[T.anything]) }
        end
